...
namespace Falcon.App.Infrastructure.CallQueues.Impl
{
    ...
    public class HealthPlanConfirmationQueueNotGeneratedPollingAgent : IHealthPlanConfirmationQueueNotGeneratedPollingAgent
    {
        ...
        public HealthPlanConfirmationQueueNotGeneratedPollingAgent(ILogManager logManager, ICallQueueRepository callQueueRepository, IHealthPlanCallQueueCriteriaRepository healthPlanCallQueueCriteriaRepository,
            IHealthPlanCallQueueAssignmentRepository healthPlanCallQueueAssignmentRepository, ICorporateAccountRepository corporateAccountRepository, IHealthPlanCallRoundService healthPlanCallRoundService)
        {
            ...
            _logger = logManager.GetLogger("HealthPlanConfirmationQueueRegeneration");
        }
