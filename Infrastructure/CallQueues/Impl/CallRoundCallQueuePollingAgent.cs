...
namespace Falcon.App.Infrastructure.CallQueues.Impl
{
    ...
    public class CallRoundCallQueuePollingAgent : ICallRoundCallQueuePollingAgent
    {
        ...
        public CallRoundCallQueuePollingAgent(ILogManager logManager, ICallQueueRepository callQueueRepository,
        ...
        {
            _logger = logManager.GetLogger("CallRoundCallQueuePollingAgent");
