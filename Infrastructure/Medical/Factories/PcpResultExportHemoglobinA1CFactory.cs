...
namespace Falcon.App.Infrastructure.Medical.Factories
{
    ...
    public class PcpResultExportHemoglobinA1CFactory : IPcpResultExportHemoglobinA1CFactory
    {
        public PcpResultExportModel SetHemoglobinA1CData(PcpResultExportModel model, HemaglobinA1CTestResult testResult, bool useBlankValue = false)
        {
