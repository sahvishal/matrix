...
{
    public interface IPcpResultExportFactory
    {
        void Create(IEnumerable<EventCustomerResultEntity> eventCustomerResultEntities, IEnumerable<OrderedPair<long, long>> orgRoleUserIdUserIdPairs, IEnumerable<UserEntity> userEntities,
            ...
            string destinationDirectory, IEnumerable<long> hafQuestionIds, bool useBlankValue, string resultExportfileName = "", string[] showHiddenColumns = null, IEnumerable<OrderedPair<string, string>> additionalFields = null);
