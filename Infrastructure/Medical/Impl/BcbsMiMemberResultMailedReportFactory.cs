...
namespace Falcon.App.Infrastructure.Medical.Impl
{
    ...
    public class BcbsMiMemberResultMailedReportFactory : IBcbsMiMemberResultMailedReportFactory
    {
        public BcbsMiMemberResultMailedReportListModel Create(IEnumerable<ShippingDetail> shippingDetails, IEnumerable<OrderedPair<long, long>> shippingDetailIdEventCustomerIdPairs, IEnumerable<EventCustomer> eventCustomers,
            IEnumerable<Customer> customers, IEnumerable<Address> addresses, IEnumerable<Event> events)
        {
            var listModel = new BcbsMiMemberResultMailedReportListModel();
            var collection = new List<BcbsMiMemberResultMailedReportViewModel>();
            ...
            foreach (var shippingDetail in shippingDetails)
            {
                ...
                var viewData = new BcbsMiMemberResultMailedReportViewModel
                {
