...
{
    public class BioSoundEchoParser : ITestParser
    {
        ...
        public BioSoundEchoParser(string pathToReportXmlFile, string mediaLocation, ILogger logger, TestType testType)
        {
        ...
        public TestResult Parse()
        {
            ...
            testResult.Media = _mediaHelper.GetMediaforTest(Directory.GetParent(_pathToReportXmlFile).Parent.FullName, _mediaLocation, "Echo", out isExceptionCaused).ToList();
