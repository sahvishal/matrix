...
{
    public class BioSoundPpAaaParser : ITestParser
    {
        ...
        public BioSoundPpAaaParser(string pathToReportXmlFile, string mediaLocation, ILogger logger)
        {
        ...
        public PpAaaTestResult MapXmlToDomainObject(string filePathtoXml)
        {
            ...
            testResult.ResultImages = _mediaHelper.GetMediaforTest(Directory.GetParent(filePathtoXml).Parent.FullName, _mediaLocation, TestType.PPAAA.ToString(), out isExceptionCaused).ToList();
