...
{
    public class BioSound2HcpAaaParser : ITestParser
    {
        ...
        public BioSound2HcpAaaParser(string pathToReportXmlFile, string mediaLocation, ILogger logger)
        {
        ...
        public HcpAaaTestResult MapXmlToDomainObject(string filePathtoXml)
        {
            ...
            testResult.ResultImages = _mediaHelper.GetMediaSortedByDecimalValue(Directory.GetParent(filePathtoXml).FullName, _mediaLocation, TestType.HCPAAA.ToString(), out isExceptionCaused).ToList();
