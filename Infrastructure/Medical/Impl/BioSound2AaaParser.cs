...
{
    public class BioSound2AaaParser : ITestParser
    {
        ...
        public BioSound2AaaParser(string pathToReportXmlFile, string mediaLocation, ILogger logger)
        {
        ...
        public AAATestResult MapXmlToDomainObject(string filePathtoXml)
        {
            ...
            testResult.ResultImages = _mediaHelper.GetMediaSortedByDecimalValue(Directory.GetParent(filePathtoXml).FullName, _mediaLocation, TestType.AAA.ToString(), out isExceptionCaused).ToList();
