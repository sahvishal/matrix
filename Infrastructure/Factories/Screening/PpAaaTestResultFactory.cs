...
{
    public class PpAaaTestResultFactory : TestResultFactory
    {
        public override TestResult CreateActualTestResult(CustomerEventScreeningTestsEntity customerEventScreeningTestsEntity)
        {
            ...
            var testResult = new PpAaaTestResult(customerEventScreeningTestsEntity.CustomerEventScreeningTestId);
            ...
            if (aortaValue != null)
            {
                testResult.Finding = new StandardFinding<decimal?>(Convert.ToInt64((new TestResultService()).GetCalculatedStandardFinding(aortaValue, (int)TestType.PPAAA, (int)ReadingLabels.AortaSize)));
            }

            if (testResult.Finding != null)
                testResult.Finding = new TestResultService().GetAllStandardFindings<decimal?>((int)TestType.PPAAA, (int)ReadingLabels.AortaSize).Find(standardFinding => standardFinding.Id == testResult.Finding.Id);
            ...
            var aortaRangeSaggitalViewFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.PPAAA, (int)ReadingLabels.AortaRangeSaggitalView);
            var aortaRangeTransverseViewFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.PPAAA, (int)ReadingLabels.AortaRangeTransverseView);
            var aortaValueFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.PPAAA, (int)ReadingLabels.AortaSize);
        ...
        {
            var aaaTestResult = testResult as PpAaaTestResult;
            var customerEventScreeningTestsEntity = new CustomerEventScreeningTestsEntity(testResult.Id) { TestId = (int)TestType.PPAAA };
            ...
            if (aortaValue != null)
            {
                findingId = (new TestResultService()).GetCalculatedStandardFinding(aortaValue, (int)TestType.PPAAA, (int)ReadingLabels.AortaSize);

                if (aaaTestResult.Finding != null && aaaTestResult.Finding.Id != findingId)
                {
                    findingId = aaaTestResult.Finding.Id;
                    standardFindingTestReadingId = (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding((int)TestType.PPAAA, (int)ReadingLabels.AortaSize, aaaTestResult.Finding.Id);
                }
            }
            ...
            if (findingId > 0)
            {
                var finding = GetSelectedStandardFinding((int)TestType.PPAAA, (int)ReadingLabels.AortaSize, findingId);
            ...
            if (aaaTestResult.DiagnosisCode != null)
            {
                var customerEventReading = CreateEventReadingEntity(aaaTestResult.DiagnosisCode, (int)ReadingLabels.DiagnosisCode, testReadingReadingPairs);
                customerEventReadingEntities.Add(customerEventReading);
            }
                    ...
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.PPAAA, (int)ReadingLabels.AortaRangeSaggitalView, Convert.ToInt64(finding.Id)),
            ...
            if (aaaTestResult.AortaRangeTransverseView != null)
            {
                aaaTestResult.AortaRangeTransverseView.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.PPAAA, (int)ReadingLabels.AortaRangeTransverseView, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
