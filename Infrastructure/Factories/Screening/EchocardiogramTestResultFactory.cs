...
{
    public class EchocardiogramTestResultFactory : TestResultFactory
    {

        public override TestResult CreateActualTestResult(CustomerEventScreeningTestsEntity customerEventScreeningTestEntity)
        {
            var customerEventReadingEntities = customerEventScreeningTestEntity.CustomerEventReading.ToList();
            var testResult = new EchocardiogramTestResult(customerEventScreeningTestEntity.CustomerEventScreeningTestId);
...

            {
                ...
                var standardFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram);
                var estimatedEjactionFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.EstimatedEjactionFraction);
                var aorticRegurgitationFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.Aortic);
                var mitralRegurgitationFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.Mitral);
                var pulmonicRegurgitationFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.Pulmonic);
                var tricuspidRegurgitationFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.Tricuspid);
                var aorticMorphologyFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.AorticMorphology);
                var mitralMorphologyFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.MitralMorphology);
                var pulmonicMorphologyFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.PulmonicMorphology);
                var tricuspidMorphologyFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.TricuspidMorphology);
                var distolicDysfunctionFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.DiastolicDysfunction);
                var pericardialEffusionFindings = testResultService.GetAllStandardFindings<int?>((int)TestType.Echocardiogram, (int)ReadingLabels.PericardialEffusion);
                ...
                customerEventTestStandardFindingEntities.ForEach(customerEventTestStandardFindingEntity =>
                {
                    ...
                    if (finding != null)
                    {
                        if (testResult.DistolicDysfunctionFinding == null) testResult.DistolicDysfunctionFinding = new List<StandardFinding<int>>();
                        testResult.DistolicDysfunctionFinding.Add(finding); return;
                    }
        ...
        public override CustomerEventScreeningTestsEntity CreateActualTestResultEntity(TestResult testResult, List<OrderedPair<int, int>> testReadingReadingPairs)
        {
            ...
            var customerEventScreeningTestsEntity = new CustomerEventScreeningTestsEntity(testResult.Id) { TestId = (int)TestType.Echocardiogram };
            ...
            if (echoTestResult.ConsiderOtherModalities != null)
                customerEventReadingEntities.Add(CreateEventReadingEntity(echoTestResult.ConsiderOtherModalities, (int)ReadingLabels.ConsiderOtherModalities, testReadingReadingPairs));

            if (echoTestResult.AdditionalImagesNeeded != null)
                customerEventReadingEntities.Add(CreateEventReadingEntity(echoTestResult.AdditionalImagesNeeded, (int)ReadingLabels.AdditionalImagesNeeded, testReadingReadingPairs));
            ...
            if (echoTestResult.Finding != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, null, Convert.ToInt64(echoTestResult.Finding.Id)),
                ...
                var finding = GetSelectedStandardFinding((int)TestType.Echocardiogram, null, echoTestResult.Finding.Id);
            ...
            if (echoTestResult.EstimatedEjactionFraction != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, (int)ReadingLabels.EstimatedEjactionFraction, Convert.ToInt64(echoTestResult.EstimatedEjactionFraction.Id)),
            ...
            if (echoTestResult.AorticRegurgitation != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, (int)ReadingLabels.Aortic, Convert.ToInt64(echoTestResult.AorticRegurgitation.Id)),
            ...
            if (echoTestResult.AorticMorphology != null)
            {
                echoTestResult.AorticMorphology.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.AorticMorphology, Convert.ToInt64(finding.Id)),
            ...
            if (echoTestResult.MitralRegurgitation != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, (int)ReadingLabels.Mitral, Convert.ToInt64(echoTestResult.MitralRegurgitation.Id)),
            ...
            if (echoTestResult.MitralMorphology != null)
            {
                echoTestResult.MitralMorphology.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.MitralMorphology, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
            ...
            if (echoTestResult.PulmonicRegurgitation != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, (int)ReadingLabels.Pulmonic, Convert.ToInt64(echoTestResult.PulmonicRegurgitation.Id)),
            ...
            if (echoTestResult.PulmonicMorphology != null)
            {
                echoTestResult.PulmonicMorphology.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.PulmonicMorphology, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
            ...
            if (echoTestResult.TricuspidRegurgitation != null)
            {
                var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                {
                    StandardFindingTestReadingId =
                        (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                            ((int)TestType.Echocardiogram, (int)ReadingLabels.Tricuspid, Convert.ToInt64(echoTestResult.TricuspidRegurgitation.Id)),
            ...
            if (echoTestResult.TricuspidMorphology != null)
            {
                echoTestResult.TricuspidMorphology.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.TricuspidMorphology, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
            ...
            {
                echoTestResult.DistolicDysfunctionFinding.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.DiastolicDysfunction, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
            ...
            if (echoTestResult.PericardialEffusionFinding != null)
            {
                echoTestResult.PericardialEffusionFinding.ForEach(finding =>
                {
                    var customerEventTestStandardFindingEntity = new CustomerEventTestStandardFindingEntity()
                    {
                        StandardFindingTestReadingId =
                            (int?)new TestResultService().GetStandardFindingTestReadingIdForStandardFinding
                                ((int)TestType.Echocardiogram, (int)ReadingLabels.PericardialEffusion, Convert.ToInt64(finding.Id)),
                        CustomerEventTestStandardFindingId = finding.CustomerEventStandardFindingId,
                        CustomerEventScreeningTestId = testResult.Id
                    };
                    customerEventScreeningTestsEntity.CustomerEventTestStandardFinding.Add(customerEventTestStandardFindingEntity);
