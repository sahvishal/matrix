...
namespace Falcon.App.Infrastructure.Application.Impl
{
    ...
    public class Settings : ISettings
    {
        ...
        public Settings(IConfigurationSettingRepository configurationSettingRepository)
        {
            _configurationSettingRepository = configurationSettingRepository;
        }

        public Settings()
            : this(new ConfigurationSettingRepository())
        {
        }
        ...
        {
            get { return ConnectionHandler.GetConnectionString(); }
        }
        ...
        public int MaximumPictureCount
        {
            get
            {
                return
                    int.Parse(
                        _configurationSettingRepository.GetConfigurationValue(ConfigurationSettingName.NumberOfPictures));
            }
        }

        public string LargeLogo
        {
            get { return "/Config/Content/Images/" + LargeLogoFileName; }
        }
        ...
        {
            get { return "/Config/Content/Images/" + MediumLogoFileName; }
        }
        ...
        {
            get { return "/Config/Content/Images/" + SmallLogoFileName; }
        }

        public string ProductName
        {
            get { return ConfigurationManager.AppSettings.Get("ProductName"); }
        }

        public string EmailNotificationLogoRelativePath
        {
            get { return AppUrl + "/Config/Content/Images/Logo-Small-160x60.gif"; }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("PrivacyStatement"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("TermsAndConditions"); }

        }

        public string CopyrightText
        {
            get { return ConfigurationManager.AppSettings.Get("CopyrightText"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("TestPreparationURL"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("SiteUrl"); }
        }

        public string AppUrl
        {
            get { return ConfigurationManager.AppSettings.Get("AppUrl"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("BusinessName"); }
        }

        public string FullBusinessName
        {
            get { return ConfigurationManager.AppSettings.Get("FullBusinessName"); }
        }

        public string PhoneTollFree
        {
            get { return ConfigurationManager.AppSettings.Get("PhoneTollFree"); }
        }
        ...
        public Email SupportEmail
        {
            get
            {
                return new Email(ConfigurationManager.AppSettings.Get("CompanySupportEmailAddress"),
                    ConfigurationManager.AppSettings.Get("CompanySupportEmailDomain"));
            }
        }

        // Replacing "From Email" from Database Global Configuration Table. 
        public Email EmailNotificationIssuedFrom
        {
            get
            {
                return new Email(ConfigurationManager.AppSettings.Get("EmailNotificationIssuedFromAddress"),
                    ConfigurationManager.AppSettings.Get("EmailNotificationIssuedFromDomain"));
            }
        }

        // Name used for Notification Send from. Replacing "From Name" in DB Global Configuration Table
        public string NameNotificationissuedFrom
        {
            get { return ConfigurationManager.AppSettings.Get("NameNotificationissuedFrom"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("Address1"); }
        }

        public string Address2
        {
            get { return ConfigurationManager.AppSettings.Get("Address2"); }
        }

        public string City
        {
            get { return ConfigurationManager.AppSettings.Get("City"); }
        }

        public string State
        {
            get { return ConfigurationManager.AppSettings.Get("State"); }
        }

        public string ZipCode
        {
            get { return ConfigurationManager.AppSettings.Get("ZipCode"); }
        }


        public bool IsAuthorizationRequired
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("IsAuthorizationRequired")); }
        }

        public decimal PrePayPercentage
        {
            get { return Convert.ToDecimal(ConfigurationManager.AppSettings.Get("PrePayPercentage")); }
        }

        public bool EnableCallPop
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("EnableCallPop")); }
        }

        public string MediaLocation
        {
            get { return ConfigurationManager.AppSettings.Get("MediaLocation"); }
        }

        public int DefaultPageSizeForReports
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("DefaultPageSizeForReports")); }
        }

        public string MediaUrl
        {
            get { return ConfigurationManager.AppSettings.Get("MediaUrl"); }
        }

        public bool IsRefundQueueEnabled
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("IsRefundQueueEnabled")); }
        }

        public string BusinessTaxId
        {
            get { return ConfigurationManager.AppSettings.Get("BusinessTaxId"); }
        }

        public string GiftCertificateImagePath
        {
            get { return Convert.ToString(ConfigurationManager.AppSettings.Get("GiftCertificateImagePath")); }
        }

        public string GiftCertificateThumbnailPath
        {
            get { return Convert.ToString(ConfigurationManager.AppSettings.Get("GiftCertificateThumbnailPath")); }
        }

        public string ProcessorLogin
        {
            get { return ConfigurationManager.AppSettings.Get("APILogin"); }
        }

        public string ProcessorTransactionKey
        {
            get { return ConfigurationManager.AppSettings.Get("AuothorizeNetTransactionKey"); }
        }

        public bool ProcessorUseTestUrl
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("UseTestUrl")); }
        }

        public bool ProcessorUseTestTransaction
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("TransactionTestMode")); }
        }

        public bool CapturePrimaryCarePhysician
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("CapturePrimaryCarePhysician")); }
        }

        public bool EnableSurveyForCorporateEvents
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("EnableSurveyForCorporateEvents")); }
        }

        public bool IsEccEnabled
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("IsEccEnabled")); }
        }
        ...
        public string ResultMediaLocationPrefix
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MediaLocation") + "\\" +
                       ConfigurationManager.AppSettings.Get("ResultMediaLocationAndUrlSuffix");
            }
        }
        ...
        public string ResultMediaUrlPrefix
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MediaUrl") + "/" +
                       ConfigurationManager.AppSettings.Get("ResultMediaLocationAndUrlSuffix");
            }
        }
        ...
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("EnableMassRegistration")); }
        }

        public bool ShowPartnerRelease
        {
            get { return bool.Parse(ConfigurationManager.AppSettings.Get("ShowPartnerRelease")); }
        }


        public string SiteConfigurableContentPath
        {
            get { return ConfigurationManager.AppSettings.Get("SiteConfigurableContentPath"); }
        }

        public string LargeLogoLocation
        {
            get { return SiteConfigurableContentPath + @"\Images\" + LargeLogoFileName; }
        }

        public string MediumLogoLocation
        {
            get { return SiteConfigurableContentPath + @"\Images\" + MediumLogoFileName; }
        }

        public string SmallLogoLocation
        {
            get { return SiteConfigurableContentPath + @"\Images\" + SmallLogoFileName; }
        }
        ...
        public string TemplatePremiumVersionLocation
        {
            get
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplatePremiumVersionFileName");
            }
        }
        ...
        public string TemplatePaperBackPremiumVersionLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplatePaperBackPremiumVersionLocation");
            }
        }
        ...
        public string TemplatePremiumVersionWithImagesLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplatePremiumVersionWithImagesLocation");
            }
        }
        ...
        public string TemplateClinicalFormLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplateClinicalFormFileName");
            }
        }
        ...
        public string TemplateIndexPageLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplateIndexPageFileName");
            }
        }
        ...
        public string TemplateCoverLetterLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplateCoverLetterLocation");
            }
        }
        ...
        public string TemplatePcpCoverLetterWithDianosisCodeLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplatePPCoverLetterLocation");
            }
        }

        public string LargeLogoFileName
        {
            get { return "Logo-Large-300x90.gif"; }
        }

        public string MediumLogoFileName
        {
            get { return "Logo-Medium-200x75.gif"; }
        }

        public string SmallLogoFileName
        {
            get { return "Logo-Small-160x60.gif"; }
        }
        ...
        public bool CopyOverMediainPremiumResultReport
        {
            get
            {
                return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("CopyOverMediainPremiumResultReport"));
            }
        }

        public bool IncludeHealthAssesmentForm
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("IncludeHealthAssesmentForm")); }
        }
        ...
        public bool IncludeCustomerSectioninPremiumResultReport
        {
            ...
            {
                return
                    Convert.ToBoolean(ConfigurationManager.AppSettings.Get("IncludeCustomerSectioninPremiumResultReport"));
            }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("HealthAssesmentFormUrl"); }
        }
        ...
        public string CompanyCustomizedLetter
        {
            get
            {
                var fileName = ConfigurationManager.AppSettings.Get("CompanyCustomizedLetter");
                return string.IsNullOrEmpty(fileName.Trim())
                    ? ""
                    : SiteConfigurableContentPath + @"\ResultPacket\" +
                      ConfigurationManager.AppSettings.Get("CompanyCustomizedLetter");
            }
        }
        ...
        public string ContentPages
        {
            get
            {
                var fileName = ConfigurationManager.AppSettings.Get("ContentPages");
                return string.IsNullOrEmpty(fileName.Trim())
                    ? ""
                    : SiteConfigurableContentPath + @"\ResultPacket\" +
                      ConfigurationManager.AppSettings.Get("ContentPages");
            }
        }
        ...
        public string DoctorLetter
        {
            get
            {
                var fileName = ConfigurationManager.AppSettings.Get("DoctorLetter");
                return string.IsNullOrEmpty(fileName.Trim())
                    ? ""
                    : SiteConfigurableContentPath + @"\ResultPacket\" +
                      ConfigurationManager.AppSettings.Get("DoctorLetter");
            }
        }
        ...
        public int ResultArchiveWaitDays
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("ResultArchiveWaitDays"), out days);
                return days;
            }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("ResultArchiveSharedDrivePath"); }
        }

        public bool IsStrokeInferenceForPHS
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("IsStrokeInferenceForPHS")); }
        }

        public DateTime EvaluationReminderSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("EvaluationReminderSchedulingTime")); }
        }

        public string BloodWorksAccountDetails
        {
            get { return ConfigurationManager.AppSettings.Get("BloodWorksAccountDetails"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("EKGParserFolderRepresentation"); }
        }

        public string EkgParsertoUse
        {
            get { return ConfigurationManager.AppSettings.Get("EKGParsertoUse"); }
        }
        ...
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("EnableResultDeliveryNotification")); }
        }


        public string AaaParsertoUse
        {
            get { return ConfigurationManager.AppSettings.Get("AaaParsertoUse"); }
        }


        public bool CleanUpHtmlFiles
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("CleanUpHtmlFiles")); }
        }
        ...
        public int IntervalResultDelivery
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("IntervalResultDelivery"), out hours);
        ...
        public int IntervalResultDeliveryBuffer
        {
            ...
            {
                int minutes = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("IntervalResultDeliveryBuffer"), out minutes);
                return (minutes < 1 || minutes > 30 ? 30 : minutes);
            }
        }
        ...
        public string CustomerPortalPhoneTollFree
        {
            get
            {
                return string.IsNullOrEmpty(ConfigurationManager.AppSettings.Get("CustomerPortalPhoneTollFree"))
                    ? PhoneTollFree
                    : ConfigurationManager.AppSettings.Get("CustomerPortalPhoneTollFree");
            }
        }
        ...
        public string TemplateBloodLetterLoaction
        {
            ...
            get
            {
                var fileName = ConfigurationManager.AppSettings.Get("TemplateBloodLetterLocation");
                return string.IsNullOrEmpty(fileName.Trim())
                    ? ""
                    : SiteConfigurableContentPath + @"\ResultPacket\" +
                      ConfigurationManager.AppSettings.Get("TemplateBloodLetterLocation");
            }
        }
        ...
        public string TemplateCorporateCoverLetterLocation
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("TemplateCorporateCoverLetterLocation");
            }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("ScreeningReminderSchedulingTime")); }
        }
        ...
        public int DaysBeforeScreeningReminder
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("DaysBeforeScreeningReminder"), out days);
        ...
        public string AnnualReminderPhoneTollFree
        {
            get
            {
                return string.IsNullOrEmpty(ConfigurationManager.AppSettings.Get("AnnualReminderPhoneTollFree"))
                    ? PhoneTollFree
                    : ConfigurationManager.AppSettings.Get("AnnualReminderPhoneTollFree");
            }
        }
        ...
        public int DaysBeforeAnnualDate
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("DaysBeforeAnnualDate"), out days);
                return days;
            }
        }
        ...
        public int MaxNumberOfRecordsToFetch
        {
            ...
            {
                int records = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("MaxNumberOfRecordsToFetch"), out records);
                return records;
            }
        }
        ...
        public int ShowNoOfRecords
        {
            ...
            {
                int records = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("ShowNoOfRecords"), out records);
                return records;
            }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("AnnualReminderSourceCode"); }
        }

        public string CheckOutUrl
        {
            get { return ConfigurationManager.AppSettings.Get("CheckOutUrl"); }
        }

        public DateTime AnnualReminderSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("AnnualReminderSchedulingTime")); }
        }


        public DateTime SurveyEmailSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("SurveyEmailSchedulingTime")); }
        }
        ...
        public DateTime ProspectCustomerFollowUpSchedulingTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("ProspectCustomerFollowUpSchedulingTime"));
            }
        }

        public bool HideEkgSection
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("HideEkgSection")); }
        }
        ...
        public DateTime? StrokeFindingChangeDate
        {
            get
            {
                DateTime newStrokeFindingDate;
                if (DateTime.TryParse(ConfigurationManager.AppSettings.Get("StrokeFindingChangeDate"),
                    out newStrokeFindingDate))
                    return newStrokeFindingDate;
                return null;
            }
        }
        ...
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("CheckShippingPurchase")); }
        }

        public bool CaptureEmployeeId
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("CaptureEmployeeId")); }
        }

        public bool CaptureInsuranceId
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("CaptureInsuranceId")); }
        }

        public DateTime TestUpsellSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("TestUpsellSchedulingTime")); }
        }
        ...
        public int DaysAfterResultReady
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("DaysAfterResultReady"), out days);
                return days;
            }
        }
        ...
        public DateTime SecondResultReadyNotificationSchedulingTime
        {
            get
            {
                return
                    Convert.ToDateTime(
                        ConfigurationManager.AppSettings.Get("SecondResultReadyNotificationSchedulingTime"));
            }
        }
        ...
        public DateTime EventResultReadyNotificationSchedulingTime
        {
            ...
            {
                return
                    Convert.ToDateTime(ConfigurationManager.AppSettings.Get("EventResultReadyNotificationSchedulingTime"));
            }
        }
        ...
        public int IntervalEventResultReady
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("IntervalEventResultReady"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("HideShippingOption")); }
        }

        public bool SelectFreeShippingByDefault
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("SelectFreeShippingByDefault")); }
        }
        ...
        public int HoursBeforeSecondScreeningReminder
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("HoursBeforeSecondScreeningReminder"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        public int IntervalSecondScreeningReminder
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("IntervalSecondScreeningReminder"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("HideResultPurchase")); }
        }

        public bool HideProductPurchase
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("HideProductPurchase")); }
        }
        ...
        public DateTime? OsteoChangeDate
        {
            get
            {
                DateTime osteoChangeDate;
                if (DateTime.TryParse(ConfigurationManager.AppSettings.Get("OsteoChangeDate"), out osteoChangeDate))
                    return osteoChangeDate;
                return null;
            }
        }
        ...
        public DateTime KynFirstNotificationSchedulingTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("KynFirstNotificationSchedulingTime"));
            }
        }
        ...
        public int DaysAfterRegistrationKynFirstNotification
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("DaysAfterRegistrationKynFirstNotification"),
                    out days);
                return days;
            }
        }
        ...
        public int HoursBeforeKynSecondNotification
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("HoursBeforeKynSecondNotification"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        public int IntervalKynSecondNotification
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("IntervalKynSecondNotification"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        {
            get { return Convert.ToBoolean(ConfigurationManager.AppSettings.Get("EligibilityTestMode")); }

        }

        public string EligibilityApiKey
        {
            get { return ConfigurationManager.AppSettings.Get("EligibilityApiKey"); }

        }

        public string EligibilityProviderFirstName
        {
            get { return ConfigurationManager.AppSettings.Get("EligibilityProviderFirstName"); }

        }

        public string EligibilityProviderLastName
        {
            get { return ConfigurationManager.AppSettings.Get("EligibilityProviderLastName"); }

        }

        public string EligibilityProviderNpi
        {
            get { return ConfigurationManager.AppSettings.Get("EligibilityProviderNpi"); }

        }

        public DateTime InsuranceEncounterSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("InsuranceEncounterSchedulingTime")); }
        }

        public DateTime InsuranceClaimSchedulingTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("InsuranceClaimSchedulingTime")); }
        }
        ...
        public int DaysAfterGetClaim
        {
            ...
            {
                int days = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("DaysAfterGetClaim"), out days);
                return (days < 1 ? 1 : days);
            }
        }
        ...
        public int CallQueueServiceInterval
        {
            ...
            {
                int mins = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("CallQueueServiceInterval"), out mins);
                return (mins < 5 ? 5 : mins);
            }
        }
        ...
        public int PullBackCallQueueCustomerInterval
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("PullBackCallQueueCustomerInterval"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        public string LipidTemplate
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("LipidTemplate");
            }
        }
        ...
        public string KynTemplate
        {
            ...
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" +
                       ConfigurationManager.AppSettings.Get("KynTemplate");
            }
        }

        public string TemplateImageLocation
        {
            get { return AppUrl + "/Config/Content/Images/"; }
        }

        public string KynDataTemplate
        {
            get
            {
                return SiteConfigurableContentPath + @"\ResultPacket\" + ConfigurationManager.AppSettings.Get("kynData");
            }
        }
        ...
        public int GenerateKynXmlInterval
        {
            ...
            {
                int minutes = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("GenerateKynXmlInterval"), out minutes);
        ...
        public int HoursBeforeScreeningReminderViaSms
        {
            ...
            {
                var hrs = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("HoursBeforeAppointmentReminderViaSms"), out hrs);
                return (hrs < 1 ? 1 : hrs);
            }
        }
        ...
        public int SmsInterval
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("SMSInterval"), out hours);
                return (hours < 1 ? 1 : hours);
            }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("SMSSystemIdentification"); }
        }

        public string SmsAuthorizationToken
        {
            get { return ConfigurationManager.AppSettings.Get("SMSAuthorizationToken"); }
        }

        public string SmsFromNumber
        {
            get { return ConfigurationManager.AppSettings.Get("SMSFromNumber"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("EFaxAccountId"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("EFaxUserName"); }
        }

        public string EFaxPassword
        {
            get { return ConfigurationManager.AppSettings.Get("EFaxPassword"); }
        }

        public string EFaxDispositionRecipient
        {
            get { return ConfigurationManager.AppSettings.Get("EFaxDispositionRecipient"); }
        }

        public string EFaxDispositionEmail
        {
            get { return ConfigurationManager.AppSettings.Get("EFaxDispositionEmail"); }
        }

        public DateTime FaxResultNotificationQueueTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("FaxResultNotificationQueueTime")); }
        }


        public DateTime FaxResultNotificationPushTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("FaxResultNotificationPushTime")); }
        }
        ...
        public long PhysicianPartnerAccountId
        {
            ...
            {
                long accountId = 0;
                long.TryParse(ConfigurationManager.AppSettings.Get("PhysicianPartnerAccountId"), out accountId);
                return accountId;
            }
        }
        ...
        public int KynXmlIntervalInMinutes
        {
            ...
            {
                int minutes = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("KynXmlIntervalInMinutes"), out minutes);
                return (minutes < 0 ? 15 : minutes);
            }
        }
        ...
        public int KynXmlIntervalInHours
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("KynXmlIntervalInHours"), out hours);
                return hours;
            }
        }
        ...
        public int WarningMessageTime
        {
            get
            {
                var warningMessageTime = 0;
                int.TryParse(ConfigurationManager.AppSettings.Get("WarningMessageTime"), out warningMessageTime);
                return warningMessageTime;
            }
        }
        ...
        public IEnumerable<long> PcpAppointmentBookedReportDownloadAccountIds
        {
            get
            {
                var configuValue = ConfigurationManager.AppSettings.Get("PcpAppointmentBookedReportDownloadAccountIds");
                var pcpAccountIds = new List<long>();
                if (string.IsNullOrEmpty(configuValue)) return pcpAccountIds;
        ...
        public bool StopMediaArchiveService
        {
            get
            {
                bool stopMediaArchiveService;
                bool.TryParse(ConfigurationManager.AppSettings.Get("StopMediaArchiveService"),
                    out stopMediaArchiveService);

                return stopMediaArchiveService;
            }
        }
        ...
        {
            get { return MedicareAppUrl + "/" + ConfigurationManager.AppSettings.Get("HraQuestionerAppUrl"); }
        }
        ...
        {
            get { return MedicareAppUrl + "/" + ConfigurationManager.AppSettings.Get("MedicareApiUrl") + "/"; }
        }
        ...
        public DateTime? FastingStatusDate
        {
            get
            {
                ...
                if (DateTime.TryParse(ConfigurationManager.AppSettings.Get("FastingStatusDate"), out fastingStatusDate))
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings["DashboardEventListingPageSize"]); }
        }
        ...
        public IEnumerable<long> WellCareEasyChoiceAccountIds
        {
            get
            {
                var configuValue = ConfigurationManager.AppSettings.Get("WellCareEasyChoiceAccountIds");
                var wellCareEasyChoiceAccountIds = new List<long>();
                if (string.IsNullOrEmpty(configuValue)) return wellCareEasyChoiceAccountIds;
                ...
                foreach (var hospitalIdstr in partnerIdsArray)
                {
                    ...
                    if (pcpAccountId > 0)
                    {
                        wellCareEasyChoiceAccountIds.Add(pcpAccountId);
                    }
                }

                return wellCareEasyChoiceAccountIds;
            }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("OutboundChaseParseIntervalHours")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("OutboundFileImportIntervalHours")); }
        }
        ...
        public int OutboundCareCodingParseIntervalHours
        {
            get
            {
                return Convert.ToInt32(ConfigurationManager.AppSettings.Get("OutboundCareCodingParseIntervalHours"));
            }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("ResponseVendorReportInterval")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("ConditionInboundReportInterval")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("BarrierInboundReportInterval")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("LabsInboundReportInterval")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("InterviewInboundReportInterval")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("CrosswalkInboundReportInterval")); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("FloridaBlueSettingResourcePath"); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings.Get("OptumZipFolderPostToPath"); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("CrosswalkLabInboundReportInterval")); }
        }
        ...
        public long BcbsMnAccountId { get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("BcbsMnAccountId")); } }
        ...
        public long MonarchAccountId { get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MonarchAccountId")); } }

        public long AnthemAccountId { get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("AnthemAccountId")); } }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("DailyPatientRecapReportScheduleTime")); }
        }
        ...
        public IEnumerable<long> AccountIdsForEventFileImport
        {
            get
            {
                ...
                var healthPlansArray = configValue.Split(',').Where(healthPlanId => !string.IsNullOrEmpty(healthPlanId)).Select(healthPlanId => healthPlanId.Trim());
        ...
        public long BcbsMiAccountId { get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("BcbsMiAccountId")); } }

        public string BcbsMiResultReportDownloadPath { get { return ConfigurationManager.AppSettings.Get("BcbsMiResultReportDownloadPath"); } }

        public string BcbsMiResultPdfDownloadPath { get { return ConfigurationManager.AppSettings.Get("BcbsMiResultPdfDownloadPath"); } }
        ...
        public string[] BcbsMiRiskPatientTags
        {
            get
            {
                ...
                bcbsMiRiskPatientTags = bcbsMiRiskPatientTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        public DayOfWeek BcbsMiIncorrectPhoneExportDay
        {
            get
            {
                ...
                {
                    int bcbsMiExportDay;
                    int.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiIncorrectPhoneExportDay"), out bcbsMiExportDay);
                    if (bcbsMiExportDay >= 0 && bcbsMiExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("BcbsMiIncorrectPhoneExportDay"));
                    }
                }
                catch (Exception)
                {
        ...
        public DayOfWeek BcbsMiHomeVisitExportDay
        {
            get
            {
                try
                {
                    ...
                    if (bcbsMiExportDay >= 0 && bcbsMiExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("BcbsMiHomeVisitExportDay"));
                    }
                }
                catch (Exception)
                {
        ...
        public string ServiceReportSettingPath { get { return ConfigurationManager.AppSettings.Get("ServiceReportSettingPath"); } }
        ...
        public DayOfWeek BcbsMiReportingServiceDayOfWeek
        {
            get
            {
                ...
                {
                    int bcbsMiExportDay;
                    int.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiReportingServiceDayOfWeek"), out bcbsMiExportDay);
                    if (bcbsMiExportDay >= 0 && bcbsMiExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("BcbsMiReportingServiceDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        public string BcbsMiPcpResultMailedReportSettingPath { get { return ConfigurationManager.AppSettings.Get("BcbsMiPcpResultMailedReportSettingPath"); } }

        public DateTime BcbsMiPcpResultMailedReportScheduleTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("BcbsMiPcpResultMailedReportScheduleTime")); }
        }
        ...
        public int BcbsMiPcpResultMailedReportIntervalHours
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiPcpResultMailedReportIntervalHours"), out hours);
                return (hours < 0 ? 12 : hours);
            }
        }
        ...
        public DayOfWeek BcbsMiPcpResultMailedReportDayOfWeek
        {
            get
            {
                ...
                {
                    int bcbsMiExportDay;
                    int.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiPcpResultMailedReportDayOfWeek"), out bcbsMiExportDay);
                    if (bcbsMiExportDay >= 0 && bcbsMiExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("BcbsMiPcpResultMailedReportDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        public string BcbsMiMemberResultMailedReportSettingPath { get { return ConfigurationManager.AppSettings.Get("BcbsMiMemberResultMailedReportSettingPath"); } }

        public DateTime BcbsMiMemberResultMailedReportScheduleTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("BcbsMiMemberResultMailedReportScheduleTime")); }
        }
        ...
        public int BcbsMiMemberResultMailedReportIntervalHours
        {
            ...
            {
                int hours = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiMemberResultMailedReportIntervalHours"), out hours);
                return (hours < 0 ? 12 : hours);
            }
        }
        ...
        public DayOfWeek BcbsMiMemberResultMailedReportDayOfWeek
        {
            get
            {
                ...
                {
                    int bcbsMiExportDay;
                    int.TryParse(ConfigurationManager.AppSettings.Get("BcbsMiMemberResultMailedReportDayOfWeek"), out bcbsMiExportDay);
                    if (bcbsMiExportDay >= 0 && bcbsMiExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("BcbsMiMemberResultMailedReportDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        public IEnumerable<long> DoNotSendHomeVistIncorrectPhoneNumberAccountIds
        {
            get
            {
                var configuValue = ConfigurationManager.AppSettings.Get("DoNotSendHomeVistIncorrectPhoneNumberAccountIds");
                var pcpAccountIds = new List<long>();
                if (string.IsNullOrEmpty(configuValue)) return pcpAccountIds;
        ...
        //Start - Well Care PCP Summary Log Properties
        public string WellCarePcpSummaryLogDownloadPath
        {
            get { return ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogDownloadPath"); }
        }

        public string WellCarePcpSummaryLogReportSettingPath
        {
            get { return ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogReportSettingPath"); }
        }
        ...
        public DayOfWeek WellCarePcpSummaryLogReportDayOfWeek
        {
            get
            {
                try
                {
                    int pcpSummaryLogExportDay;
                    int.TryParse(ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogReportDayOfWeek"), out pcpSummaryLogExportDay);
                    if (pcpSummaryLogExportDay >= 0 && pcpSummaryLogExportDay <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogReportDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogReportScheduleTime")); }
        }

        public int WellCarePcpSummaryLogReportIntervalHours
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogReportIntervalHours")); }
        }

        public DateTime WellCarePcpSummaryLogCutOfDate
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("WellCarePcpSummaryLogCutOfDate")); }
        }
        //End - Well Care PCP Summary Log Properties
        ...
        public string[] ExcellusCustomTags
        {
            get
            {
                ...
                excellusCustomTags = excellusCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        public string[] HealthNowCustomTags
        {
            get
            {
                ...
                healthNowCustomTags = healthNowCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        public IEnumerable<long> GiftCertificateReportDownloadAccountIds
        {
            get
            {
                ...
                var gCAccountIdsArray = configuValue.Split(',').Where(gCAccountIdstr => !string.IsNullOrEmpty(gCAccountIdstr)).Select(x => x.Trim());
        ...
        public IEnumerable<DayOfWeek> GiftCertificateReportDaysOfWeek
        {
            get
            {
                ...
                return new List<DayOfWeek> { DayOfWeek.Monday, DayOfWeek.Thursday };
            }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("GiftCertificateReportScheduleTime")); }
        }
        ...
        public bool HideQuantaFloAbiSection
        {
            get
            {
                ...
                bool.TryParse(ConfigurationManager.AppSettings.Get("HideQuantaFloAbiSection"), out hideQuantaFloAbiSection);
        ...
        public DateTime LoincLabDataParseScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("LoincLabDataParseScheduleTime"));
            }
        }
        ...
        public DateTime LoincCrosswalkParseScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("LoincCrosswalkParseScheduleTime"));
            }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("HourlyAppointmentBookedIntervalHours")); }
        }
        ...
        public DayOfWeek FloridaBlueReportsDayOfWeek
        {
            get
            {
                try
                {
                    ...
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("FloridaBlueReportsDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        public string[] FloridaBlueMedicareCustomTags
        {
            get
            {
                ...
                floridaBlueMedicareCustomTags = floridaBlueMedicareCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        public string[] FloridaBlueCommercialCustomTags
        {
            get
            {
                ...
                floridaBlueCommercialCustomTags = floridaBlueCommercialCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("HourlyOutreachCallReportIntervalHours")); }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("PatientKareoIntegrationSchedulingTime")); }
        }
        ...
        public DateTime FromDateForGapPatient
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("FromDateForGapPatient"));
            }
        }
        ...
        public string MonarchResultPdfArchive
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MonarchResultPdfArchive");
            }
        }
        ...
        public DateTime HealthPlanEventZipScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HealthPlanEventZipScheduleTime"));
            }
        }
        ...
        public DateTime HealthPlanEventZipQueueNotGeneratedScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HealthPlanEventZipQueueNotGeneratedScheduleTime"));
            }
        }

        public int HealthPlanEventZipQueueNotGeneratedInterval
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("HealthPlanEventZipQueueNotGeneratedInterval")); }
        }
        ...
        public DateTime HkynGenerationDate
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HkynGenerationDate"));
            }
        }
        ...
        public string ClinicalDoumentPath { get { return ConfigurationManager.AppSettings.Get("ClinicalDoumentPath"); } }

        public string ClinicalDoumentSettingPath { get { return ConfigurationManager.AppSettings.Get("ClinicalDoumentSettingPath"); } }
        ...
        public long AppleCareAccountId
        {
            ...
            {
                int dayOfMonth = 0;
                Int32.TryParse(ConfigurationManager.AppSettings.Get("AppleCareAccountId"), out dayOfMonth);
                return dayOfMonth;
            }
        }
        ...
        public DayOfWeek AppleCareAppointmentBookedReportDayOfWeek
        {
            get
            {
                try
                {
                    ...
                    if (floridaBlueReportsDayOfWeek >= 0 && floridaBlueReportsDayOfWeek <= 6)
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("AppleCareAppointmentBookedReportDayOfWeek"));
                    }
                }
                catch (Exception)
                {
        ...
        public string BioCheckAssessmentFailedListPath { get { return ConfigurationManager.AppSettings.Get("BioCheckAssessmentFailedListPath"); } }
        ...
        public string DailyVolumeReportPath { get { return ConfigurationManager.AppSettings.Get("DailyVolumeReportPath"); } }
        ...
        public string EventListGmsReportPath { get { return ConfigurationManager.AppSettings.Get("EventListGmsReportPath"); } }
        ...
        public string TwilioFilePath { get { return ConfigurationManager.AppSettings.Get("TwilioFilePath"); } }

        public string GmsDialerFilePath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("GmsDialerFilePath");
            }
        }
        ...
        public string EventScheduleReportPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("EventScheduleReportPath");
            }
        }
        ...
        public string MailRoundCustomersReportDestinantionPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MailRoundCustomersReportDestinantionPath");
            }
        }

        public DateTime MailRoundCustomersReportScheduleTime
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("MailRoundCustomersReportScheduleTime")); }
        }

        public int MailRoundCustomersReportIntervalHours
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MailRoundCustomersReportIntervalHours")); }
        }
        ...
        public string BiWeeklyMicroAlbuminFobtReportPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("BiWeeklyMicroAlbuminFobtReportPath");
            }
        }
        public bool SendBiWeeklyMicroAlbuminFobtReportToSftp
        {
            ...
            {
                bool sendReportToWellmed;
                bool.TryParse(ConfigurationManager.AppSettings.Get("SendBiWeeklyMicroAlbuminFobtReportToSftp"), out sendReportToWellmed);
                return sendReportToWellmed;
            }
        }
        public DateTime BiWeeklyMicroAlbuminFobtCutoffDate
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("BiWeeklyMicroAlbuminFobtCutoffDate")); }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("BiWeeklyMicroAlbuminFobtScheduleTime")); }
        }
        public int BiWeeklyMicroAlbuminFobtIntervalHours
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("BiWeeklyMicroAlbuminFobtIntervalHours")); }
        }

        public string EventScheduleReportSftpPath { get { return ConfigurationManager.AppSettings.Get("EventScheduleReportSftpPath"); } }
        ...
        public bool SendNonTargetableReportToSftp
        {
            ...
            {
                bool sendReportToWellmed;
                bool.TryParse(ConfigurationManager.AppSettings.Get("SendNonTargetableReportToSftp"), out sendReportToWellmed);
                return sendReportToWellmed;
            }
        }
        ...
        public string NonTargetableReportPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("NonTargetableReportPath");
            }
        }
        ...
        public string PcpChangeReportPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("PcpChangeReportPath");
            }
        }
        ...
        public DateTime HousecallOutreachReportCutOfDate
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HousecallOutreachReportCutOfDate"));
            }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HousecallHafResultReportDownloadTime")); }
        }

        public int HousecallHafResultReportDownloadInterval
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("HousecallHafResultReportDownloadInterval")); }
        }
        ...
        public bool WellmedMemberStatusReportSendToSftp
        {
            get
            {
                ...
                bool.TryParse(ConfigurationManager.AppSettings.Get("WellmedMemberStatusReportSendToSftp"), out wellmedMemberStatusReportSendToSftp);
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("StaffEventScheduleParseIntervalMinutes")); }
        }
        ...
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MedicareMedicationSyncIntervalMinute")); }
        }

        public int MedicationFileParserIntervalMinute
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MedicationFileParserIntervalMinute")); }
        }

        public int CustomerForMedicationSyncCutoffDays
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("CustomerForMedicationSyncCutoffDays")); }
        }
        ...
        public string[] FloridaBlueMammoCustomTags
        {
            get
            {
                ...
                floridaBlueMammoCustomTags = floridaBlueMammoCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        public DateTime ChecklistChangeDate
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("ChecklistChangeDate"));
            }
        }
        ...
        public string OptumUtCustomTagsForGms
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("OptumUtCustomTagsForGms");
            }
        }
        ...
        public string CustomerConsentDataFilePath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("CustomerConsentDataFilePath");
            }
        }
        ...
        public string CustomerConsentDataReportSftpPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("CustomerConsentDataReportSftpPath");
            }
        }
        ...
        public bool CustomerConsentDataReportSendToSftp
        {
            get
            {
                ...
                bool.TryParse(ConfigurationManager.AppSettings.Get("CustomerConsentDataReportSendToSftp"), out customerConsentDataReportSendToSftp);
        ...
        public string CustomerConsentDataReportSettingPath
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("CustomerConsentDataReportSettingPath");
            }
        }
        ...
        public string MatrixSftpHost
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MatrixSftpHost");
            }
        }
        ...
        public string MatrixSftpUserName
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MatrixSftpUserName");
            }
        }
        ...
        public string MatrixSftpPassword
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("MatrixSftpPassword");
            }
        }
        ...
        public string ConsentHeaderFormUrl
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("ConsentHeaderFormUrl");
            }
        }
        ...
        public DateTime MedicareSuspectConditionSyncScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("MedicareSuspectConditionSyncScheduleTime"));
            }
        }

        public int MedicareSuspectConditionSyncIntervalHour
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MedicareSuspectConditionSyncIntervalHour")); }
        }

        public int MedicareSuspectConditionSyncIntervalMinute
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("MedicareSuspectConditionSyncIntervalMinute")); }
        }
        ...
        public DateTime GiftCerificateOptumScheduledTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("GiftCerificateOptumScheduledTime"));
            }
        }
        public int GiftCerificateOptumScheduledInterval
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("GiftCerificateOptumScheduledInterval")); }
        }
        ...
        {
            get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("AccountZipSubstituteRegenerationScheduleTime")); }
        }

        public int AccountZipSubstituteRegenerationInterval
        {
            get { return Convert.ToInt32(ConfigurationManager.AppSettings.Get("AccountZipSubstituteRegenerationInterval")); }
        }
        ...
        public bool RegenerateAccountEventZip
        {
            get
            {
                ...
                bool.TryParse(ConfigurationManager.AppSettings.Get("RegenerateAccountEventZip"), out regenerateAccountEventZip);
        ...
        public string[] FloridaBlueGapsCustomTags
        {
            get
            {
                ...
                floridaBlueGapsCustomTags = floridaBlueGapsCustomTags.Where(x => !string.IsNullOrWhiteSpace(x)).Select(x => x.Trim()).ToArray();
        ...
        {
            get { return Convert.ToString(ConfigurationManager.AppSettings.Get("BcbsmiDateAddedIncorrectPhoneNumberSettingPath")); }
        }
        ...
        public DateTime ResultFlowChangeDate { get { return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("ResultFlowChangeDate")); } }
        ...
        public DayOfWeek ConnecticareEventScheduleExportDay
        {
            get
            {
                try
                {
                    ...
                    {
                        return (DayOfWeek)Enum.Parse(typeof(DayOfWeek), ConfigurationManager.AppSettings.Get("ConnecticareEventScheduleExportDay"));
                    }
                }
                catch (Exception)
                {
        ...
        public DateTime HiptoAcesCrossWalkReportScheduleTime
        {
            get
            {
                return Convert.ToDateTime(ConfigurationManager.AppSettings.Get("HiptoAcesCrossWalkReportScheduleTime"));
            }
        }
        ...
        public string BcbsScFolder { get { return ConfigurationManager.AppSettings.Get("BcbsScFolder"); } }
