...
namespace AuthorizeNet {
    public interface ICustomerGateway {
        ...
        string ValidateProfile(string profileID, string paymentProfileID, string shippingAddressID, AuthorizeNet.ServiceMode mode);
        string ValidateProfile(string profileID, string paymentProfileID, AuthorizeNet.ServiceMode mode);
