...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'CustomerHealthQuestionGroup'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CustomerHealthQuestionGroupEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CustomerHealthQuestionGroupEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public CustomerHealthQuestionGroupEntity():base("CustomerHealthQuestionGroupEntity")
		{
		...
		public CustomerHealthQuestionGroupEntity(IEntityFields2 fields):base("CustomerHealthQuestionGroupEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CustomerHealthQuestionGroupEntity</param>
		public CustomerHealthQuestionGroupEntity(IValidator validator):base("CustomerHealthQuestionGroupEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="customerHealthQuestionGroupId">PK value for CustomerHealthQuestionGroup which data should be fetched into this CustomerHealthQuestionGroup object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerHealthQuestionGroupEntity(System.Int64 customerHealthQuestionGroupId):base("CustomerHealthQuestionGroupEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.CustomerHealthQuestionGroupId = customerHealthQuestionGroupId;
		}
		...
		/// <param name="validator">The custom validator object for this CustomerHealthQuestionGroupEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerHealthQuestionGroupEntity(System.Int64 customerHealthQuestionGroupId, IValidator validator):base("CustomerHealthQuestionGroupEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.CustomerHealthQuestionGroupId = customerHealthQuestionGroupId;
		}
		...
		protected CustomerHealthQuestionGroupEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((CustomerHealthQuestionGroupFieldIndex)fieldIndex)
			{
				case CustomerHealthQuestionGroupFieldIndex.TestId:
		...
		{
			return CustomerHealthQuestionGroupEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Test":
					toReturn.Add(CustomerHealthQuestionGroupEntity.Relations.TestEntityUsingTestId);
					break;
				case "CustomerHealthQuestions":
					toReturn.Add(CustomerHealthQuestionGroupEntity.Relations.CustomerHealthQuestionsEntityUsingCustomerHealthQuestionGroupId);
					break;
				case "CustomerHealthQuestionsCollectionViaCustomerHealthQuestions":
					toReturn.Add(CustomerHealthQuestionGroupEntity.Relations.CustomerHealthQuestionsEntityUsingCustomerHealthQuestionGroupId, "CustomerHealthQuestionGroupEntity__", "CustomerHealthQuestions_", JoinHint.None);
		...
		public bool TestOriginalFieldValueForNull(CustomerHealthQuestionGroupFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CustomerHealthQuestionGroupFieldIndex fieldIndex)
		{
		...
		{
			return new CustomerHealthQuestionGroupRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoCustomerHealthQuestions()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CustomerHealthQuestionsFields.CustomerHealthQuestionGroupId, null, ComparisonOperator.Equal, this.CustomerHealthQuestionGroupId));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoCustomerHealthQuestionsCollectionViaCustomerHealthQuestions()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CustomerHealthQuestionGroupFields.CustomerHealthQuestionGroupId, null, ComparisonOperator.Equal, this.CustomerHealthQuestionGroupId, "CustomerHealthQuestionGroupEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.CustomerHealthQuestionGroupEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CustomerHealthQuestionGroupEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("IsClinicalQuestions", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", CustomerHealthQuestionGroupEntity.Relations.TestEntityUsingTestId, true, signalRelatedEntity, "CustomerHealthQuestionGroup", resetFKFields, new int[] { (int)CustomerHealthQuestionGroupFieldIndex.TestId } );		
			_test = null;
		}
		...
		private void SetupSyncTest(IEntity2 relatedEntity)
		{
			if(_test!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", CustomerHealthQuestionGroupEntity.Relations.TestEntityUsingTestId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CustomerHealthQuestionGroupEntity</param>
		...
		public  static CustomerHealthQuestionGroupRelations Relations
		{
			get	{ return new CustomerHealthQuestionGroupRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerHealthQuestions
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<CustomerHealthQuestionsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerHealthQuestionsEntityFactory))),
					(IEntityRelation)GetRelationsForField("CustomerHealthQuestions")[0], (int)Falcon.Data.EntityType.CustomerHealthQuestionGroupEntity, (int)Falcon.Data.EntityType.CustomerHealthQuestionsEntity, 0, null, null, null, null, "CustomerHealthQuestions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerHealthQuestionsCollectionViaCustomerHealthQuestions
		{
			get
			{
				IEntityRelation intermediateRelation = CustomerHealthQuestionGroupEntity.Relations.CustomerHealthQuestionsEntityUsingCustomerHealthQuestionGroupId;
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaCustomerHealthQuestions
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.CustomerHealthQuestionGroupEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaCustomerHealthQuestions"), null, "LookupCollectionViaCustomerHealthQuestions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTest
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))),
					(IEntityRelation)GetRelationsForField("Test")[0], (int)Falcon.Data.EntityType.CustomerHealthQuestionGroupEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, null, null, "Test", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return CustomerHealthQuestionGroupEntity.CustomProperties;}
		}
		...
		{
			get { return CustomerHealthQuestionGroupEntity.FieldsCustomProperties;}
		}

		/// <summary> The CustomerHealthQuestionGroupId property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."CustomerHealthQuestionGroupID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 CustomerHealthQuestionGroupId
		{
			get { return (System.Int64)GetValue((int)CustomerHealthQuestionGroupFieldIndex.CustomerHealthQuestionGroupId, true); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.CustomerHealthQuestionGroupId, value); }
		}

		/// <summary> The Name property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)CustomerHealthQuestionGroupFieldIndex.Name, true); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.Name, value); }
		}

		/// <summary> The Description property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)CustomerHealthQuestionGroupFieldIndex.Description, true); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.Description, value); }
		}

		/// <summary> The IsActive property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)CustomerHealthQuestionGroupFieldIndex.IsActive, true); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.IsActive, value); }
		}

		/// <summary> The IsClinicalQuestions property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."IsClinicalQuestions"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsClinicalQuestions
		{
			get { return (System.Boolean)GetValue((int)CustomerHealthQuestionGroupFieldIndex.IsClinicalQuestions, true); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.IsClinicalQuestions, value); }
		}

		/// <summary> The TestId property of the Entity CustomerHealthQuestionGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerHealthQuestionGroup"."TestId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> TestId
		{
			get { return (Nullable<System.Int64>)GetValue((int)CustomerHealthQuestionGroupFieldIndex.TestId, false); }
			set	{ SetValue((int)CustomerHealthQuestionGroupFieldIndex.TestId, value); }
		}
		...
		public virtual EntityCollection<CustomerHealthQuestionsEntity> CustomerHealthQuestions
		{
			get
			{
				if(_customerHealthQuestions==null)
				{
					...
					_customerHealthQuestions.SetContainingEntityInfo(this, "CustomerHealthQuestionGroup");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_test != null)
						{
							_test.UnsetRelatedEntity(this, "CustomerHealthQuestionGroup");
						}
					}
					else
					{
						if(_test!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "CustomerHealthQuestionGroup");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.CustomerHealthQuestionGroupEntity; }
		}
		#endregion
