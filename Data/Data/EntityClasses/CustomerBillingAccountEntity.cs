...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'CustomerBillingAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CustomerBillingAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CustomerBillingAccountEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public CustomerBillingAccountEntity():base("CustomerBillingAccountEntity")
		{
		...
		public CustomerBillingAccountEntity(IEntityFields2 fields):base("CustomerBillingAccountEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CustomerBillingAccountEntity</param>
		public CustomerBillingAccountEntity(IValidator validator):base("CustomerBillingAccountEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="customerId">PK value for CustomerBillingAccount which data should be fetched into this CustomerBillingAccount object</param>
		/// <param name="billingAccountId">PK value for CustomerBillingAccount which data should be fetched into this CustomerBillingAccount object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerBillingAccountEntity(System.Int64 customerId, System.Int64 billingAccountId):base("CustomerBillingAccountEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this CustomerBillingAccountEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerBillingAccountEntity(System.Int64 customerId, System.Int64 billingAccountId, IValidator validator):base("CustomerBillingAccountEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.CustomerId = customerId;
			this.BillingAccountId = billingAccountId;
		...
		{
			switch((CustomerBillingAccountFieldIndex)fieldIndex)
			{
				case CustomerBillingAccountFieldIndex.CustomerId:
					DesetupSyncCustomerProfile(true, false);
					break;
				case CustomerBillingAccountFieldIndex.BillingAccountId:
		...
		{
			return CustomerBillingAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "BillingAccount":
					toReturn.Add(CustomerBillingAccountEntity.Relations.BillingAccountEntityUsingBillingAccountId);
					break;
				case "CustomerProfile":
					toReturn.Add(CustomerBillingAccountEntity.Relations.CustomerProfileEntityUsingCustomerId);
					break;
		...
		public bool TestOriginalFieldValueForNull(CustomerBillingAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CustomerBillingAccountFieldIndex fieldIndex)
		{
		...
		{
			return new CustomerBillingAccountRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.CustomerBillingAccountEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CustomerBillingAccountEntityFactory));
		}
#if !CF
		...
		private void SetupSyncCustomerProfile(IEntity2 relatedEntity)
		{
			if(_customerProfile!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _customerProfile, new PropertyChangedEventHandler( OnCustomerProfilePropertyChanged ), "CustomerProfile", CustomerBillingAccountEntity.Relations.CustomerProfileEntityUsingCustomerId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CustomerBillingAccountEntity</param>
		...
		public  static CustomerBillingAccountRelations Relations
		{
			get	{ return new CustomerBillingAccountRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBillingAccount
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BillingAccountEntityFactory))),
					(IEntityRelation)GetRelationsForField("BillingAccount")[0], (int)Falcon.Data.EntityType.CustomerBillingAccountEntity, (int)Falcon.Data.EntityType.BillingAccountEntity, 0, null, null, null, null, "BillingAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("CustomerProfile")[0], (int)Falcon.Data.EntityType.CustomerBillingAccountEntity, (int)Falcon.Data.EntityType.CustomerProfileEntity, 0, null, null, null, null, "CustomerProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return CustomerBillingAccountEntity.CustomProperties;}
		}
		...
		{
			get { return CustomerBillingAccountEntity.FieldsCustomProperties;}
		}

		/// <summary> The CustomerId property of the Entity CustomerBillingAccount<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerBillingAccount"."CustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CustomerId
		{
			get { return (System.Int64)GetValue((int)CustomerBillingAccountFieldIndex.CustomerId, true); }
			set	{ SetValue((int)CustomerBillingAccountFieldIndex.CustomerId, value); }
		}

		/// <summary> The BillingAccountId property of the Entity CustomerBillingAccount<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerBillingAccount"."BillingAccountId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 BillingAccountId
		{
			get { return (System.Int64)GetValue((int)CustomerBillingAccountFieldIndex.BillingAccountId, true); }
			set	{ SetValue((int)CustomerBillingAccountFieldIndex.BillingAccountId, value); }
		}

		/// <summary> The BillingPatientId property of the Entity CustomerBillingAccount<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerBillingAccount"."BillingPatientId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 BillingPatientId
		{
			get { return (System.Int64)GetValue((int)CustomerBillingAccountFieldIndex.BillingPatientId, true); }
			set	{ SetValue((int)CustomerBillingAccountFieldIndex.BillingPatientId, value); }
		}

		/// <summary> The DateCreated property of the Entity CustomerBillingAccount<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblCustomerBillingAccount"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)CustomerBillingAccountFieldIndex.DateCreated, true); }
			set	{ SetValue((int)CustomerBillingAccountFieldIndex.DateCreated, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_billingAccount != null)
						{
							_billingAccount.UnsetRelatedEntity(this, "CustomerBillingAccount");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "CustomerBillingAccount");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_customerProfile != null)
						{
							_customerProfile.UnsetRelatedEntity(this, "CustomerBillingAccount");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.CustomerBillingAccountEntity; }
		}
		#endregion
