...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'SurveyTemplate'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SurveyTemplateEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<EventsEntity> _eventsCollectionViaEventSurveyTemplate;
		...
		private EntityCollection<SurveyQuestionEntity> _surveyQuestionCollectionViaSurveyTemplateQuestion;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name EventsCollectionViaEventSurveyTemplate</summary>
			public static readonly string EventsCollectionViaEventSurveyTemplate = "EventsCollectionViaEventSurveyTemplate";
			...
			/// <summary>Member name SurveyQuestionCollectionViaSurveyTemplateQuestion</summary>
			public static readonly string SurveyQuestionCollectionViaSurveyTemplateQuestion = "SurveyQuestionCollectionViaSurveyTemplateQuestion";

		}
		#endregion
		
		/// <summary> Static CTor for setting up custom property hashtables. Is executed before the first instance of this entity class or derived classes is constructed. </summary>
		static SurveyTemplateEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public SurveyTemplateEntity():base("SurveyTemplateEntity")
		{
		...
		public SurveyTemplateEntity(IEntityFields2 fields):base("SurveyTemplateEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SurveyTemplateEntity</param>
		public SurveyTemplateEntity(IValidator validator):base("SurveyTemplateEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for SurveyTemplate which data should be fetched into this SurveyTemplate object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SurveyTemplateEntity(System.Int64 id):base("SurveyTemplateEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this SurveyTemplateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SurveyTemplateEntity(System.Int64 id, IValidator validator):base("SurveyTemplateEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.Id = id;
		}
		...
		protected SurveyTemplateEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_eventsCollectionViaEventSurveyTemplate = (EntityCollection<EventsEntity>)info.GetValue("_eventsCollectionViaEventSurveyTemplate", typeof(EntityCollection<EventsEntity>));
				...
				_surveyQuestionCollectionViaSurveyTemplateQuestion = (EntityCollection<SurveyQuestionEntity>)info.GetValue("_surveyQuestionCollectionViaSurveyTemplateQuestion", typeof(EntityCollection<SurveyQuestionEntity>));
		...
		{
			switch((SurveyTemplateFieldIndex)fieldIndex)
			{
				case SurveyTemplateFieldIndex.CreatedBy:
					DesetupSyncOrganizationRoleUser(true, false);
					break;
				case SurveyTemplateFieldIndex.ModifiedBy:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "EmailTemplateCollectionViaAccount__":
					...
					break;
				case "EventsCollectionViaEventSurveyTemplate":
					this.EventsCollectionViaEventSurveyTemplate.IsReadOnly = false;
					this.EventsCollectionViaEventSurveyTemplate.Add((EventsEntity)entity);
					this.EventsCollectionViaEventSurveyTemplate.IsReadOnly = true;
					break;
				...
				case "ProspectsCollectionViaAccount":
					...
					break;
				case "SurveyQuestionCollectionViaSurveyTemplateQuestion":
					this.SurveyQuestionCollectionViaSurveyTemplateQuestion.IsReadOnly = false;
					this.SurveyQuestionCollectionViaSurveyTemplateQuestion.Add((SurveyQuestionEntity)entity);
					this.SurveyQuestionCollectionViaSurveyTemplateQuestion.IsReadOnly = true;
					break;
		...
		{
			return SurveyTemplateEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "OrganizationRoleUser_":
					toReturn.Add(SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy);
					break;
				case "OrganizationRoleUser":
					toReturn.Add(SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy);
					break;
				case "Account":
					toReturn.Add(SurveyTemplateEntity.Relations.AccountEntityUsingSurveyTemplateId);
					break;
				case "EventSurveyTemplate":
					toReturn.Add(SurveyTemplateEntity.Relations.EventSurveyTemplateEntityUsingSurveyTemplateId);
					break;
				case "SurveyTemplateQuestion":
					toReturn.Add(SurveyTemplateEntity.Relations.SurveyTemplateQuestionEntityUsingTemplateId);
					break;
				case "CheckListTemplateCollectionViaAccount":
					toReturn.Add(SurveyTemplateEntity.Relations.AccountEntityUsingSurveyTemplateId, "SurveyTemplateEntity__", "Account_", JoinHint.None);
				...
				case "EmailTemplateCollectionViaAccount__":
					...
					break;
				case "EventsCollectionViaEventSurveyTemplate":
					toReturn.Add(SurveyTemplateEntity.Relations.EventSurveyTemplateEntityUsingSurveyTemplateId, "SurveyTemplateEntity__", "EventSurveyTemplate_", JoinHint.None);
					toReturn.Add(EventSurveyTemplateEntity.Relations.EventsEntityUsingEventId, "EventSurveyTemplate_", string.Empty, JoinHint.None);
					break;
				case "FileCollectionViaAccount________":
					toReturn.Add(SurveyTemplateEntity.Relations.AccountEntityUsingSurveyTemplateId, "SurveyTemplateEntity__", "Account_", JoinHint.None);
				...
				case "ProspectsCollectionViaAccount":
					...
					break;
				case "SurveyQuestionCollectionViaSurveyTemplateQuestion":
					toReturn.Add(SurveyTemplateEntity.Relations.SurveyTemplateQuestionEntityUsingTemplateId, "SurveyTemplateEntity__", "SurveyTemplateQuestion_", JoinHint.None);
					toReturn.Add(SurveyTemplateQuestionEntity.Relations.SurveyQuestionEntityUsingQuestionId, "SurveyTemplateQuestion_", string.Empty, JoinHint.None);
					break;
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_eventsCollectionViaEventSurveyTemplate", ((_eventsCollectionViaEventSurveyTemplate!=null) && (_eventsCollectionViaEventSurveyTemplate.Count>0) && !this.MarkedForDeletion)?_eventsCollectionViaEventSurveyTemplate:null);
				...
				info.AddValue("_surveyQuestionCollectionViaSurveyTemplateQuestion", ((_surveyQuestionCollectionViaSurveyTemplateQuestion!=null) && (_surveyQuestionCollectionViaSurveyTemplateQuestion.Count>0) && !this.MarkedForDeletion)?_surveyQuestionCollectionViaSurveyTemplateQuestion:null);
		...
		public bool TestOriginalFieldValueForNull(SurveyTemplateFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SurveyTemplateFieldIndex fieldIndex)
		{
		...
		{
			return new SurveyTemplateRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoAccount()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AccountFields.SurveyTemplateId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EventSurveyTemplateFields.SurveyTemplateId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SurveyTemplateQuestionFields.TemplateId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoCheckListTemplateCollectionViaAccount()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SurveyTemplateFields.Id, null, ComparisonOperator.Equal, this.Id, "SurveyTemplateEntity__"));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEventsCollectionViaEventSurveyTemplate()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("EventsCollectionViaEventSurveyTemplate"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SurveyTemplateFields.Id, null, ComparisonOperator.Equal, this.Id, "SurveyTemplateEntity__"));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSurveyQuestionCollectionViaSurveyTemplateQuestion()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SurveyQuestionCollectionViaSurveyTemplateQuestion"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SurveyTemplateFields.Id, null, ComparisonOperator.Equal, this.Id, "SurveyTemplateEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.SurveyTemplateEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SurveyTemplateEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._eventsCollectionViaEventSurveyTemplate);
			...
			collectionsQueue.Enqueue(this._surveyQuestionCollectionViaSurveyTemplateQuestion);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._eventsCollectionViaEventSurveyTemplate = (EntityCollection<EventsEntity>) collectionsQueue.Dequeue();
			...
			this._surveyQuestionCollectionViaSurveyTemplateQuestion = (EntityCollection<SurveyQuestionEntity>) collectionsQueue.Dequeue();
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._eventsCollectionViaEventSurveyTemplate != null)
			{
				return true;
			}
			...
			if (this._surveyQuestionCollectionViaSurveyTemplateQuestion != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("EventsCollectionViaEventSurveyTemplate", _eventsCollectionViaEventSurveyTemplate);
			...
			toReturn.Add("SurveyQuestionCollectionViaSurveyTemplateQuestion", _surveyQuestionCollectionViaSurveyTemplateQuestion);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_eventsCollectionViaEventSurveyTemplate!=null)
			{
				_eventsCollectionViaEventSurveyTemplate.ActiveContext = base.ActiveContext;
			}
			...
			if(_surveyQuestionCollectionViaSurveyTemplateQuestion!=null)
			{
				_surveyQuestionCollectionViaSurveyTemplateQuestion.ActiveContext = base.ActiveContext;
			}
			if(_organizationRoleUser_!=null)
			{
		...
		protected virtual void InitClassMembers()
		{
			...
			_eventsCollectionViaEventSurveyTemplate = null;
			...
			_surveyQuestionCollectionViaSurveyTemplateQuestion = null;
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, signalRelatedEntity, "SurveyTemplate_", resetFKFields, new int[] { (int)SurveyTemplateFieldIndex.ModifiedBy } );		
			_organizationRoleUser_ = null;
		}
		...
		private void SetupSyncOrganizationRoleUser_(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser_!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, signalRelatedEntity, "SurveyTemplate", resetFKFields, new int[] { (int)SurveyTemplateFieldIndex.CreatedBy } );		
			_organizationRoleUser = null;
		}
		...
		private void SetupSyncOrganizationRoleUser(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", SurveyTemplateEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this SurveyTemplateEntity</param>
		...
		public  static SurveyTemplateRelations Relations
		{
			get	{ return new SurveyTemplateRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAccount
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<AccountEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AccountEntityFactory))),
					(IEntityRelation)GetRelationsForField("Account")[0], (int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.AccountEntity, 0, null, null, null, null, "Account", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEventSurveyTemplate
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<EventSurveyTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EventSurveyTemplateEntityFactory))),
					(IEntityRelation)GetRelationsForField("EventSurveyTemplate")[0], (int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EventSurveyTemplateEntity, 0, null, null, null, null, "EventSurveyTemplate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSurveyTemplateQuestion
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<SurveyTemplateQuestionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SurveyTemplateQuestionEntityFactory))),
					(IEntityRelation)GetRelationsForField("SurveyTemplateQuestion")[0], (int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.SurveyTemplateQuestionEntity, 0, null, null, null, null, "SurveyTemplateQuestion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCheckListTemplateCollectionViaAccount
		{
			get
			{
				IEntityRelation intermediateRelation = SurveyTemplateEntity.Relations.AccountEntityUsingSurveyTemplateId;
				...
				return new PrefetchPathElement2(new EntityCollection<CheckListTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CheckListTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.CheckListTemplateEntity, 0, null, null, GetRelationsForField("CheckListTemplateCollectionViaAccount"), null, "CheckListTemplateCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCheckListTemplateCollectionViaAccount_
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<CheckListTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CheckListTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.CheckListTemplateEntity, 0, null, null, GetRelationsForField("CheckListTemplateCollectionViaAccount_"), null, "CheckListTemplateCollectionViaAccount_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmailTemplateCollectionViaAccount
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmailTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EmailTemplateEntity, 0, null, null, GetRelationsForField("EmailTemplateCollectionViaAccount"), null, "EmailTemplateCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmailTemplateCollectionViaAccount_
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<EmailTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EmailTemplateEntity, 0, null, null, GetRelationsForField("EmailTemplateCollectionViaAccount_"), null, "EmailTemplateCollectionViaAccount_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmailTemplateCollectionViaAccount___
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<EmailTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EmailTemplateEntity, 0, null, null, GetRelationsForField("EmailTemplateCollectionViaAccount___"), null, "EmailTemplateCollectionViaAccount___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmailTemplateCollectionViaAccount__
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<EmailTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EmailTemplateEntity, 0, null, null, GetRelationsForField("EmailTemplateCollectionViaAccount__"), null, "EmailTemplateCollectionViaAccount__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEventsCollectionViaEventSurveyTemplate
		{
			get
			{
				IEntityRelation intermediateRelation = SurveyTemplateEntity.Relations.EventSurveyTemplateEntityUsingSurveyTemplateId;
				...
				return new PrefetchPathElement2(new EntityCollection<EventsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, GetRelationsForField("EventsCollectionViaEventSurveyTemplate"), null, "EventsCollectionViaEventSurveyTemplate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount________
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount________"), null, "FileCollectionViaAccount________", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount_____
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount_____"), null, "FileCollectionViaAccount_____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount______
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount______"), null, "FileCollectionViaAccount______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount_______
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount_______"), null, "FileCollectionViaAccount_______", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount_
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount_"), null, "FileCollectionViaAccount_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount"), null, "FileCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount__
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount__"), null, "FileCollectionViaAccount__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount____
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount____"), null, "FileCollectionViaAccount____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaAccount___
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Account_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaAccount___"), null, "FileCollectionViaAccount___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFluConsentTemplateCollectionViaAccount
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<FluConsentTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FluConsentTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.FluConsentTemplateEntity, 0, null, null, GetRelationsForField("FluConsentTemplateCollectionViaAccount"), null, "FluConsentTemplateCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHafTemplateCollectionViaAccount
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HafTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HafTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.HafTemplateEntity, 0, null, null, GetRelationsForField("HafTemplateCollectionViaAccount"), null, "HafTemplateCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaAccount
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaAccount"), null, "LookupCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProspectsCollectionViaAccount
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProspectsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProspectsEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.ProspectsEntity, 0, null, null, GetRelationsForField("ProspectsCollectionViaAccount"), null, "ProspectsCollectionViaAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSurveyQuestionCollectionViaSurveyTemplateQuestion
		{
			get
			{
				IEntityRelation intermediateRelation = SurveyTemplateEntity.Relations.SurveyTemplateQuestionEntityUsingTemplateId;
				...
				return new PrefetchPathElement2(new EntityCollection<SurveyQuestionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SurveyQuestionEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.SurveyQuestionEntity, 0, null, null, GetRelationsForField("SurveyQuestionCollectionViaSurveyTemplateQuestion"), null, "SurveyQuestionCollectionViaSurveyTemplateQuestion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser_
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser_")[0], (int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser
		{
			...
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser")[0], (int)Falcon.Data.EntityType.SurveyTemplateEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return SurveyTemplateEntity.CustomProperties;}
		}
		...
		{
			get { return SurveyTemplateEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 Id
		{
			get { return (System.Int64)GetValue((int)SurveyTemplateFieldIndex.Id, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.Id, value); }
		}

		/// <summary> The Name property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 255<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)SurveyTemplateFieldIndex.Name, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.Name, value); }
		}

		/// <summary> The IsActive property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)SurveyTemplateFieldIndex.IsActive, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.IsActive, value); }
		}

		/// <summary> The IsPublished property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."IsPublished"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsPublished
		{
			get { return (System.Boolean)GetValue((int)SurveyTemplateFieldIndex.IsPublished, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.IsPublished, value); }
		}

		/// <summary> The DateCreated property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)SurveyTemplateFieldIndex.DateCreated, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateModified property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."DateModified"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> DateModified
		{
			get { return (Nullable<System.DateTime>)GetValue((int)SurveyTemplateFieldIndex.DateModified, false); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.DateModified, value); }
		}

		/// <summary> The CreatedBy property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 CreatedBy
		{
			get { return (System.Int64)GetValue((int)SurveyTemplateFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.CreatedBy, value); }
		}

		/// <summary> The ModifiedBy property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."ModifiedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ModifiedBy
		{
			get { return (Nullable<System.Int64>)GetValue((int)SurveyTemplateFieldIndex.ModifiedBy, false); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.ModifiedBy, value); }
		}

		/// <summary> The IsDefault property of the Entity SurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyTemplate"."IsDefault"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsDefault
		{
			get { return (System.Boolean)GetValue((int)SurveyTemplateFieldIndex.IsDefault, true); }
			set	{ SetValue((int)SurveyTemplateFieldIndex.IsDefault, value); }
		}
		...
		public virtual EntityCollection<AccountEntity> Account
		{
			get
			{
				if(_account==null)
				{
					...
					_account.SetContainingEntityInfo(this, "SurveyTemplate");
				}
				return _account;
			}
		}
		...
		public virtual EntityCollection<EventSurveyTemplateEntity> EventSurveyTemplate
		{
			get
			{
				if(_eventSurveyTemplate==null)
				{
					...
					_eventSurveyTemplate.SetContainingEntityInfo(this, "SurveyTemplate");
				}
		...
		public virtual EntityCollection<SurveyTemplateQuestionEntity> SurveyTemplateQuestion
		{
			get
			{
				if(_surveyTemplateQuestion==null)
				{
					...
					_surveyTemplateQuestion.SetContainingEntityInfo(this, "SurveyTemplate");
				}
		...
		public virtual EntityCollection<EventsEntity> EventsCollectionViaEventSurveyTemplate
		{
			get
			{
				if(_eventsCollectionViaEventSurveyTemplate==null)
				{
					_eventsCollectionViaEventSurveyTemplate = new EntityCollection<EventsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory)));
					_eventsCollectionViaEventSurveyTemplate.IsReadOnly=true;
				}
				return _eventsCollectionViaEventSurveyTemplate;
			}
		}
		...
		public virtual EntityCollection<SurveyQuestionEntity> SurveyQuestionCollectionViaSurveyTemplateQuestion
		{
			get
			{
				if(_surveyQuestionCollectionViaSurveyTemplateQuestion==null)
				{
					_surveyQuestionCollectionViaSurveyTemplateQuestion = new EntityCollection<SurveyQuestionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SurveyQuestionEntityFactory)));
					_surveyQuestionCollectionViaSurveyTemplateQuestion.IsReadOnly=true;
				}
				return _surveyQuestionCollectionViaSurveyTemplateQuestion;
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser_ != null)
						{
							_organizationRoleUser_.UnsetRelatedEntity(this, "SurveyTemplate_");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "SurveyTemplate_");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser != null)
						{
							_organizationRoleUser.UnsetRelatedEntity(this, "SurveyTemplate");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "SurveyTemplate");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.SurveyTemplateEntity; }
		}
		#endregion
