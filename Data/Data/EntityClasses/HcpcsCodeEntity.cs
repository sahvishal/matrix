...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'HcpcsCode'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class HcpcsCodeEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static HcpcsCodeEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public HcpcsCodeEntity():base("HcpcsCodeEntity")
		{
		...
		public HcpcsCodeEntity(IEntityFields2 fields):base("HcpcsCodeEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this HcpcsCodeEntity</param>
		public HcpcsCodeEntity(IValidator validator):base("HcpcsCodeEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for HcpcsCode which data should be fetched into this HcpcsCode object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HcpcsCodeEntity(System.Int64 id):base("HcpcsCodeEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this HcpcsCodeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HcpcsCodeEntity(System.Int64 id, IValidator validator):base("HcpcsCodeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.Id = id;
		}
		...
		protected HcpcsCodeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((HcpcsCodeFieldIndex)fieldIndex)
			{
				case HcpcsCodeFieldIndex.CreatedBy:
					DesetupSyncOrganizationRoleUser(true, false);
					break;
				case HcpcsCodeFieldIndex.ModifiedBy:
		...
		{
			return HcpcsCodeEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "OrganizationRoleUser_":
					toReturn.Add(HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy);
					break;
				case "OrganizationRoleUser":
					toReturn.Add(HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy);
					break;
				case "TestHcpcsCode":
					toReturn.Add(HcpcsCodeEntity.Relations.TestHcpcsCodeEntityUsingHcpcsCodeId);
					break;
				case "OrganizationRoleUserCollectionViaTestHcpcsCode_":
					toReturn.Add(HcpcsCodeEntity.Relations.TestHcpcsCodeEntityUsingHcpcsCodeId, "HcpcsCodeEntity__", "TestHcpcsCode_", JoinHint.None);
		...
		public bool TestOriginalFieldValueForNull(HcpcsCodeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(HcpcsCodeFieldIndex fieldIndex)
		{
		...
		{
			return new HcpcsCodeRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoTestHcpcsCode()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TestHcpcsCodeFields.HcpcsCodeId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoOrganizationRoleUserCollectionViaTestHcpcsCode_()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(HcpcsCodeFields.Id, null, ComparisonOperator.Equal, this.Id, "HcpcsCodeEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.HcpcsCodeEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(HcpcsCodeEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("CopayCost", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, signalRelatedEntity, "HcpcsCode_", resetFKFields, new int[] { (int)HcpcsCodeFieldIndex.ModifiedBy } );		
			_organizationRoleUser_ = null;
		}
		...
		private void SetupSyncOrganizationRoleUser_(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser_!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, signalRelatedEntity, "HcpcsCode", resetFKFields, new int[] { (int)HcpcsCodeFieldIndex.CreatedBy } );		
			_organizationRoleUser = null;
		}
		...
		private void SetupSyncOrganizationRoleUser(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", HcpcsCodeEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this HcpcsCodeEntity</param>
		...
		public  static HcpcsCodeRelations Relations
		{
			get	{ return new HcpcsCodeRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTestHcpcsCode
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<TestHcpcsCodeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TestHcpcsCodeEntityFactory))),
					(IEntityRelation)GetRelationsForField("TestHcpcsCode")[0], (int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.TestHcpcsCodeEntity, 0, null, null, null, null, "TestHcpcsCode", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaTestHcpcsCode_
		{
			get
			{
				IEntityRelation intermediateRelation = HcpcsCodeEntity.Relations.TestHcpcsCodeEntityUsingHcpcsCodeId;
				intermediateRelation.SetAliases(string.Empty, "TestHcpcsCode_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaTestHcpcsCode_"), null, "OrganizationRoleUserCollectionViaTestHcpcsCode_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaTestHcpcsCode
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "TestHcpcsCode_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaTestHcpcsCode"), null, "OrganizationRoleUserCollectionViaTestHcpcsCode", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTestCollectionViaTestHcpcsCode
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<TestEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, GetRelationsForField("TestCollectionViaTestHcpcsCode"), null, "TestCollectionViaTestHcpcsCode", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser_
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser_")[0], (int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser
		{
			...
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser")[0], (int)Falcon.Data.EntityType.HcpcsCodeEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return HcpcsCodeEntity.CustomProperties;}
		}
		...
		{
			get { return HcpcsCodeEntity.FieldsCustomProperties;}
		}

		/// <summary> The Id property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 Id
		{
			get { return (System.Int64)GetValue((int)HcpcsCodeFieldIndex.Id, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.Id, value); }
		}

		/// <summary> The Code property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."Code"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Code
		{
			get { return (System.String)GetValue((int)HcpcsCodeFieldIndex.Code, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.Code, value); }
		}

		/// <summary> The Description property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 1024<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)HcpcsCodeFieldIndex.Description, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.Description, value); }
		}

		/// <summary> The Cost property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."Cost"<br/>
		/// Table field type characteristics (type, precision, scale, length): Decimal, 9, 2, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Decimal> Cost
		{
			get { return (Nullable<System.Decimal>)GetValue((int)HcpcsCodeFieldIndex.Cost, false); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.Cost, value); }
		}

		/// <summary> The CopayCost property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."CopayCost"<br/>
		/// Table field type characteristics (type, precision, scale, length): Decimal, 9, 2, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Decimal> CopayCost
		{
			get { return (Nullable<System.Decimal>)GetValue((int)HcpcsCodeFieldIndex.CopayCost, false); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.CopayCost, value); }
		}

		/// <summary> The IsRetired property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."IsRetired"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsRetired
		{
			get { return (System.Boolean)GetValue((int)HcpcsCodeFieldIndex.IsRetired, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.IsRetired, value); }
		}

		/// <summary> The CreatedBy property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 CreatedBy
		{
			get { return (System.Int64)GetValue((int)HcpcsCodeFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.CreatedBy, value); }
		}

		/// <summary> The CreatedDate property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."CreatedDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CreatedDate
		{
			get { return (System.DateTime)GetValue((int)HcpcsCodeFieldIndex.CreatedDate, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.CreatedDate, value); }
		}

		/// <summary> The ModifiedBy property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."ModifiedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ModifiedBy
		{
			get { return (Nullable<System.Int64>)GetValue((int)HcpcsCodeFieldIndex.ModifiedBy, false); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.ModifiedBy, value); }
		}

		/// <summary> The ModifiedDate property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."ModifiedDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> ModifiedDate
		{
			get { return (Nullable<System.DateTime>)GetValue((int)HcpcsCodeFieldIndex.ModifiedDate, false); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.ModifiedDate, value); }
		}

		/// <summary> The IsActive property of the Entity HcpcsCode<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHcpcsCode"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)HcpcsCodeFieldIndex.IsActive, true); }
			set	{ SetValue((int)HcpcsCodeFieldIndex.IsActive, value); }
		}
		...
		public virtual EntityCollection<TestHcpcsCodeEntity> TestHcpcsCode
		{
			get
			{
				if(_testHcpcsCode==null)
				{
					...
					_testHcpcsCode.SetContainingEntityInfo(this, "HcpcsCode");
				}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser_ != null)
						{
							_organizationRoleUser_.UnsetRelatedEntity(this, "HcpcsCode_");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "HcpcsCode_");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser != null)
						{
							_organizationRoleUser.UnsetRelatedEntity(this, "HcpcsCode");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "HcpcsCode");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.HcpcsCodeEntity; }
		}
		#endregion
