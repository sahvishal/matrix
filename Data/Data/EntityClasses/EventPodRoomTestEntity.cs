...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EventPodRoomTest'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EventPodRoomTestEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EventPodRoomTestEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EventPodRoomTestEntity():base("EventPodRoomTestEntity")
		{
		...
		public EventPodRoomTestEntity(IEntityFields2 fields):base("EventPodRoomTestEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EventPodRoomTestEntity</param>
		public EventPodRoomTestEntity(IValidator validator):base("EventPodRoomTestEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="eventPodRoomId">PK value for EventPodRoomTest which data should be fetched into this EventPodRoomTest object</param>
		/// <param name="testId">PK value for EventPodRoomTest which data should be fetched into this EventPodRoomTest object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventPodRoomTestEntity(System.Int64 eventPodRoomId, System.Int64 testId):base("EventPodRoomTestEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this EventPodRoomTestEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventPodRoomTestEntity(System.Int64 eventPodRoomId, System.Int64 testId, IValidator validator):base("EventPodRoomTestEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.EventPodRoomId = eventPodRoomId;
			this.TestId = testId;
		...
		protected EventPodRoomTestEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EventPodRoomTestFieldIndex)fieldIndex)
			{
				case EventPodRoomTestFieldIndex.EventPodRoomId:
					DesetupSyncEventPodRoom(true, false);
					break;
				case EventPodRoomTestFieldIndex.TestId:
		...
		{
			return EventPodRoomTestEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(EventPodRoomTestFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EventPodRoomTestFieldIndex fieldIndex)
		{
		...
		{
			return new EventPodRoomTestRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.EventPodRoomTestEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EventPodRoomTestEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _eventPodRoom, new PropertyChangedEventHandler( OnEventPodRoomPropertyChanged ), "EventPodRoom", EventPodRoomTestEntity.Relations.EventPodRoomEntityUsingEventPodRoomId, true, signalRelatedEntity, "EventPodRoomTest", resetFKFields, new int[] { (int)EventPodRoomTestFieldIndex.EventPodRoomId } );		
			_eventPodRoom = null;
		}
		...
		private void SetupSyncEventPodRoom(IEntity2 relatedEntity)
		{
			if(_eventPodRoom!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _eventPodRoom, new PropertyChangedEventHandler( OnEventPodRoomPropertyChanged ), "EventPodRoom", EventPodRoomTestEntity.Relations.EventPodRoomEntityUsingEventPodRoomId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", EventPodRoomTestEntity.Relations.TestEntityUsingTestId, true, signalRelatedEntity, "EventPodRoomTest", resetFKFields, new int[] { (int)EventPodRoomTestFieldIndex.TestId } );		
			_test = null;
		}
		...
		private void SetupSyncTest(IEntity2 relatedEntity)
		{
			if(_test!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", EventPodRoomTestEntity.Relations.TestEntityUsingTestId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EventPodRoomTestEntity</param>
		...
		public  static EventPodRoomTestRelations Relations
		{
			get	{ return new EventPodRoomTestRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEventPodRoom
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventPodRoomEntityFactory))),
					(IEntityRelation)GetRelationsForField("EventPodRoom")[0], (int)Falcon.Data.EntityType.EventPodRoomTestEntity, (int)Falcon.Data.EntityType.EventPodRoomEntity, 0, null, null, null, null, "EventPodRoom", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTest
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))),
					(IEntityRelation)GetRelationsForField("Test")[0], (int)Falcon.Data.EntityType.EventPodRoomTestEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, null, null, "Test", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return EventPodRoomTestEntity.CustomProperties;}
		}
		...
		{
			get { return EventPodRoomTestEntity.FieldsCustomProperties;}
		}

		/// <summary> The EventPodRoomId property of the Entity EventPodRoomTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventPodRoomTest"."EventPodRoomId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventPodRoomId
		{
			get { return (System.Int64)GetValue((int)EventPodRoomTestFieldIndex.EventPodRoomId, true); }
			set	{ SetValue((int)EventPodRoomTestFieldIndex.EventPodRoomId, value); }
		}

		/// <summary> The TestId property of the Entity EventPodRoomTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventPodRoomTest"."TestId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TestId
		{
			get { return (System.Int64)GetValue((int)EventPodRoomTestFieldIndex.TestId, true); }
			set	{ SetValue((int)EventPodRoomTestFieldIndex.TestId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_eventPodRoom != null)
						{
							_eventPodRoom.UnsetRelatedEntity(this, "EventPodRoomTest");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "EventPodRoomTest");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_test != null)
						{
							_test.UnsetRelatedEntity(this, "EventPodRoomTest");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.EventPodRoomTestEntity; }
		}
		#endregion
