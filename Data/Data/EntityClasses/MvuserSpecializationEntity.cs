...
// Code is generated on: Thursday, July 21, 2011 6:44:30 PM
...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MvuserSpecialization'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MvuserSpecializationEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MvuserSpecializationEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public MvuserSpecializationEntity():base("MvuserSpecializationEntity")
		{
		...
		public MvuserSpecializationEntity(IEntityFields2 fields):base("MvuserSpecializationEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MvuserSpecializationEntity</param>
		public MvuserSpecializationEntity(IValidator validator):base("MvuserSpecializationEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="mvuserSpecializationId">PK value for MvuserSpecialization which data should be fetched into this MvuserSpecialization object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MvuserSpecializationEntity(System.Int64 mvuserSpecializationId):base("MvuserSpecializationEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.MvuserSpecializationId = mvuserSpecializationId;
		}
		...
		/// <param name="validator">The custom validator object for this MvuserSpecializationEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MvuserSpecializationEntity(System.Int64 mvuserSpecializationId, IValidator validator):base("MvuserSpecializationEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.MvuserSpecializationId = mvuserSpecializationId;
		}
		...
		protected MvuserSpecializationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MvuserSpecializationFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return MvuserSpecializationEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "PhysicianProfile":
					toReturn.Add(MvuserSpecializationEntity.Relations.PhysicianProfileEntityUsingSpecializationId);
					break;
				case "FileCollectionViaPhysicianProfile_":
					toReturn.Add(MvuserSpecializationEntity.Relations.PhysicianProfileEntityUsingSpecializationId, "MvuserSpecializationEntity__", "PhysicianProfile_", JoinHint.None);
		...
		public bool TestOriginalFieldValueForNull(MvuserSpecializationFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MvuserSpecializationFieldIndex fieldIndex)
		{
		...
		{
			return new MvuserSpecializationRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoPhysicianProfile()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(PhysicianProfileFields.SpecializationId, null, ComparisonOperator.Equal, this.MvuserSpecializationId));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoFileCollectionViaPhysicianProfile_()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(MvuserSpecializationFields.MvuserSpecializationId, null, ComparisonOperator.Equal, this.MvuserSpecializationId, "MvuserSpecializationEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.MvuserSpecializationEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MvuserSpecializationEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("MvuserSpecializationId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this MvuserSpecializationEntity</param>
		...
		public  static MvuserSpecializationRelations Relations
		{
			get	{ return new MvuserSpecializationRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPhysicianProfile
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<PhysicianProfileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PhysicianProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("PhysicianProfile")[0], (int)Falcon.Data.EntityType.MvuserSpecializationEntity, (int)Falcon.Data.EntityType.PhysicianProfileEntity, 0, null, null, null, null, "PhysicianProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaPhysicianProfile_
		{
			get
			{
				IEntityRelation intermediateRelation = MvuserSpecializationEntity.Relations.PhysicianProfileEntityUsingSpecializationId;
				...
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.MvuserSpecializationEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaPhysicianProfile_"), null, "FileCollectionViaPhysicianProfile_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFileCollectionViaPhysicianProfile
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "PhysicianProfile_");
				return new PrefetchPathElement2(new EntityCollection<FileEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.MvuserSpecializationEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, GetRelationsForField("FileCollectionViaPhysicianProfile"), null, "FileCollectionViaPhysicianProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMvuserClassificationCollectionViaPhysicianProfile
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<MvuserClassificationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MvuserClassificationEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.MvuserSpecializationEntity, (int)Falcon.Data.EntityType.MvuserClassificationEntity, 0, null, null, GetRelationsForField("MvuserClassificationCollectionViaPhysicianProfile"), null, "MvuserClassificationCollectionViaPhysicianProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return MvuserSpecializationEntity.CustomProperties;}
		}
		...
		{
			get { return MvuserSpecializationEntity.FieldsCustomProperties;}
		}

		/// <summary> The MvuserSpecializationId property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."MVUserSpecializationID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 MvuserSpecializationId
		{
			get { return (System.Int64)GetValue((int)MvuserSpecializationFieldIndex.MvuserSpecializationId, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.MvuserSpecializationId, value); }
		}

		/// <summary> The Name property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)MvuserSpecializationFieldIndex.Name, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.Name, value); }
		}

		/// <summary> The Description property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 1000<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)MvuserSpecializationFieldIndex.Description, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.Description, value); }
		}

		/// <summary> The DateCreated property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)MvuserSpecializationFieldIndex.DateCreated, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateModified property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."DateModified"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateModified
		{
			get { return (System.DateTime)GetValue((int)MvuserSpecializationFieldIndex.DateModified, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.DateModified, value); }
		}

		/// <summary> The IsActive property of the Entity MvuserSpecialization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMVUserSpecialization"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)MvuserSpecializationFieldIndex.IsActive, true); }
			set	{ SetValue((int)MvuserSpecializationFieldIndex.IsActive, value); }
		}
		...
		public virtual EntityCollection<PhysicianProfileEntity> PhysicianProfile
		{
			get
			{
				if(_physicianProfile==null)
				{
					...
					_physicianProfile.SetContainingEntityInfo(this, "MvuserSpecialization");
				}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.MvuserSpecializationEntity; }
		}
		#endregion
