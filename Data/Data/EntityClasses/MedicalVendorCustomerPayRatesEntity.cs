...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MedicalVendorCustomerPayRates'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MedicalVendorCustomerPayRatesEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MedicalVendorCustomerPayRatesEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public MedicalVendorCustomerPayRatesEntity():base("MedicalVendorCustomerPayRatesEntity")
		{
		...
		public MedicalVendorCustomerPayRatesEntity(IEntityFields2 fields):base("MedicalVendorCustomerPayRatesEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MedicalVendorCustomerPayRatesEntity</param>
		public MedicalVendorCustomerPayRatesEntity(IValidator validator):base("MedicalVendorCustomerPayRatesEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="organizationId">PK value for MedicalVendorCustomerPayRates which data should be fetched into this MedicalVendorCustomerPayRates object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MedicalVendorCustomerPayRatesEntity(System.Int64 organizationId):base("MedicalVendorCustomerPayRatesEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this MedicalVendorCustomerPayRatesEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MedicalVendorCustomerPayRatesEntity(System.Int64 organizationId, IValidator validator):base("MedicalVendorCustomerPayRatesEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.OrganizationId = organizationId;
		}
		...
		{
			switch((MedicalVendorCustomerPayRatesFieldIndex)fieldIndex)
			{
				case MedicalVendorCustomerPayRatesFieldIndex.OrganizationId:
		...
		{
			return MedicalVendorCustomerPayRatesEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "MedicalVendorProfile":
					toReturn.Add(MedicalVendorCustomerPayRatesEntity.Relations.MedicalVendorProfileEntityUsingOrganizationId);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(MedicalVendorCustomerPayRatesFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MedicalVendorCustomerPayRatesFieldIndex fieldIndex)
		{
		...
		{
			return new MedicalVendorCustomerPayRatesRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.MedicalVendorCustomerPayRatesEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MedicalVendorCustomerPayRatesEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this MedicalVendorCustomerPayRatesEntity</param>
		...
		public  static MedicalVendorCustomerPayRatesRelations Relations
		{
			get	{ return new MedicalVendorCustomerPayRatesRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMedicalVendorProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(MedicalVendorProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("MedicalVendorProfile")[0], (int)Falcon.Data.EntityType.MedicalVendorCustomerPayRatesEntity, (int)Falcon.Data.EntityType.MedicalVendorProfileEntity, 0, null, null, null, null, "MedicalVendorProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return MedicalVendorCustomerPayRatesEntity.CustomProperties;}
		}
		...
		{
			get { return MedicalVendorCustomerPayRatesEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrganizationId property of the Entity MedicalVendorCustomerPayRates<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMedicalVendorCustomerPayRates"."OrganizationID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 OrganizationId
		{
			get { return (System.Int64)GetValue((int)MedicalVendorCustomerPayRatesFieldIndex.OrganizationId, true); }
			set	{ SetValue((int)MedicalVendorCustomerPayRatesFieldIndex.OrganizationId, value); }
		}

		/// <summary> The OfferRate property of the Entity MedicalVendorCustomerPayRates<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblMedicalVendorCustomerPayRates"."OfferRate"<br/>
		...
		{
			get { return (System.Decimal)GetValue((int)MedicalVendorCustomerPayRatesFieldIndex.OfferRate, true); }
			set	{ SetValue((int)MedicalVendorCustomerPayRatesFieldIndex.OfferRate, value); }
		}
		...
		public virtual MedicalVendorProfileEntity MedicalVendorProfile
		{
			...
			set
			{
				if(base.IsDeserializing)
				{
					...
					{
						value.SetRelatedEntity(this, "MedicalVendorCustomerPayRates");
					}
				}
				else
				{
					...
					else
					{
						if(_medicalVendorProfile!=value)
						{
							...
							relatedEntity.SetRelatedEntity(this, "MedicalVendorCustomerPayRates");
							SetupSyncMedicalVendorProfile(relatedEntity);
						}
					}
				}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.MedicalVendorCustomerPayRatesEntity; }
		}
		#endregion
