		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Activity":
					toReturn.Add(NoteEntity.Relations.ActivityEntityUsingNoteId);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoActivity()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ActivityFields.ActivityId, null, ComparisonOperator.Equal, this.NoteId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.NoteEntity);
		}
		...
		private void SetupSyncActivity(IEntity2 relatedEntity)
		{
			if(_activity!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _activity, new PropertyChangedEventHandler( OnActivityPropertyChanged ), "Activity", NoteEntity.Relations.ActivityEntityUsingNoteId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathActivity
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ActivityEntityFactory))),
					(IEntityRelation)GetRelationsForField("Activity")[0], (int)Falcon.Data.EntityType.NoteEntity, (int)Falcon.Data.EntityType.ActivityEntity, 0, null, null, null, null, "Activity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		/// </summary>
		/// <remarks>Mapped on  table field: "TblNote"."NoteId"<br/>
		...
		/// </summary>
		/// <remarks>Mapped on  table field: "TblNote"."Note"<br/>
		...
		public virtual ActivityEntity Activity
		{
			...
			set
			{
				if(base.IsDeserializing)
				{
					...
					{
						value.SetRelatedEntity(this, "Note");
					}
				}
				else
				{
					...
					else
					{
						if(_activity!=value)
						{
							...
							relatedEntity.SetRelatedEntity(this, "Note");
							SetupSyncActivity(relatedEntity);
						}
					}
				}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.NoteEntity; }
		}
		#endregion
