...
namespace Falcon.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.TemplateEntity);
		}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("TemplateText", fieldHashtable);
		}
		#endregion
		...
		/// </summary>
		/// <remarks>Mapped on  table field: "TblTemplate"."TemplateId"<br/>
		...
		/// <summary> The TemplateText property of the Entity Template<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblTemplate"."TemplateText"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String TemplateText
		{
			get { return (System.String)GetValue((int)TemplateFieldIndex.TemplateText, true); }
			set	{ SetValue((int)TemplateFieldIndex.TemplateText, value); }
		}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.TemplateEntity; }
		}
		#endregion
