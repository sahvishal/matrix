...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'HostImage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class HostImageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static HostImageEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public HostImageEntity():base("HostImageEntity")
		{
		...
		public HostImageEntity(IEntityFields2 fields):base("HostImageEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this HostImageEntity</param>
		public HostImageEntity(IValidator validator):base("HostImageEntity")
		{
		...
		{
			switch((HostImageFieldIndex)fieldIndex)
			{
				case HostImageFieldIndex.HostId:
					DesetupSyncProspects(true, false);
					break;
				case HostImageFieldIndex.ImageId:
					DesetupSyncFile(true, false);
					break;
				case HostImageFieldIndex.HostImageType:
		...
		{
			return HostImageEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "File":
					toReturn.Add(HostImageEntity.Relations.FileEntityUsingImageId);
					break;
				case "Lookup":
					toReturn.Add(HostImageEntity.Relations.LookupEntityUsingHostImageType);
					break;
				case "Prospects":
					toReturn.Add(HostImageEntity.Relations.ProspectsEntityUsingHostId);
					break;
		...
		public bool TestOriginalFieldValueForNull(HostImageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(HostImageFieldIndex fieldIndex)
		{
		...
		{
			return new HostImageRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoFile()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(FileFields.FileId, null, ComparisonOperator.Equal, this.ImageId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(LookupFields.LookupId, null, ComparisonOperator.Equal, this.HostImageType));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.HostImageEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(HostImageEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("HostImageType", fieldHashtable);
		}
		#endregion
		...
		{
			base.PerformDesetupSyncRelatedEntity( _file, new PropertyChangedEventHandler( OnFilePropertyChanged ), "File", HostImageEntity.Relations.FileEntityUsingImageId, true, signalRelatedEntity, "HostImage", resetFKFields, new int[] { (int)HostImageFieldIndex.ImageId } );		
			_file = null;
		}
		...
		private void SetupSyncFile(IEntity2 relatedEntity)
		{
			if(_file!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _file, new PropertyChangedEventHandler( OnFilePropertyChanged ), "File", HostImageEntity.Relations.FileEntityUsingImageId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _lookup, new PropertyChangedEventHandler( OnLookupPropertyChanged ), "Lookup", HostImageEntity.Relations.LookupEntityUsingHostImageType, true, signalRelatedEntity, "HostImage", resetFKFields, new int[] { (int)HostImageFieldIndex.HostImageType } );		
			_lookup = null;
		}
		...
		private void SetupSyncLookup(IEntity2 relatedEntity)
		{
			if(_lookup!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _lookup, new PropertyChangedEventHandler( OnLookupPropertyChanged ), "Lookup", HostImageEntity.Relations.LookupEntityUsingHostImageType, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _prospects, new PropertyChangedEventHandler( OnProspectsPropertyChanged ), "Prospects", HostImageEntity.Relations.ProspectsEntityUsingHostId, true, signalRelatedEntity, "HostImage", resetFKFields, new int[] { (int)HostImageFieldIndex.HostId } );		
			_prospects = null;
		}
		...
		private void SetupSyncProspects(IEntity2 relatedEntity)
		{
			if(_prospects!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _prospects, new PropertyChangedEventHandler( OnProspectsPropertyChanged ), "Prospects", HostImageEntity.Relations.ProspectsEntityUsingHostId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this HostImageEntity</param>
		...
		public  static HostImageRelations Relations
		{
			get	{ return new HostImageRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FileEntityFactory))),
					(IEntityRelation)GetRelationsForField("File")[0], (int)Falcon.Data.EntityType.HostImageEntity, (int)Falcon.Data.EntityType.FileEntity, 0, null, null, null, null, "File", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookup
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))),
					(IEntityRelation)GetRelationsForField("Lookup")[0], (int)Falcon.Data.EntityType.HostImageEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, null, null, "Lookup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProspects
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProspectsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Prospects")[0], (int)Falcon.Data.EntityType.HostImageEntity, (int)Falcon.Data.EntityType.ProspectsEntity, 0, null, null, null, null, "Prospects", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return HostImageEntity.CustomProperties;}
		}
		...
		{
			get { return HostImageEntity.FieldsCustomProperties;}
		}

		/// <summary> The HostId property of the Entity HostImage<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHostImage"."HostId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 HostId
		{
			get { return (System.Int64)GetValue((int)HostImageFieldIndex.HostId, true); }
			set	{ SetValue((int)HostImageFieldIndex.HostId, value); }
		}

		/// <summary> The ImageId property of the Entity HostImage<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHostImage"."ImageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 ImageId
		{
			get { return (System.Int64)GetValue((int)HostImageFieldIndex.ImageId, true); }
			set	{ SetValue((int)HostImageFieldIndex.ImageId, value); }
		}

		/// <summary> The HostImageType property of the Entity HostImage<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHostImage"."HostImageType"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 HostImageType
		{
			get { return (System.Int64)GetValue((int)HostImageFieldIndex.HostImageType, true); }
			set	{ SetValue((int)HostImageFieldIndex.HostImageType, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_file != null)
						{
							_file.UnsetRelatedEntity(this, "HostImage");
						}
					}
					else
					{
						if(_file!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "HostImage");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_lookup != null)
						{
							_lookup.UnsetRelatedEntity(this, "HostImage");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_prospects != null)
						{
							_prospects.UnsetRelatedEntity(this, "HostImage");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.HostImageEntity; }
		}
		#endregion
