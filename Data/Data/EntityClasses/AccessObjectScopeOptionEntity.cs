...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AccessObjectScopeOption'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AccessObjectScopeOptionEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AccessObjectScopeOptionEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public AccessObjectScopeOptionEntity():base("AccessObjectScopeOptionEntity")
		{
		...
		public AccessObjectScopeOptionEntity(IEntityFields2 fields):base("AccessObjectScopeOptionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AccessObjectScopeOptionEntity</param>
		public AccessObjectScopeOptionEntity(IValidator validator):base("AccessObjectScopeOptionEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="accessControlObjectId">PK value for AccessObjectScopeOption which data should be fetched into this AccessObjectScopeOption object</param>
		/// <param name="scopeId">PK value for AccessObjectScopeOption which data should be fetched into this AccessObjectScopeOption object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AccessObjectScopeOptionEntity(System.Int64 accessControlObjectId, System.Int64 scopeId):base("AccessObjectScopeOptionEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this AccessObjectScopeOptionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AccessObjectScopeOptionEntity(System.Int64 accessControlObjectId, System.Int64 scopeId, IValidator validator):base("AccessObjectScopeOptionEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.AccessControlObjectId = accessControlObjectId;
			this.ScopeId = scopeId;
		...
		protected AccessObjectScopeOptionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AccessObjectScopeOptionFieldIndex)fieldIndex)
			{
				case AccessObjectScopeOptionFieldIndex.AccessControlObjectId:
					DesetupSyncAccessControlObject(true, false);
					break;
				case AccessObjectScopeOptionFieldIndex.ScopeId:
		...
		{
			return AccessObjectScopeOptionEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(AccessObjectScopeOptionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AccessObjectScopeOptionFieldIndex fieldIndex)
		{
		...
		{
			return new AccessObjectScopeOptionRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.AccessObjectScopeOptionEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AccessObjectScopeOptionEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _accessControlObject, new PropertyChangedEventHandler( OnAccessControlObjectPropertyChanged ), "AccessControlObject", AccessObjectScopeOptionEntity.Relations.AccessControlObjectEntityUsingAccessControlObjectId, true, signalRelatedEntity, "AccessObjectScopeOption", resetFKFields, new int[] { (int)AccessObjectScopeOptionFieldIndex.AccessControlObjectId } );		
			_accessControlObject = null;
		}
		...
		private void SetupSyncAccessControlObject(IEntity2 relatedEntity)
		{
			if(_accessControlObject!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _accessControlObject, new PropertyChangedEventHandler( OnAccessControlObjectPropertyChanged ), "AccessControlObject", AccessObjectScopeOptionEntity.Relations.AccessControlObjectEntityUsingAccessControlObjectId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this AccessObjectScopeOptionEntity</param>
		...
		public  static AccessObjectScopeOptionRelations Relations
		{
			get	{ return new AccessObjectScopeOptionRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAccessControlObject
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AccessControlObjectEntityFactory))),
					(IEntityRelation)GetRelationsForField("AccessControlObject")[0], (int)Falcon.Data.EntityType.AccessObjectScopeOptionEntity, (int)Falcon.Data.EntityType.AccessControlObjectEntity, 0, null, null, null, null, "AccessControlObject", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookup
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))),
					(IEntityRelation)GetRelationsForField("Lookup")[0], (int)Falcon.Data.EntityType.AccessObjectScopeOptionEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, null, null, "Lookup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AccessObjectScopeOptionEntity.CustomProperties;}
		}
		...
		{
			get { return AccessObjectScopeOptionEntity.FieldsCustomProperties;}
		}

		/// <summary> The AccessControlObjectId property of the Entity AccessObjectScopeOption<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblAccessObjectScopeOption"."AccessControlObjectId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 AccessControlObjectId
		{
			get { return (System.Int64)GetValue((int)AccessObjectScopeOptionFieldIndex.AccessControlObjectId, true); }
			set	{ SetValue((int)AccessObjectScopeOptionFieldIndex.AccessControlObjectId, value); }
		}

		/// <summary> The ScopeId property of the Entity AccessObjectScopeOption<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblAccessObjectScopeOption"."ScopeId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 ScopeId
		{
			get { return (System.Int64)GetValue((int)AccessObjectScopeOptionFieldIndex.ScopeId, true); }
			set	{ SetValue((int)AccessObjectScopeOptionFieldIndex.ScopeId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_accessControlObject != null)
						{
							_accessControlObject.UnsetRelatedEntity(this, "AccessObjectScopeOption");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "AccessObjectScopeOption");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_lookup != null)
						{
							_lookup.UnsetRelatedEntity(this, "AccessObjectScopeOption");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.AccessObjectScopeOptionEntity; }
		}
		#endregion
