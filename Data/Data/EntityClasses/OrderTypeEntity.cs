...
// Code is generated on: Thursday, October 08, 2009 3:52:08 PM
...
namespace HealthYes.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OrderType'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OrderTypeEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public OrderTypeEntity():base("OrderTypeEntity")
		{
		...
		public OrderTypeEntity(IEntityFields2 fields):base("OrderTypeEntity")
		{
		...
		public OrderTypeEntity(IValidator validator):base("OrderTypeEntity")
		{
		...
		public OrderTypeEntity(System.Int64 orderTypeId):base("OrderTypeEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this OrderTypeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OrderTypeEntity(System.Int64 orderTypeId, IValidator validator):base("OrderTypeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.OrderTypeId = orderTypeId;
		}
		...
		{
			switch((OrderTypeFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return OrderTypeEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Order":
					toReturn.Add(OrderTypeEntity.Relations.OrderEntityUsingOrderTypeId);
					break;
		...
		public bool TestOriginalFieldValueForNull(OrderTypeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OrderTypeFieldIndex fieldIndex)
		{
		...
		{
			return new OrderTypeRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoOrder()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(OrderFields.OrderTypeId, null, ComparisonOperator.Equal, this.OrderTypeId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(HealthYes.Data.EntityType.OrderTypeEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(OrderTypeEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("OrderTypeId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		public  static OrderTypeRelations Relations
		{
			get	{ return new OrderTypeRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrder
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))),
					(IEntityRelation)GetRelationsForField("Order")[0], (int)HealthYes.Data.EntityType.OrderTypeEntity, (int)HealthYes.Data.EntityType.OrderEntity, 0, null, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return OrderTypeEntity.CustomProperties;}
		}
		...
		{
			get { return OrderTypeEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderTypeId property of the Entity OrderType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblOrderType"."OrderTypeID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 OrderTypeId
		{
			get { return (System.Int64)GetValue((int)OrderTypeFieldIndex.OrderTypeId, true); }
			set	{ SetValue((int)OrderTypeFieldIndex.OrderTypeId, value); }
		}

		/// <summary> The OrderType property of the Entity OrderType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblOrderType"."OrderType"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String OrderType
		{
			get { return (System.String)GetValue((int)OrderTypeFieldIndex.OrderType, true); }
			set	{ SetValue((int)OrderTypeFieldIndex.OrderType, value); }
		}
		...
		public virtual EntityCollection<OrderEntity> Order
		{
			get
			{
				if(_order==null)
				{
					...
					_order.SetContainingEntityInfo(this, "OrderType");
				}
				return _order;
			}
		}
		...
		{ 
			get { return (int)HealthYes.Data.EntityType.OrderTypeEntity; }
		}
		#endregion
