...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PhysicianPod'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PhysicianPodEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PhysicianPodEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public PhysicianPodEntity():base("PhysicianPodEntity")
		{
		...
		public PhysicianPodEntity(IEntityFields2 fields):base("PhysicianPodEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PhysicianPodEntity</param>
		public PhysicianPodEntity(IValidator validator):base("PhysicianPodEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="physicianId">PK value for PhysicianPod which data should be fetched into this PhysicianPod object</param>
		/// <param name="podId">PK value for PhysicianPod which data should be fetched into this PhysicianPod object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PhysicianPodEntity(System.Int64 physicianId, System.Int64 podId):base("PhysicianPodEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this PhysicianPodEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PhysicianPodEntity(System.Int64 physicianId, System.Int64 podId, IValidator validator):base("PhysicianPodEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.PhysicianId = physicianId;
			this.PodId = podId;
		...
		protected PhysicianPodEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PhysicianPodFieldIndex)fieldIndex)
			{
				case PhysicianPodFieldIndex.PhysicianId:
					DesetupSyncPhysicianProfile(true, false);
					break;
				case PhysicianPodFieldIndex.PodId:
		...
		{
			return PhysicianPodEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "PhysicianProfile":
					toReturn.Add(PhysicianPodEntity.Relations.PhysicianProfileEntityUsingPhysicianId);
					break;
				case "PodDetails":
					toReturn.Add(PhysicianPodEntity.Relations.PodDetailsEntityUsingPodId);
					break;
		...
		public bool TestOriginalFieldValueForNull(PhysicianPodFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PhysicianPodFieldIndex fieldIndex)
		{
		...
		{
			return new PhysicianPodRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.PhysicianPodEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PhysicianPodEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _physicianProfile, new PropertyChangedEventHandler( OnPhysicianProfilePropertyChanged ), "PhysicianProfile", PhysicianPodEntity.Relations.PhysicianProfileEntityUsingPhysicianId, true, signalRelatedEntity, "PhysicianPod", resetFKFields, new int[] { (int)PhysicianPodFieldIndex.PhysicianId } );		
			_physicianProfile = null;
		}
		...
		private void SetupSyncPhysicianProfile(IEntity2 relatedEntity)
		{
			if(_physicianProfile!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _physicianProfile, new PropertyChangedEventHandler( OnPhysicianProfilePropertyChanged ), "PhysicianProfile", PhysicianPodEntity.Relations.PhysicianProfileEntityUsingPhysicianId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _podDetails, new PropertyChangedEventHandler( OnPodDetailsPropertyChanged ), "PodDetails", PhysicianPodEntity.Relations.PodDetailsEntityUsingPodId, true, signalRelatedEntity, "PhysicianPod", resetFKFields, new int[] { (int)PhysicianPodFieldIndex.PodId } );		
			_podDetails = null;
		}
		...
		private void SetupSyncPodDetails(IEntity2 relatedEntity)
		{
			if(_podDetails!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _podDetails, new PropertyChangedEventHandler( OnPodDetailsPropertyChanged ), "PodDetails", PhysicianPodEntity.Relations.PodDetailsEntityUsingPodId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PhysicianPodEntity</param>
		...
		public  static PhysicianPodRelations Relations
		{
			get	{ return new PhysicianPodRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPhysicianProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PhysicianProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("PhysicianProfile")[0], (int)Falcon.Data.EntityType.PhysicianPodEntity, (int)Falcon.Data.EntityType.PhysicianProfileEntity, 0, null, null, null, null, "PhysicianProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPodDetails
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PodDetailsEntityFactory))),
					(IEntityRelation)GetRelationsForField("PodDetails")[0], (int)Falcon.Data.EntityType.PhysicianPodEntity, (int)Falcon.Data.EntityType.PodDetailsEntity, 0, null, null, null, null, "PodDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return PhysicianPodEntity.CustomProperties;}
		}
		...
		{
			get { return PhysicianPodEntity.FieldsCustomProperties;}
		}

		/// <summary> The PhysicianId property of the Entity PhysicianPod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPhysicianPod"."PhysicianID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PhysicianId
		{
			get { return (System.Int64)GetValue((int)PhysicianPodFieldIndex.PhysicianId, true); }
			set	{ SetValue((int)PhysicianPodFieldIndex.PhysicianId, value); }
		}

		/// <summary> The PodId property of the Entity PhysicianPod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPhysicianPod"."PodID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PodId
		{
			get { return (System.Int64)GetValue((int)PhysicianPodFieldIndex.PodId, true); }
			set	{ SetValue((int)PhysicianPodFieldIndex.PodId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_physicianProfile != null)
						{
							_physicianProfile.UnsetRelatedEntity(this, "PhysicianPod");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "PhysicianPod");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_podDetails != null)
						{
							_podDetails.UnsetRelatedEntity(this, "PhysicianPod");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.PhysicianPodEntity; }
		}
		#endregion
