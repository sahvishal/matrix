...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PodRoomTest'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PodRoomTestEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PodRoomTestEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public PodRoomTestEntity():base("PodRoomTestEntity")
		{
		...
		public PodRoomTestEntity(IEntityFields2 fields):base("PodRoomTestEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PodRoomTestEntity</param>
		public PodRoomTestEntity(IValidator validator):base("PodRoomTestEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="podRoomId">PK value for PodRoomTest which data should be fetched into this PodRoomTest object</param>
		/// <param name="testId">PK value for PodRoomTest which data should be fetched into this PodRoomTest object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PodRoomTestEntity(System.Int64 podRoomId, System.Int64 testId):base("PodRoomTestEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this PodRoomTestEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PodRoomTestEntity(System.Int64 podRoomId, System.Int64 testId, IValidator validator):base("PodRoomTestEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.PodRoomId = podRoomId;
			this.TestId = testId;
		...
		{
			switch((PodRoomTestFieldIndex)fieldIndex)
			{
				case PodRoomTestFieldIndex.PodRoomId:
					DesetupSyncPodRoom(true, false);
					break;
				case PodRoomTestFieldIndex.TestId:
		...
		{
			return PodRoomTestEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "PodRoom":
					toReturn.Add(PodRoomTestEntity.Relations.PodRoomEntityUsingPodRoomId);
					break;
				case "Test":
					toReturn.Add(PodRoomTestEntity.Relations.TestEntityUsingTestId);
					break;
		...
		public bool TestOriginalFieldValueForNull(PodRoomTestFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PodRoomTestFieldIndex fieldIndex)
		{
		...
		{
			return new PodRoomTestRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.PodRoomTestEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PodRoomTestEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", PodRoomTestEntity.Relations.TestEntityUsingTestId, true, signalRelatedEntity, "PodRoomTest", resetFKFields, new int[] { (int)PodRoomTestFieldIndex.TestId } );		
			_test = null;
		}
		...
		private void SetupSyncTest(IEntity2 relatedEntity)
		{
			if(_test!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", PodRoomTestEntity.Relations.TestEntityUsingTestId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PodRoomTestEntity</param>
		...
		public  static PodRoomTestRelations Relations
		{
			get	{ return new PodRoomTestRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPodRoom
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PodRoomEntityFactory))),
					(IEntityRelation)GetRelationsForField("PodRoom")[0], (int)Falcon.Data.EntityType.PodRoomTestEntity, (int)Falcon.Data.EntityType.PodRoomEntity, 0, null, null, null, null, "PodRoom", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTest
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))),
					(IEntityRelation)GetRelationsForField("Test")[0], (int)Falcon.Data.EntityType.PodRoomTestEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, null, null, "Test", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return PodRoomTestEntity.CustomProperties;}
		}
		...
		{
			get { return PodRoomTestEntity.FieldsCustomProperties;}
		}

		/// <summary> The PodRoomId property of the Entity PodRoomTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPodRoomTest"."PodRoomId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PodRoomId
		{
			get { return (System.Int64)GetValue((int)PodRoomTestFieldIndex.PodRoomId, true); }
			set	{ SetValue((int)PodRoomTestFieldIndex.PodRoomId, value); }
		}

		/// <summary> The TestId property of the Entity PodRoomTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPodRoomTest"."TestId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TestId
		{
			get { return (System.Int64)GetValue((int)PodRoomTestFieldIndex.TestId, true); }
			set	{ SetValue((int)PodRoomTestFieldIndex.TestId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_podRoom != null)
						{
							_podRoom.UnsetRelatedEntity(this, "PodRoomTest");
						}
					}
					else
					{
						if(_podRoom!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "PodRoomTest");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_test != null)
						{
							_test.UnsetRelatedEntity(this, "PodRoomTest");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.PodRoomTestEntity; }
		}
		#endregion
