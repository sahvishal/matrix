...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Widget'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class WidgetEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public WidgetEntity():base("WidgetEntity")
		{
		...
		public WidgetEntity(IEntityFields2 fields):base("WidgetEntity")
		{
		...
		public WidgetEntity(IValidator validator):base("WidgetEntity")
		{
		...
		public WidgetEntity(System.Int64 widgetId):base("WidgetEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this WidgetEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WidgetEntity(System.Int64 widgetId, IValidator validator):base("WidgetEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.WidgetId = widgetId;
		}
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case WidgetFieldIndex.MarketingMaterialId:
		...
		{
			return WidgetEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AfmarketingMaterial":
					toReturn.Add(WidgetEntity.Relations.AfmarketingMaterialEntityUsingMarketingMaterialId);
					break;
		...
		public bool TestOriginalFieldValueForNull(WidgetFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(WidgetFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.WidgetEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(WidgetEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("WidgetAbbreviation", fieldHashtable);
		}
		#endregion
		...
		{
			base.PerformDesetupSyncRelatedEntity( _afmarketingMaterial, new PropertyChangedEventHandler( OnAfmarketingMaterialPropertyChanged ), "AfmarketingMaterial", WidgetEntity.Relations.AfmarketingMaterialEntityUsingMarketingMaterialId, true, signalRelatedEntity, "Widget", resetFKFields, new int[] { (int)WidgetFieldIndex.MarketingMaterialId } );		
			_afmarketingMaterial = null;
		}
		...
		private void SetupSyncAfmarketingMaterial(IEntity2 relatedEntity)
		{
			if(_afmarketingMaterial!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _afmarketingMaterial, new PropertyChangedEventHandler( OnAfmarketingMaterialPropertyChanged ), "AfmarketingMaterial", WidgetEntity.Relations.AfmarketingMaterialEntityUsingMarketingMaterialId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAfmarketingMaterial
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AfmarketingMaterialEntityFactory))),
					(IEntityRelation)GetRelationsForField("AfmarketingMaterial")[0], (int)Falcon.Data.EntityType.WidgetEntity, (int)Falcon.Data.EntityType.AfmarketingMaterialEntity, 0, null, null, null, null, "AfmarketingMaterial", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return WidgetEntity.CustomProperties;}
		}
		...
		{
			get { return WidgetEntity.FieldsCustomProperties;}
		}

		/// <summary> The WidgetId property of the Entity Widget<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblWidget"."WidgetID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 WidgetId
		{
			get { return (System.Int64)GetValue((int)WidgetFieldIndex.WidgetId, true); }
			set	{ SetValue((int)WidgetFieldIndex.WidgetId, value); }
		}

		/// <summary> The MarketingMaterialId property of the Entity Widget<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblWidget"."MarketingMaterialId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 MarketingMaterialId
		{
			get { return (System.Int64)GetValue((int)WidgetFieldIndex.MarketingMaterialId, true); }
			set	{ SetValue((int)WidgetFieldIndex.MarketingMaterialId, value); }
		}

		/// <summary> The WidgetAbbreviation property of the Entity Widget<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblWidget"."WidgetAbbreviation"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 16<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String WidgetAbbreviation
		{
			get { return (System.String)GetValue((int)WidgetFieldIndex.WidgetAbbreviation, true); }
			set	{ SetValue((int)WidgetFieldIndex.WidgetAbbreviation, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_afmarketingMaterial != null)
						{
							_afmarketingMaterial.UnsetRelatedEntity(this, "Widget");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "Widget");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.WidgetEntity; }
		}
		#endregion
