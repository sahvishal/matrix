...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'StaffEventRoleTest'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class StaffEventRoleTestEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static StaffEventRoleTestEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public StaffEventRoleTestEntity():base("StaffEventRoleTestEntity")
		{
		...
		public StaffEventRoleTestEntity(IEntityFields2 fields):base("StaffEventRoleTestEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this StaffEventRoleTestEntity</param>
		public StaffEventRoleTestEntity(IValidator validator):base("StaffEventRoleTestEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="staffEventRoleId">PK value for StaffEventRoleTest which data should be fetched into this StaffEventRoleTest object</param>
		/// <param name="testId">PK value for StaffEventRoleTest which data should be fetched into this StaffEventRoleTest object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public StaffEventRoleTestEntity(System.Int64 staffEventRoleId, System.Int64 testId):base("StaffEventRoleTestEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this StaffEventRoleTestEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public StaffEventRoleTestEntity(System.Int64 staffEventRoleId, System.Int64 testId, IValidator validator):base("StaffEventRoleTestEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.StaffEventRoleId = staffEventRoleId;
			this.TestId = testId;
		...
		{
			switch((StaffEventRoleTestFieldIndex)fieldIndex)
			{
				case StaffEventRoleTestFieldIndex.StaffEventRoleId:
					DesetupSyncStaffEventRole(true, false);
					break;
				case StaffEventRoleTestFieldIndex.TestId:
		...
		{
			return StaffEventRoleTestEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "StaffEventRole":
					toReturn.Add(StaffEventRoleTestEntity.Relations.StaffEventRoleEntityUsingStaffEventRoleId);
					break;
				case "Test":
					toReturn.Add(StaffEventRoleTestEntity.Relations.TestEntityUsingTestId);
					break;
		...
		public bool TestOriginalFieldValueForNull(StaffEventRoleTestFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(StaffEventRoleTestFieldIndex fieldIndex)
		{
		...
		{
			return new StaffEventRoleTestRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.StaffEventRoleTestEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(StaffEventRoleTestEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", StaffEventRoleTestEntity.Relations.TestEntityUsingTestId, true, signalRelatedEntity, "StaffEventRoleTest", resetFKFields, new int[] { (int)StaffEventRoleTestFieldIndex.TestId } );		
			_test = null;
		}
		...
		private void SetupSyncTest(IEntity2 relatedEntity)
		{
			if(_test!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", StaffEventRoleTestEntity.Relations.TestEntityUsingTestId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this StaffEventRoleTestEntity</param>
		...
		public  static StaffEventRoleTestRelations Relations
		{
			get	{ return new StaffEventRoleTestRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathStaffEventRole
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StaffEventRoleEntityFactory))),
					(IEntityRelation)GetRelationsForField("StaffEventRole")[0], (int)Falcon.Data.EntityType.StaffEventRoleTestEntity, (int)Falcon.Data.EntityType.StaffEventRoleEntity, 0, null, null, null, null, "StaffEventRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTest
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))),
					(IEntityRelation)GetRelationsForField("Test")[0], (int)Falcon.Data.EntityType.StaffEventRoleTestEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, null, null, "Test", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return StaffEventRoleTestEntity.CustomProperties;}
		}
		...
		{
			get { return StaffEventRoleTestEntity.FieldsCustomProperties;}
		}

		/// <summary> The StaffEventRoleId property of the Entity StaffEventRoleTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblStaffEventRoleTest"."StaffEventRoleID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 StaffEventRoleId
		{
			get { return (System.Int64)GetValue((int)StaffEventRoleTestFieldIndex.StaffEventRoleId, true); }
			set	{ SetValue((int)StaffEventRoleTestFieldIndex.StaffEventRoleId, value); }
		}

		/// <summary> The TestId property of the Entity StaffEventRoleTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblStaffEventRoleTest"."TestID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TestId
		{
			get { return (System.Int64)GetValue((int)StaffEventRoleTestFieldIndex.TestId, true); }
			set	{ SetValue((int)StaffEventRoleTestFieldIndex.TestId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_staffEventRole != null)
						{
							_staffEventRole.UnsetRelatedEntity(this, "StaffEventRoleTest");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "StaffEventRoleTest");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_test != null)
						{
							_test.UnsetRelatedEntity(this, "StaffEventRoleTest");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.StaffEventRoleTestEntity; }
		}
		#endregion
