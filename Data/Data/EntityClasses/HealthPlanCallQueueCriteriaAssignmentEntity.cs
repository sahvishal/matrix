...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'HealthPlanCallQueueCriteriaAssignment'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class HealthPlanCallQueueCriteriaAssignmentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static HealthPlanCallQueueCriteriaAssignmentEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public HealthPlanCallQueueCriteriaAssignmentEntity():base("HealthPlanCallQueueCriteriaAssignmentEntity")
		{
		...
		public HealthPlanCallQueueCriteriaAssignmentEntity(IEntityFields2 fields):base("HealthPlanCallQueueCriteriaAssignmentEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this HealthPlanCallQueueCriteriaAssignmentEntity</param>
		public HealthPlanCallQueueCriteriaAssignmentEntity(IValidator validator):base("HealthPlanCallQueueCriteriaAssignmentEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="callQueueCustomerId">PK value for HealthPlanCallQueueCriteriaAssignment which data should be fetched into this HealthPlanCallQueueCriteriaAssignment object</param>
		/// <param name="callQueueId">PK value for HealthPlanCallQueueCriteriaAssignment which data should be fetched into this HealthPlanCallQueueCriteriaAssignment object</param>
		/// <param name="criteriaId">PK value for HealthPlanCallQueueCriteriaAssignment which data should be fetched into this HealthPlanCallQueueCriteriaAssignment object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HealthPlanCallQueueCriteriaAssignmentEntity(System.Int64 callQueueCustomerId, System.Int64 callQueueId, System.Int64 criteriaId):base("HealthPlanCallQueueCriteriaAssignmentEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this HealthPlanCallQueueCriteriaAssignmentEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HealthPlanCallQueueCriteriaAssignmentEntity(System.Int64 callQueueCustomerId, System.Int64 callQueueId, System.Int64 criteriaId, IValidator validator):base("HealthPlanCallQueueCriteriaAssignmentEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.CallQueueCustomerId = callQueueCustomerId;
			this.CallQueueId = callQueueId;
		...
		{
			switch((HealthPlanCallQueueCriteriaAssignmentFieldIndex)fieldIndex)
			{
				case HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueCustomerId:
					DesetupSyncCallQueueCustomer(true, false);
					break;
				case HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueId:
					DesetupSyncCallQueue(true, false);
					break;
				case HealthPlanCallQueueCriteriaAssignmentFieldIndex.CriteriaId:
		...
		{
			return HealthPlanCallQueueCriteriaAssignmentEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "CallQueue":
					toReturn.Add(HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueEntityUsingCallQueueId);
					break;
				case "CallQueueCustomer":
					toReturn.Add(HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueCustomerEntityUsingCallQueueCustomerId);
					break;
				case "HealthPlanCallQueueCriteria":
					toReturn.Add(HealthPlanCallQueueCriteriaAssignmentEntity.Relations.HealthPlanCallQueueCriteriaEntityUsingCriteriaId);
					break;
		...
		public bool TestOriginalFieldValueForNull(HealthPlanCallQueueCriteriaAssignmentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(HealthPlanCallQueueCriteriaAssignmentFieldIndex fieldIndex)
		{
		...
		{
			return new HealthPlanCallQueueCriteriaAssignmentRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.HealthPlanCallQueueCriteriaAssignmentEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(HealthPlanCallQueueCriteriaAssignmentEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _callQueue, new PropertyChangedEventHandler( OnCallQueuePropertyChanged ), "CallQueue", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueEntityUsingCallQueueId, true, signalRelatedEntity, "HealthPlanCallQueueCriteriaAssignment", resetFKFields, new int[] { (int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueId } );		
			_callQueue = null;
		}
		...
		private void SetupSyncCallQueue(IEntity2 relatedEntity)
		{
			if(_callQueue!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _callQueue, new PropertyChangedEventHandler( OnCallQueuePropertyChanged ), "CallQueue", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueEntityUsingCallQueueId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _callQueueCustomer, new PropertyChangedEventHandler( OnCallQueueCustomerPropertyChanged ), "CallQueueCustomer", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueCustomerEntityUsingCallQueueCustomerId, true, signalRelatedEntity, "HealthPlanCallQueueCriteriaAssignment", resetFKFields, new int[] { (int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueCustomerId } );		
			_callQueueCustomer = null;
		}
		...
		private void SetupSyncCallQueueCustomer(IEntity2 relatedEntity)
		{
			if(_callQueueCustomer!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _callQueueCustomer, new PropertyChangedEventHandler( OnCallQueueCustomerPropertyChanged ), "CallQueueCustomer", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.CallQueueCustomerEntityUsingCallQueueCustomerId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _healthPlanCallQueueCriteria, new PropertyChangedEventHandler( OnHealthPlanCallQueueCriteriaPropertyChanged ), "HealthPlanCallQueueCriteria", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.HealthPlanCallQueueCriteriaEntityUsingCriteriaId, true, signalRelatedEntity, "HealthPlanCallQueueCriteriaAssignment", resetFKFields, new int[] { (int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CriteriaId } );		
			_healthPlanCallQueueCriteria = null;
		}
		...
		private void SetupSyncHealthPlanCallQueueCriteria(IEntity2 relatedEntity)
		{
			if(_healthPlanCallQueueCriteria!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _healthPlanCallQueueCriteria, new PropertyChangedEventHandler( OnHealthPlanCallQueueCriteriaPropertyChanged ), "HealthPlanCallQueueCriteria", HealthPlanCallQueueCriteriaAssignmentEntity.Relations.HealthPlanCallQueueCriteriaEntityUsingCriteriaId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this HealthPlanCallQueueCriteriaAssignmentEntity</param>
		...
		public  static HealthPlanCallQueueCriteriaAssignmentRelations Relations
		{
			get	{ return new HealthPlanCallQueueCriteriaAssignmentRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCallQueue
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CallQueueEntityFactory))),
					(IEntityRelation)GetRelationsForField("CallQueue")[0], (int)Falcon.Data.EntityType.HealthPlanCallQueueCriteriaAssignmentEntity, (int)Falcon.Data.EntityType.CallQueueEntity, 0, null, null, null, null, "CallQueue", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCallQueueCustomer
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CallQueueCustomerEntityFactory))),
					(IEntityRelation)GetRelationsForField("CallQueueCustomer")[0], (int)Falcon.Data.EntityType.HealthPlanCallQueueCriteriaAssignmentEntity, (int)Falcon.Data.EntityType.CallQueueCustomerEntity, 0, null, null, null, null, "CallQueueCustomer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHealthPlanCallQueueCriteria
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(HealthPlanCallQueueCriteriaEntityFactory))),
					(IEntityRelation)GetRelationsForField("HealthPlanCallQueueCriteria")[0], (int)Falcon.Data.EntityType.HealthPlanCallQueueCriteriaAssignmentEntity, (int)Falcon.Data.EntityType.HealthPlanCallQueueCriteriaEntity, 0, null, null, null, null, "HealthPlanCallQueueCriteria", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return HealthPlanCallQueueCriteriaAssignmentEntity.CustomProperties;}
		}
		...
		{
			get { return HealthPlanCallQueueCriteriaAssignmentEntity.FieldsCustomProperties;}
		}

		/// <summary> The CallQueueCustomerId property of the Entity HealthPlanCallQueueCriteriaAssignment<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHealthPlanCallQueueCriteriaAssignment"."CallQueueCustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CallQueueCustomerId
		{
			get { return (System.Int64)GetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueCustomerId, true); }
			set	{ SetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueCustomerId, value); }
		}

		/// <summary> The CallQueueId property of the Entity HealthPlanCallQueueCriteriaAssignment<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHealthPlanCallQueueCriteriaAssignment"."CallQueueId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CallQueueId
		{
			get { return (System.Int64)GetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueId, true); }
			set	{ SetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CallQueueId, value); }
		}

		/// <summary> The CriteriaId property of the Entity HealthPlanCallQueueCriteriaAssignment<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHealthPlanCallQueueCriteriaAssignment"."CriteriaId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CriteriaId
		{
			get { return (System.Int64)GetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CriteriaId, true); }
			set	{ SetValue((int)HealthPlanCallQueueCriteriaAssignmentFieldIndex.CriteriaId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_callQueue != null)
						{
							_callQueue.UnsetRelatedEntity(this, "HealthPlanCallQueueCriteriaAssignment");
						}
					}
					else
					{
						if(_callQueue!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "HealthPlanCallQueueCriteriaAssignment");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_callQueueCustomer != null)
						{
							_callQueueCustomer.UnsetRelatedEntity(this, "HealthPlanCallQueueCriteriaAssignment");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_healthPlanCallQueueCriteria != null)
						{
							_healthPlanCallQueueCriteria.UnsetRelatedEntity(this, "HealthPlanCallQueueCriteriaAssignment");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.HealthPlanCallQueueCriteriaAssignmentEntity; }
		}
		#endregion
