...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AfimpressionLog'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AfimpressionLogEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AfimpressionLogEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public AfimpressionLogEntity():base("AfimpressionLogEntity")
		{
		...
		public AfimpressionLogEntity(IEntityFields2 fields):base("AfimpressionLogEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AfimpressionLogEntity</param>
		public AfimpressionLogEntity(IValidator validator):base("AfimpressionLogEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="impressionLogId">PK value for AfimpressionLog which data should be fetched into this AfimpressionLog object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AfimpressionLogEntity(System.Int64 impressionLogId):base("AfimpressionLogEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ImpressionLogId = impressionLogId;
		}
		...
		/// <param name="validator">The custom validator object for this AfimpressionLogEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AfimpressionLogEntity(System.Int64 impressionLogId, IValidator validator):base("AfimpressionLogEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ImpressionLogId = impressionLogId;
		}
		...
		protected AfimpressionLogEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AfimpressionLogFieldIndex)fieldIndex)
			{
				case AfimpressionLogFieldIndex.AffiliateCampaignMarketingMaterialId:
		...
		{
			return AfimpressionLogEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AfaffiliateCampaignMarketingMaterial":
					toReturn.Add(AfimpressionLogEntity.Relations.AfaffiliateCampaignMarketingMaterialEntityUsingAffiliateCampaignMarketingMaterialId);
					break;
				case "Afcampaign":
					toReturn.Add(AfimpressionLogEntity.Relations.AfcampaignEntityUsingAffiliateCampaignMarketingMaterialId);
					break;
		...
		public bool TestOriginalFieldValueForNull(AfimpressionLogFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AfimpressionLogFieldIndex fieldIndex)
		{
		...
		{
			return new AfimpressionLogRelations().GetAllRelations();
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AfcampaignFields.CampaignId, null, ComparisonOperator.Equal, this.AffiliateCampaignMarketingMaterialId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.AfimpressionLogEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AfimpressionLogEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ImpressionLogId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("AffiliateCampaignMarketingMaterialId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("DayStamp", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this AfimpressionLogEntity</param>
		...
		public  static AfimpressionLogRelations Relations
		{
			get	{ return new AfimpressionLogRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAfaffiliateCampaignMarketingMaterial
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AfaffiliateCampaignMarketingMaterialEntityFactory))),
					(IEntityRelation)GetRelationsForField("AfaffiliateCampaignMarketingMaterial")[0], (int)Falcon.Data.EntityType.AfimpressionLogEntity, (int)Falcon.Data.EntityType.AfaffiliateCampaignMarketingMaterialEntity, 0, null, null, null, null, "AfaffiliateCampaignMarketingMaterial", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAfcampaign
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AfcampaignEntityFactory))),
					(IEntityRelation)GetRelationsForField("Afcampaign")[0], (int)Falcon.Data.EntityType.AfimpressionLogEntity, (int)Falcon.Data.EntityType.AfcampaignEntity, 0, null, null, null, null, "Afcampaign", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AfimpressionLogEntity.CustomProperties;}
		}
		...
		{
			get { return AfimpressionLogEntity.FieldsCustomProperties;}
		}

		/// <summary> The ImpressionLogId property of the Entity AfimpressionLog<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "tblAFImpressionLog"."ImpressionLogID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ImpressionLogId
		{
			get { return (System.Int64)GetValue((int)AfimpressionLogFieldIndex.ImpressionLogId, true); }
			set	{ SetValue((int)AfimpressionLogFieldIndex.ImpressionLogId, value); }
		}

		/// <summary> The AffiliateCampaignMarketingMaterialId property of the Entity AfimpressionLog<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "tblAFImpressionLog"."AffiliateCampaignMarketingMaterialID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 AffiliateCampaignMarketingMaterialId
		{
			get { return (System.Int64)GetValue((int)AfimpressionLogFieldIndex.AffiliateCampaignMarketingMaterialId, true); }
			set	{ SetValue((int)AfimpressionLogFieldIndex.AffiliateCampaignMarketingMaterialId, value); }
		}

		/// <summary> The DayStamp property of the Entity AfimpressionLog<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "tblAFImpressionLog"."DayStamp"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DayStamp
		{
			get { return (System.DateTime)GetValue((int)AfimpressionLogFieldIndex.DayStamp, true); }
			set	{ SetValue((int)AfimpressionLogFieldIndex.DayStamp, value); }
		}

		/// <summary> The ImpressionCount property of the Entity AfimpressionLog<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "tblAFImpressionLog"."ImpressionCount"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ImpressionCount
		{
			get { return (Nullable<System.Int64>)GetValue((int)AfimpressionLogFieldIndex.ImpressionCount, false); }
			set	{ SetValue((int)AfimpressionLogFieldIndex.ImpressionCount, value); }
		}

		/// <summary> The ClickCount property of the Entity AfimpressionLog<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "tblAFImpressionLog"."ClickCount"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ClickCount
		{
			get { return (Nullable<System.Int64>)GetValue((int)AfimpressionLogFieldIndex.ClickCount, false); }
			set	{ SetValue((int)AfimpressionLogFieldIndex.ClickCount, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_afaffiliateCampaignMarketingMaterial != null)
						{
							_afaffiliateCampaignMarketingMaterial.UnsetRelatedEntity(this, "AfimpressionLog");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "AfimpressionLog");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_afcampaign != null)
						{
							_afcampaign.UnsetRelatedEntity(this, "AfimpressionLog");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.AfimpressionLogEntity; }
		}
		#endregion
