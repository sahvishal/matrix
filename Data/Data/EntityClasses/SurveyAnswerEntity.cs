...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'SurveyAnswer'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SurveyAnswerEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SurveyAnswerEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public SurveyAnswerEntity():base("SurveyAnswerEntity")
		{
		...
		public SurveyAnswerEntity(IEntityFields2 fields):base("SurveyAnswerEntity")
		{
		...
		public SurveyAnswerEntity(IValidator validator):base("SurveyAnswerEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="eventCustomerId">PK value for SurveyAnswer which data should be fetched into this SurveyAnswer object</param>
		/// <param name="questionId">PK value for SurveyAnswer which data should be fetched into this SurveyAnswer object</param>
		/// <param name="version">PK value for SurveyAnswer which data should be fetched into this SurveyAnswer object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SurveyAnswerEntity(System.Int64 eventCustomerId, System.Int64 questionId, System.Int32 version):base("SurveyAnswerEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this SurveyAnswerEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SurveyAnswerEntity(System.Int64 eventCustomerId, System.Int64 questionId, System.Int32 version, IValidator validator):base("SurveyAnswerEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.EventCustomerId = eventCustomerId;
			this.QuestionId = questionId;
		...
		protected SurveyAnswerEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case SurveyAnswerFieldIndex.EventCustomerId:
					DesetupSyncEventCustomers(true, false);
					break;
				case SurveyAnswerFieldIndex.QuestionId:
					DesetupSyncSurveyQuestion(true, false);
					break;
				case SurveyAnswerFieldIndex.CreatedBy:
					DesetupSyncOrganizationRoleUser(true, false);
					break;
				case SurveyAnswerFieldIndex.ModifiedBy:
		...
		{
			return SurveyAnswerEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "EventCustomers":
					toReturn.Add(SurveyAnswerEntity.Relations.EventCustomersEntityUsingEventCustomerId);
					break;
				case "OrganizationRoleUser_":
					toReturn.Add(SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy);
					break;
				case "OrganizationRoleUser":
					toReturn.Add(SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy);
					break;
				case "SurveyQuestion":
					toReturn.Add(SurveyAnswerEntity.Relations.SurveyQuestionEntityUsingQuestionId);
					break;
		...
		public bool TestOriginalFieldValueForNull(SurveyAnswerFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SurveyAnswerFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.SurveyAnswerEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SurveyAnswerEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _eventCustomers, new PropertyChangedEventHandler( OnEventCustomersPropertyChanged ), "EventCustomers", SurveyAnswerEntity.Relations.EventCustomersEntityUsingEventCustomerId, true, signalRelatedEntity, "SurveyAnswer", resetFKFields, new int[] { (int)SurveyAnswerFieldIndex.EventCustomerId } );		
			_eventCustomers = null;
		}
		...
		private void SetupSyncEventCustomers(IEntity2 relatedEntity)
		{
			if(_eventCustomers!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _eventCustomers, new PropertyChangedEventHandler( OnEventCustomersPropertyChanged ), "EventCustomers", SurveyAnswerEntity.Relations.EventCustomersEntityUsingEventCustomerId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, signalRelatedEntity, "SurveyAnswer_", resetFKFields, new int[] { (int)SurveyAnswerFieldIndex.ModifiedBy } );		
			_organizationRoleUser_ = null;
		}
		...
		private void SetupSyncOrganizationRoleUser_(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser_!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingModifiedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, signalRelatedEntity, "SurveyAnswer", resetFKFields, new int[] { (int)SurveyAnswerFieldIndex.CreatedBy } );		
			_organizationRoleUser = null;
		}
		...
		private void SetupSyncOrganizationRoleUser(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", SurveyAnswerEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _surveyQuestion, new PropertyChangedEventHandler( OnSurveyQuestionPropertyChanged ), "SurveyQuestion", SurveyAnswerEntity.Relations.SurveyQuestionEntityUsingQuestionId, true, signalRelatedEntity, "SurveyAnswer", resetFKFields, new int[] { (int)SurveyAnswerFieldIndex.QuestionId } );		
			_surveyQuestion = null;
		}
		...
		private void SetupSyncSurveyQuestion(IEntity2 relatedEntity)
		{
			if(_surveyQuestion!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _surveyQuestion, new PropertyChangedEventHandler( OnSurveyQuestionPropertyChanged ), "SurveyQuestion", SurveyAnswerEntity.Relations.SurveyQuestionEntityUsingQuestionId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEventCustomers
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventCustomersEntityFactory))),
					(IEntityRelation)GetRelationsForField("EventCustomers")[0], (int)Falcon.Data.EntityType.SurveyAnswerEntity, (int)Falcon.Data.EntityType.EventCustomersEntity, 0, null, null, null, null, "EventCustomers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser_
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser_")[0], (int)Falcon.Data.EntityType.SurveyAnswerEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser
		{
			...
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser")[0], (int)Falcon.Data.EntityType.SurveyAnswerEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSurveyQuestion
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SurveyQuestionEntityFactory))),
					(IEntityRelation)GetRelationsForField("SurveyQuestion")[0], (int)Falcon.Data.EntityType.SurveyAnswerEntity, (int)Falcon.Data.EntityType.SurveyQuestionEntity, 0, null, null, null, null, "SurveyQuestion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return SurveyAnswerEntity.CustomProperties;}
		}
		...
		{
			get { return SurveyAnswerEntity.FieldsCustomProperties;}
		}

		/// <summary> The EventCustomerId property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."EventCustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventCustomerId
		{
			get { return (System.Int64)GetValue((int)SurveyAnswerFieldIndex.EventCustomerId, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.EventCustomerId, value); }
		}

		/// <summary> The QuestionId property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."QuestionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 QuestionId
		{
			get { return (System.Int64)GetValue((int)SurveyAnswerFieldIndex.QuestionId, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.QuestionId, value); }
		}

		/// <summary> The Answer property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."Answer"<br/>
		...
		public virtual System.String Answer
		{
			...
			set	{ SetValue((int)SurveyAnswerFieldIndex.Answer, value); }
		}

		/// <summary> The CreatedOn property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."CreatedOn"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CreatedOn
		{
			get { return (System.DateTime)GetValue((int)SurveyAnswerFieldIndex.CreatedOn, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.CreatedOn, value); }
		}

		/// <summary> The CreatedBy property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 CreatedBy
		{
			get { return (System.Int64)GetValue((int)SurveyAnswerFieldIndex.CreatedBy, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.CreatedBy, value); }
		}

		/// <summary> The Version property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."Version"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 Version
		{
			get { return (System.Int32)GetValue((int)SurveyAnswerFieldIndex.Version, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.Version, value); }
		}

		/// <summary> The IsActive property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)SurveyAnswerFieldIndex.IsActive, true); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.IsActive, value); }
		}

		/// <summary> The ModifiedOn property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."ModifiedOn"<br/>
		/// Table field type characteristics (type, precision, scale, length): Date, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> ModifiedOn
		{
			get { return (Nullable<System.DateTime>)GetValue((int)SurveyAnswerFieldIndex.ModifiedOn, false); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.ModifiedOn, value); }
		}

		/// <summary> The ModifiedBy property of the Entity SurveyAnswer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblSurveyAnswer"."ModifiedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> ModifiedBy
		{
			get { return (Nullable<System.Int64>)GetValue((int)SurveyAnswerFieldIndex.ModifiedBy, false); }
			set	{ SetValue((int)SurveyAnswerFieldIndex.ModifiedBy, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_eventCustomers != null)
						{
							_eventCustomers.UnsetRelatedEntity(this, "SurveyAnswer");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "SurveyAnswer");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser_ != null)
						{
							_organizationRoleUser_.UnsetRelatedEntity(this, "SurveyAnswer_");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "SurveyAnswer_");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser != null)
						{
							_organizationRoleUser.UnsetRelatedEntity(this, "SurveyAnswer");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_surveyQuestion != null)
						{
							_surveyQuestion.UnsetRelatedEntity(this, "SurveyAnswer");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.SurveyAnswerEntity; }
		}
		#endregion
