...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PhysicianPaymentInvoice'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PhysicianPaymentInvoiceEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PhysicianPaymentInvoiceEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public PhysicianPaymentInvoiceEntity():base("PhysicianPaymentInvoiceEntity")
		{
		...
		public PhysicianPaymentInvoiceEntity(IEntityFields2 fields):base("PhysicianPaymentInvoiceEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PhysicianPaymentInvoiceEntity</param>
		public PhysicianPaymentInvoiceEntity(IValidator validator):base("PhysicianPaymentInvoiceEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="physicianPaymentId">PK value for PhysicianPaymentInvoice which data should be fetched into this PhysicianPaymentInvoice object</param>
		/// <param name="physicianInvoiceId">PK value for PhysicianPaymentInvoice which data should be fetched into this PhysicianPaymentInvoice object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PhysicianPaymentInvoiceEntity(System.Int64 physicianPaymentId, System.Int64 physicianInvoiceId):base("PhysicianPaymentInvoiceEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this PhysicianPaymentInvoiceEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PhysicianPaymentInvoiceEntity(System.Int64 physicianPaymentId, System.Int64 physicianInvoiceId, IValidator validator):base("PhysicianPaymentInvoiceEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.PhysicianPaymentId = physicianPaymentId;
			this.PhysicianInvoiceId = physicianInvoiceId;
		...
		{
			switch((PhysicianPaymentInvoiceFieldIndex)fieldIndex)
			{
				case PhysicianPaymentInvoiceFieldIndex.PhysicianPaymentId:
					DesetupSyncPhysicianPayment(true, false);
					break;
				case PhysicianPaymentInvoiceFieldIndex.PhysicianInvoiceId:
		...
		{
			return PhysicianPaymentInvoiceEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "PhysicianInvoice":
					toReturn.Add(PhysicianPaymentInvoiceEntity.Relations.PhysicianInvoiceEntityUsingPhysicianInvoiceId);
					break;
				case "PhysicianPayment":
					toReturn.Add(PhysicianPaymentInvoiceEntity.Relations.PhysicianPaymentEntityUsingPhysicianPaymentId);
					break;
		...
		public bool TestOriginalFieldValueForNull(PhysicianPaymentInvoiceFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PhysicianPaymentInvoiceFieldIndex fieldIndex)
		{
		...
		{
			return new PhysicianPaymentInvoiceRelations().GetAllRelations();
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(PhysicianPaymentFields.PhysicianPaymentId, null, ComparisonOperator.Equal, this.PhysicianPaymentId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.PhysicianPaymentInvoiceEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PhysicianPaymentInvoiceEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _physicianPayment, new PropertyChangedEventHandler( OnPhysicianPaymentPropertyChanged ), "PhysicianPayment", PhysicianPaymentInvoiceEntity.Relations.PhysicianPaymentEntityUsingPhysicianPaymentId, true, signalRelatedEntity, "PhysicianPaymentInvoice", resetFKFields, new int[] { (int)PhysicianPaymentInvoiceFieldIndex.PhysicianPaymentId } );		
			_physicianPayment = null;
		}
		...
		private void SetupSyncPhysicianPayment(IEntity2 relatedEntity)
		{
			if(_physicianPayment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _physicianPayment, new PropertyChangedEventHandler( OnPhysicianPaymentPropertyChanged ), "PhysicianPayment", PhysicianPaymentInvoiceEntity.Relations.PhysicianPaymentEntityUsingPhysicianPaymentId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PhysicianPaymentInvoiceEntity</param>
		...
		public  static PhysicianPaymentInvoiceRelations Relations
		{
			get	{ return new PhysicianPaymentInvoiceRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPhysicianInvoice
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PhysicianInvoiceEntityFactory))),
					(IEntityRelation)GetRelationsForField("PhysicianInvoice")[0], (int)Falcon.Data.EntityType.PhysicianPaymentInvoiceEntity, (int)Falcon.Data.EntityType.PhysicianInvoiceEntity, 0, null, null, null, null, "PhysicianInvoice", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPhysicianPayment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PhysicianPaymentEntityFactory))),
					(IEntityRelation)GetRelationsForField("PhysicianPayment")[0], (int)Falcon.Data.EntityType.PhysicianPaymentInvoiceEntity, (int)Falcon.Data.EntityType.PhysicianPaymentEntity, 0, null, null, null, null, "PhysicianPayment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return PhysicianPaymentInvoiceEntity.CustomProperties;}
		}
		...
		{
			get { return PhysicianPaymentInvoiceEntity.FieldsCustomProperties;}
		}

		/// <summary> The PhysicianPaymentId property of the Entity PhysicianPaymentInvoice<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPhysicianPaymentInvoice"."PhysicianPaymentID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PhysicianPaymentId
		{
			get { return (System.Int64)GetValue((int)PhysicianPaymentInvoiceFieldIndex.PhysicianPaymentId, true); }
			set	{ SetValue((int)PhysicianPaymentInvoiceFieldIndex.PhysicianPaymentId, value); }
		}

		/// <summary> The PhysicianInvoiceId property of the Entity PhysicianPaymentInvoice<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPhysicianPaymentInvoice"."PhysicianInvoiceID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PhysicianInvoiceId
		{
			get { return (System.Int64)GetValue((int)PhysicianPaymentInvoiceFieldIndex.PhysicianInvoiceId, true); }
			set	{ SetValue((int)PhysicianPaymentInvoiceFieldIndex.PhysicianInvoiceId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_physicianInvoice != null)
						{
							_physicianInvoice.UnsetRelatedEntity(this, "PhysicianPaymentInvoice");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "PhysicianPaymentInvoice");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_physicianPayment != null)
						{
							_physicianPayment.UnsetRelatedEntity(this, "PhysicianPaymentInvoice");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.PhysicianPaymentInvoiceEntity; }
		}
		#endregion
