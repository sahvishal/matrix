...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EventSurveyTemplate'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EventSurveyTemplateEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EventSurveyTemplateEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EventSurveyTemplateEntity():base("EventSurveyTemplateEntity")
		{
		...
		public EventSurveyTemplateEntity(IEntityFields2 fields):base("EventSurveyTemplateEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EventSurveyTemplateEntity</param>
		public EventSurveyTemplateEntity(IValidator validator):base("EventSurveyTemplateEntity")
		{
		...
		/// <param name="validator">The custom validator object for this EventSurveyTemplateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventSurveyTemplateEntity(System.Int64 eventId, System.Int64 surveyTemplateId, IValidator validator):base("EventSurveyTemplateEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.EventId = eventId;
			this.SurveyTemplateId = surveyTemplateId;
		...
		protected EventSurveyTemplateEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EventSurveyTemplateFieldIndex)fieldIndex)
			{
				case EventSurveyTemplateFieldIndex.EventId:
					DesetupSyncEvents(true, false);
					break;
				case EventSurveyTemplateFieldIndex.SurveyTemplateId:
		...
		{
			return EventSurveyTemplateEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Events":
					toReturn.Add(EventSurveyTemplateEntity.Relations.EventsEntityUsingEventId);
					break;
				case "SurveyTemplate":
					toReturn.Add(EventSurveyTemplateEntity.Relations.SurveyTemplateEntityUsingSurveyTemplateId);
					break;
		...
		public bool TestOriginalFieldValueForNull(EventSurveyTemplateFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EventSurveyTemplateFieldIndex fieldIndex)
		{
		...
		{
			return new EventSurveyTemplateRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.EventSurveyTemplateEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EventSurveyTemplateEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventSurveyTemplateEntity.Relations.EventsEntityUsingEventId, true, signalRelatedEntity, "EventSurveyTemplate", resetFKFields, new int[] { (int)EventSurveyTemplateFieldIndex.EventId } );		
			_events = null;
		}
		...
		private void SetupSyncEvents(IEntity2 relatedEntity)
		{
			if(_events!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventSurveyTemplateEntity.Relations.EventsEntityUsingEventId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _surveyTemplate, new PropertyChangedEventHandler( OnSurveyTemplatePropertyChanged ), "SurveyTemplate", EventSurveyTemplateEntity.Relations.SurveyTemplateEntityUsingSurveyTemplateId, true, signalRelatedEntity, "EventSurveyTemplate", resetFKFields, new int[] { (int)EventSurveyTemplateFieldIndex.SurveyTemplateId } );		
			_surveyTemplate = null;
		}
		...
		private void SetupSyncSurveyTemplate(IEntity2 relatedEntity)
		{
			if(_surveyTemplate!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _surveyTemplate, new PropertyChangedEventHandler( OnSurveyTemplatePropertyChanged ), "SurveyTemplate", EventSurveyTemplateEntity.Relations.SurveyTemplateEntityUsingSurveyTemplateId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EventSurveyTemplateEntity</param>
		...
		public  static EventSurveyTemplateRelations Relations
		{
			get	{ return new EventSurveyTemplateRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEvents
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Events")[0], (int)Falcon.Data.EntityType.EventSurveyTemplateEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, null, null, "Events", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSurveyTemplate
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SurveyTemplateEntityFactory))),
					(IEntityRelation)GetRelationsForField("SurveyTemplate")[0], (int)Falcon.Data.EntityType.EventSurveyTemplateEntity, (int)Falcon.Data.EntityType.SurveyTemplateEntity, 0, null, null, null, null, "SurveyTemplate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return EventSurveyTemplateEntity.CustomProperties;}
		}
		...
		{
			get { return EventSurveyTemplateEntity.FieldsCustomProperties;}
		}

		/// <summary> The EventId property of the Entity EventSurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventSurveyTemplate"."EventId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventId
		{
			get { return (System.Int64)GetValue((int)EventSurveyTemplateFieldIndex.EventId, true); }
			set	{ SetValue((int)EventSurveyTemplateFieldIndex.EventId, value); }
		}

		/// <summary> The SurveyTemplateId property of the Entity EventSurveyTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventSurveyTemplate"."SurveyTemplateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 SurveyTemplateId
		{
			get { return (System.Int64)GetValue((int)EventSurveyTemplateFieldIndex.SurveyTemplateId, true); }
			set	{ SetValue((int)EventSurveyTemplateFieldIndex.SurveyTemplateId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_events != null)
						{
							_events.UnsetRelatedEntity(this, "EventSurveyTemplate");
						}
					}
					else
					{
						if(_events!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "EventSurveyTemplate");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_surveyTemplate != null)
						{
							_surveyTemplate.UnsetRelatedEntity(this, "EventSurveyTemplate");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.EventSurveyTemplateEntity; }
		}
		#endregion
