...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EventFluConsentTemplate'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EventFluConsentTemplateEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EventFluConsentTemplateEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EventFluConsentTemplateEntity():base("EventFluConsentTemplateEntity")
		{
		...
		public EventFluConsentTemplateEntity(IEntityFields2 fields):base("EventFluConsentTemplateEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EventFluConsentTemplateEntity</param>
		public EventFluConsentTemplateEntity(IValidator validator):base("EventFluConsentTemplateEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="eventId">PK value for EventFluConsentTemplate which data should be fetched into this EventFluConsentTemplate object</param>
		/// <param name="templateId">PK value for EventFluConsentTemplate which data should be fetched into this EventFluConsentTemplate object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventFluConsentTemplateEntity(System.Int64 eventId, System.Int64 templateId):base("EventFluConsentTemplateEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this EventFluConsentTemplateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventFluConsentTemplateEntity(System.Int64 eventId, System.Int64 templateId, IValidator validator):base("EventFluConsentTemplateEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.EventId = eventId;
			this.TemplateId = templateId;
		...
		{
			switch((EventFluConsentTemplateFieldIndex)fieldIndex)
			{
				case EventFluConsentTemplateFieldIndex.EventId:
					DesetupSyncEvents(true, false);
					break;
				case EventFluConsentTemplateFieldIndex.TemplateId:
		...
		{
			return EventFluConsentTemplateEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Events":
					toReturn.Add(EventFluConsentTemplateEntity.Relations.EventsEntityUsingEventId);
					break;
				case "FluConsentTemplate":
					toReturn.Add(EventFluConsentTemplateEntity.Relations.FluConsentTemplateEntityUsingTemplateId);
					break;
		...
		public bool TestOriginalFieldValueForNull(EventFluConsentTemplateFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EventFluConsentTemplateFieldIndex fieldIndex)
		{
		...
		{
			return new EventFluConsentTemplateRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.EventFluConsentTemplateEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EventFluConsentTemplateEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventFluConsentTemplateEntity.Relations.EventsEntityUsingEventId, true, signalRelatedEntity, "EventFluConsentTemplate", resetFKFields, new int[] { (int)EventFluConsentTemplateFieldIndex.EventId } );		
			_events = null;
		}
		...
		private void SetupSyncEvents(IEntity2 relatedEntity)
		{
			if(_events!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventFluConsentTemplateEntity.Relations.EventsEntityUsingEventId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EventFluConsentTemplateEntity</param>
		...
		public  static EventFluConsentTemplateRelations Relations
		{
			get	{ return new EventFluConsentTemplateRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEvents
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Events")[0], (int)Falcon.Data.EntityType.EventFluConsentTemplateEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, null, null, "Events", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFluConsentTemplate
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FluConsentTemplateEntityFactory))),
					(IEntityRelation)GetRelationsForField("FluConsentTemplate")[0], (int)Falcon.Data.EntityType.EventFluConsentTemplateEntity, (int)Falcon.Data.EntityType.FluConsentTemplateEntity, 0, null, null, null, null, "FluConsentTemplate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return EventFluConsentTemplateEntity.CustomProperties;}
		}
		...
		{
			get { return EventFluConsentTemplateEntity.FieldsCustomProperties;}
		}

		/// <summary> The EventId property of the Entity EventFluConsentTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventFluConsentTemplate"."EventId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventId
		{
			get { return (System.Int64)GetValue((int)EventFluConsentTemplateFieldIndex.EventId, true); }
			set	{ SetValue((int)EventFluConsentTemplateFieldIndex.EventId, value); }
		}

		/// <summary> The TemplateId property of the Entity EventFluConsentTemplate<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventFluConsentTemplate"."TemplateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TemplateId
		{
			get { return (System.Int64)GetValue((int)EventFluConsentTemplateFieldIndex.TemplateId, true); }
			set	{ SetValue((int)EventFluConsentTemplateFieldIndex.TemplateId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_events != null)
						{
							_events.UnsetRelatedEntity(this, "EventFluConsentTemplate");
						}
					}
					else
					{
						if(_events!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "EventFluConsentTemplate");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_fluConsentTemplate != null)
						{
							_fluConsentTemplate.UnsetRelatedEntity(this, "EventFluConsentTemplate");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.EventFluConsentTemplateEntity; }
		}
		#endregion
