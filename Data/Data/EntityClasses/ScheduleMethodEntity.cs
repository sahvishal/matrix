...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ScheduleMethod'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ScheduleMethodEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ScheduleMethodEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ScheduleMethodEntity():base("ScheduleMethodEntity")
		{
		...
		public ScheduleMethodEntity(IEntityFields2 fields):base("ScheduleMethodEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ScheduleMethodEntity</param>
		public ScheduleMethodEntity(IValidator validator):base("ScheduleMethodEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="scheduleMethodId">PK value for ScheduleMethod which data should be fetched into this ScheduleMethod object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ScheduleMethodEntity(System.Int64 scheduleMethodId):base("ScheduleMethodEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ScheduleMethodId = scheduleMethodId;
		}
		...
		/// <param name="validator">The custom validator object for this ScheduleMethodEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ScheduleMethodEntity(System.Int64 scheduleMethodId, IValidator validator):base("ScheduleMethodEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ScheduleMethodId = scheduleMethodId;
		}
		...
		protected ScheduleMethodEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ScheduleMethodFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ScheduleMethodEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Events":
					toReturn.Add(ScheduleMethodEntity.Relations.EventsEntityUsingScheduleMethodId);
					break;
				case "CommunicationModeCollectionViaEvents":
					toReturn.Add(ScheduleMethodEntity.Relations.EventsEntityUsingScheduleMethodId, "ScheduleMethodEntity__", "Events_", JoinHint.None);
		...
		public bool TestOriginalFieldValueForNull(ScheduleMethodFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ScheduleMethodFieldIndex fieldIndex)
		{
		...
		{
			return new ScheduleMethodRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoEvents()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EventsFields.ScheduleMethodId, null, ComparisonOperator.Equal, this.ScheduleMethodId));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoCommunicationModeCollectionViaEvents()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ScheduleMethodFields.ScheduleMethodId, null, ComparisonOperator.Equal, this.ScheduleMethodId, "ScheduleMethodEntity__"));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.ScheduleMethodEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ScheduleMethodEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ScheduleMethodEntity</param>
		...
		public  static ScheduleMethodRelations Relations
		{
			get	{ return new ScheduleMethodRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEvents
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<EventsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Events")[0], (int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, null, null, "Events", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCommunicationModeCollectionViaEvents
		{
			get
			{
				IEntityRelation intermediateRelation = ScheduleMethodEntity.Relations.EventsEntityUsingScheduleMethodId;
				...
				return new PrefetchPathElement2(new EntityCollection<CommunicationModeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CommunicationModeEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.CommunicationModeEntity, 0, null, null, GetRelationsForField("CommunicationModeCollectionViaEvents"), null, "CommunicationModeCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEventTypeCollectionViaEvents
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EventTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EventTypeEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.EventTypeEntity, 0, null, null, GetRelationsForField("EventTypeCollectionViaEvents"), null, "EventTypeCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHafTemplateCollectionViaEvents
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<HafTemplateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(HafTemplateEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.HafTemplateEntity, 0, null, null, GetRelationsForField("HafTemplateCollectionViaEvents"), null, "HafTemplateCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaEvents
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaEvents"), null, "LookupCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaEvents____
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaEvents____"), null, "LookupCollectionViaEvents____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaEvents___
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaEvents___"), null, "LookupCollectionViaEvents___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaEvents__
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaEvents__"), null, "LookupCollectionViaEvents__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathLookupCollectionViaEvents_
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<LookupEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.LookupEntity, 0, null, null, GetRelationsForField("LookupCollectionViaEvents_"), null, "LookupCollectionViaEvents_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathNotesDetailsCollectionViaEvents
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<NotesDetailsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(NotesDetailsEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.NotesDetailsEntity, 0, null, null, GetRelationsForField("NotesDetailsCollectionViaEvents"), null, "NotesDetailsCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaEvents
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaEvents"), null, "OrganizationRoleUserCollectionViaEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaEvents____
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaEvents____"), null, "OrganizationRoleUserCollectionViaEvents____", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaEvents_
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaEvents_"), null, "OrganizationRoleUserCollectionViaEvents_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaEvents__
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaEvents__"), null, "OrganizationRoleUserCollectionViaEvents__", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUserCollectionViaEvents___
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Events_");
				return new PrefetchPathElement2(new EntityCollection<OrganizationRoleUserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))), intermediateRelation,
					(int)Falcon.Data.EntityType.ScheduleMethodEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, GetRelationsForField("OrganizationRoleUserCollectionViaEvents___"), null, "OrganizationRoleUserCollectionViaEvents___", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return ScheduleMethodEntity.CustomProperties;}
		}
		...
		{
			get { return ScheduleMethodEntity.FieldsCustomProperties;}
		}

		/// <summary> The ScheduleMethodId property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."ScheduleMethodID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 ScheduleMethodId
		{
			get { return (System.Int64)GetValue((int)ScheduleMethodFieldIndex.ScheduleMethodId, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.ScheduleMethodId, value); }
		}

		/// <summary> The Name property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)ScheduleMethodFieldIndex.Name, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.Name, value); }
		}

		/// <summary> The Description property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 1000<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)ScheduleMethodFieldIndex.Description, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.Description, value); }
		}

		/// <summary> The DateCreated property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)ScheduleMethodFieldIndex.DateCreated, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateModified property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."DateModified"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateModified
		{
			get { return (System.DateTime)GetValue((int)ScheduleMethodFieldIndex.DateModified, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.DateModified, value); }
		}

		/// <summary> The IsActive property of the Entity ScheduleMethod<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblScheduleMethod"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)ScheduleMethodFieldIndex.IsActive, true); }
			set	{ SetValue((int)ScheduleMethodFieldIndex.IsActive, value); }
		}
		...
		public virtual EntityCollection<EventsEntity> Events
		{
			get
			{
				if(_events==null)
				{
					...
					_events.SetContainingEntityInfo(this, "ScheduleMethod");
				}
				return _events;
			}
		}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.ScheduleMethodEntity; }
		}
		#endregion
