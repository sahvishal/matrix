...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'IncidentalFindingIncidentalFindingReadingGroup'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IncidentalFindingIncidentalFindingReadingGroupEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static IncidentalFindingIncidentalFindingReadingGroupEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public IncidentalFindingIncidentalFindingReadingGroupEntity():base("IncidentalFindingIncidentalFindingReadingGroupEntity")
		{
		...
		public IncidentalFindingIncidentalFindingReadingGroupEntity(IEntityFields2 fields):base("IncidentalFindingIncidentalFindingReadingGroupEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this IncidentalFindingIncidentalFindingReadingGroupEntity</param>
		public IncidentalFindingIncidentalFindingReadingGroupEntity(IValidator validator):base("IncidentalFindingIncidentalFindingReadingGroupEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="incidentalFindingId">PK value for IncidentalFindingIncidentalFindingReadingGroup which data should be fetched into this IncidentalFindingIncidentalFindingReadingGroup object</param>
		/// <param name="groupId">PK value for IncidentalFindingIncidentalFindingReadingGroup which data should be fetched into this IncidentalFindingIncidentalFindingReadingGroup object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IncidentalFindingIncidentalFindingReadingGroupEntity(System.Int64 incidentalFindingId, System.Int64 groupId):base("IncidentalFindingIncidentalFindingReadingGroupEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.IncidentalFindingId = incidentalFindingId;
		...
		/// <param name="validator">The custom validator object for this IncidentalFindingIncidentalFindingReadingGroupEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IncidentalFindingIncidentalFindingReadingGroupEntity(System.Int64 incidentalFindingId, System.Int64 groupId, IValidator validator):base("IncidentalFindingIncidentalFindingReadingGroupEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.IncidentalFindingId = incidentalFindingId;
			this.GroupId = groupId;
		...
		protected IncidentalFindingIncidentalFindingReadingGroupEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((IncidentalFindingIncidentalFindingReadingGroupFieldIndex)fieldIndex)
			{
				case IncidentalFindingIncidentalFindingReadingGroupFieldIndex.IncidentalFindingId:
					DesetupSyncIncidentalFindings(true, false);
					break;
				case IncidentalFindingIncidentalFindingReadingGroupFieldIndex.GroupId:
		...
		{
			return IncidentalFindingIncidentalFindingReadingGroupEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(IncidentalFindingIncidentalFindingReadingGroupFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IncidentalFindingIncidentalFindingReadingGroupFieldIndex fieldIndex)
		{
		...
		{
			return new IncidentalFindingIncidentalFindingReadingGroupRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.IncidentalFindingIncidentalFindingReadingGroupEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(IncidentalFindingIncidentalFindingReadingGroupEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _incidentalFindingReadingGroup, new PropertyChangedEventHandler( OnIncidentalFindingReadingGroupPropertyChanged ), "IncidentalFindingReadingGroup", IncidentalFindingIncidentalFindingReadingGroupEntity.Relations.IncidentalFindingReadingGroupEntityUsingGroupId, true, signalRelatedEntity, "IncidentalFindingIncidentalFindingReadingGroup", resetFKFields, new int[] { (int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.GroupId } );		
			_incidentalFindingReadingGroup = null;
		}
		...
		private void SetupSyncIncidentalFindingReadingGroup(IEntity2 relatedEntity)
		{
			if(_incidentalFindingReadingGroup!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _incidentalFindingReadingGroup, new PropertyChangedEventHandler( OnIncidentalFindingReadingGroupPropertyChanged ), "IncidentalFindingReadingGroup", IncidentalFindingIncidentalFindingReadingGroupEntity.Relations.IncidentalFindingReadingGroupEntityUsingGroupId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _incidentalFindings, new PropertyChangedEventHandler( OnIncidentalFindingsPropertyChanged ), "IncidentalFindings", IncidentalFindingIncidentalFindingReadingGroupEntity.Relations.IncidentalFindingsEntityUsingIncidentalFindingId, true, signalRelatedEntity, "IncidentalFindingIncidentalFindingReadingGroup", resetFKFields, new int[] { (int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.IncidentalFindingId } );		
			_incidentalFindings = null;
		}
		...
		private void SetupSyncIncidentalFindings(IEntity2 relatedEntity)
		{
			if(_incidentalFindings!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _incidentalFindings, new PropertyChangedEventHandler( OnIncidentalFindingsPropertyChanged ), "IncidentalFindings", IncidentalFindingIncidentalFindingReadingGroupEntity.Relations.IncidentalFindingsEntityUsingIncidentalFindingId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this IncidentalFindingIncidentalFindingReadingGroupEntity</param>
		...
		public  static IncidentalFindingIncidentalFindingReadingGroupRelations Relations
		{
			get	{ return new IncidentalFindingIncidentalFindingReadingGroupRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathIncidentalFindingReadingGroup
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IncidentalFindingReadingGroupEntityFactory))),
					(IEntityRelation)GetRelationsForField("IncidentalFindingReadingGroup")[0], (int)Falcon.Data.EntityType.IncidentalFindingIncidentalFindingReadingGroupEntity, (int)Falcon.Data.EntityType.IncidentalFindingReadingGroupEntity, 0, null, null, null, null, "IncidentalFindingReadingGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathIncidentalFindings
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IncidentalFindingsEntityFactory))),
					(IEntityRelation)GetRelationsForField("IncidentalFindings")[0], (int)Falcon.Data.EntityType.IncidentalFindingIncidentalFindingReadingGroupEntity, (int)Falcon.Data.EntityType.IncidentalFindingsEntity, 0, null, null, null, null, "IncidentalFindings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return IncidentalFindingIncidentalFindingReadingGroupEntity.CustomProperties;}
		}
		...
		{
			get { return IncidentalFindingIncidentalFindingReadingGroupEntity.FieldsCustomProperties;}
		}

		/// <summary> The IncidentalFindingId property of the Entity IncidentalFindingIncidentalFindingReadingGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIncidentalFindingIncidentalFindingReadingGroup"."IncidentalFindingId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 IncidentalFindingId
		{
			get { return (System.Int64)GetValue((int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.IncidentalFindingId, true); }
			set	{ SetValue((int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.IncidentalFindingId, value); }
		}

		/// <summary> The GroupId property of the Entity IncidentalFindingIncidentalFindingReadingGroup<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIncidentalFindingIncidentalFindingReadingGroup"."GroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 GroupId
		{
			get { return (System.Int64)GetValue((int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.GroupId, true); }
			set	{ SetValue((int)IncidentalFindingIncidentalFindingReadingGroupFieldIndex.GroupId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_incidentalFindingReadingGroup != null)
						{
							_incidentalFindingReadingGroup.UnsetRelatedEntity(this, "IncidentalFindingIncidentalFindingReadingGroup");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "IncidentalFindingIncidentalFindingReadingGroup");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_incidentalFindings != null)
						{
							_incidentalFindings.UnsetRelatedEntity(this, "IncidentalFindingIncidentalFindingReadingGroup");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.IncidentalFindingIncidentalFindingReadingGroupEntity; }
		}
		#endregion
