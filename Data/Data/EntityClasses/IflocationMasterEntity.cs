...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'IflocationMaster'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IflocationMasterEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static IflocationMasterEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public IflocationMasterEntity():base("IflocationMasterEntity")
		{
		...
		public IflocationMasterEntity(IEntityFields2 fields):base("IflocationMasterEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this IflocationMasterEntity</param>
		public IflocationMasterEntity(IValidator validator):base("IflocationMasterEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="locationId">PK value for IflocationMaster which data should be fetched into this IflocationMaster object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IflocationMasterEntity(System.Byte locationId):base("IflocationMasterEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this IflocationMasterEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IflocationMasterEntity(System.Byte locationId, IValidator validator):base("IflocationMasterEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.LocationId = locationId;
		}
		...
		{
			switch((IflocationMasterFieldIndex)fieldIndex)
			{
				case IflocationMasterFieldIndex.IncidentalFindingsId:
		...
		{
			return IflocationMasterEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "IncidentalFindings":
					toReturn.Add(IflocationMasterEntity.Relations.IncidentalFindingsEntityUsingIncidentalFindingsId);
					break;
		...
		public bool TestOriginalFieldValueForNull(IflocationMasterFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IflocationMasterFieldIndex fieldIndex)
		{
		...
		{
			return new IflocationMasterRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.IflocationMasterEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(IflocationMasterEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this IflocationMasterEntity</param>
		...
		public  static IflocationMasterRelations Relations
		{
			get	{ return new IflocationMasterRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathIncidentalFindings
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IncidentalFindingsEntityFactory))),
					(IEntityRelation)GetRelationsForField("IncidentalFindings")[0], (int)Falcon.Data.EntityType.IflocationMasterEntity, (int)Falcon.Data.EntityType.IncidentalFindingsEntity, 0, null, null, null, null, "IncidentalFindings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return IflocationMasterEntity.CustomProperties;}
		}
		...
		{
			get { return IflocationMasterEntity.FieldsCustomProperties;}
		}

		/// <summary> The LocationId property of the Entity IflocationMaster<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIFLocationMaster"."LocationID"<br/>
		/// Table field type characteristics (type, precision, scale, length): TinyInt, 3, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Byte LocationId
		{
			get { return (System.Byte)GetValue((int)IflocationMasterFieldIndex.LocationId, true); }
			set	{ SetValue((int)IflocationMasterFieldIndex.LocationId, value); }
		}

		/// <summary> The Label property of the Entity IflocationMaster<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIFLocationMaster"."Label"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Label
		{
			get { return (System.String)GetValue((int)IflocationMasterFieldIndex.Label, true); }
			set	{ SetValue((int)IflocationMasterFieldIndex.Label, value); }
		}

		/// <summary> The IncidentalFindingsId property of the Entity IflocationMaster<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIFLocationMaster"."IncidentalFindingsID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 IncidentalFindingsId
		{
			get { return (System.Int64)GetValue((int)IflocationMasterFieldIndex.IncidentalFindingsId, true); }
			set	{ SetValue((int)IflocationMasterFieldIndex.IncidentalFindingsId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_incidentalFindings != null)
						{
							_incidentalFindings.UnsetRelatedEntity(this, "IflocationMaster");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "IflocationMaster");
						}
					}
				}
			}
		...
		{ 
			get { return (int)Falcon.Data.EntityType.IflocationMasterEntity; }
		}
		#endregion
