...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'DisqualifiedTest'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class DisqualifiedTestEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static DisqualifiedTestEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public DisqualifiedTestEntity():base("DisqualifiedTestEntity")
		{
		...
		public DisqualifiedTestEntity(IEntityFields2 fields):base("DisqualifiedTestEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this DisqualifiedTestEntity</param>
		public DisqualifiedTestEntity(IValidator validator):base("DisqualifiedTestEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="testId">PK value for DisqualifiedTest which data should be fetched into this DisqualifiedTest object</param>
		/// <param name="questionId">PK value for DisqualifiedTest which data should be fetched into this DisqualifiedTest object</param>
		/// <param name="version">PK value for DisqualifiedTest which data should be fetched into this DisqualifiedTest object</param>
		/// <param name="customerId">PK value for DisqualifiedTest which data should be fetched into this DisqualifiedTest object</param>
		/// <param name="eventId">PK value for DisqualifiedTest which data should be fetched into this DisqualifiedTest object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public DisqualifiedTestEntity(System.Int64 testId, System.Int64 questionId, System.Int64 version, System.Int64 customerId, System.Int64 eventId):base("DisqualifiedTestEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TestId = testId;
		...
		/// <param name="validator">The custom validator object for this DisqualifiedTestEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public DisqualifiedTestEntity(System.Int64 testId, System.Int64 questionId, System.Int64 version, System.Int64 customerId, System.Int64 eventId, IValidator validator):base("DisqualifiedTestEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TestId = testId;
			this.QuestionId = questionId;
		...
		protected DisqualifiedTestEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((DisqualifiedTestFieldIndex)fieldIndex)
			{
				case DisqualifiedTestFieldIndex.TestId:
					DesetupSyncTest(true, false);
					break;
				case DisqualifiedTestFieldIndex.EventCustomerId:
					DesetupSyncEventCustomers(true, false);
					break;
				case DisqualifiedTestFieldIndex.QuestionId:
					DesetupSyncPreQualificationQuestion(true, false);
					break;
				case DisqualifiedTestFieldIndex.CreatedBy:
					DesetupSyncOrganizationRoleUser(true, false);
					break;
				case DisqualifiedTestFieldIndex.UpdatedBy:
					DesetupSyncOrganizationRoleUser_(true, false);
					break;
				case DisqualifiedTestFieldIndex.CustomerId:
					DesetupSyncCustomerProfile(true, false);
					break;
				case DisqualifiedTestFieldIndex.EventId:
		...
		{
			return DisqualifiedTestEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "CustomerProfile":
					toReturn.Add(DisqualifiedTestEntity.Relations.CustomerProfileEntityUsingCustomerId);
					break;
				case "EventCustomers":
					toReturn.Add(DisqualifiedTestEntity.Relations.EventCustomersEntityUsingEventCustomerId);
					break;
				case "Events":
					toReturn.Add(DisqualifiedTestEntity.Relations.EventsEntityUsingEventId);
					break;
				case "OrganizationRoleUser_":
					toReturn.Add(DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingUpdatedBy);
					break;
				case "OrganizationRoleUser":
					toReturn.Add(DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy);
					break;
				case "PreQualificationQuestion":
					toReturn.Add(DisqualifiedTestEntity.Relations.PreQualificationQuestionEntityUsingQuestionId);
					break;
				case "Test":
					toReturn.Add(DisqualifiedTestEntity.Relations.TestEntityUsingTestId);
					break;
		...
		public bool TestOriginalFieldValueForNull(DisqualifiedTestFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(DisqualifiedTestFieldIndex fieldIndex)
		{
		...
		{
			return new DisqualifiedTestRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.DisqualifiedTestEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(DisqualifiedTestEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _customerProfile, new PropertyChangedEventHandler( OnCustomerProfilePropertyChanged ), "CustomerProfile", DisqualifiedTestEntity.Relations.CustomerProfileEntityUsingCustomerId, true, signalRelatedEntity, "DisqualifiedTest", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.CustomerId } );		
			_customerProfile = null;
		}
		...
		private void SetupSyncCustomerProfile(IEntity2 relatedEntity)
		{
			if(_customerProfile!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _customerProfile, new PropertyChangedEventHandler( OnCustomerProfilePropertyChanged ), "CustomerProfile", DisqualifiedTestEntity.Relations.CustomerProfileEntityUsingCustomerId, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEventCustomers(IEntity2 relatedEntity)
		{
			if(_eventCustomers!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _eventCustomers, new PropertyChangedEventHandler( OnEventCustomersPropertyChanged ), "EventCustomers", DisqualifiedTestEntity.Relations.EventCustomersEntityUsingEventCustomerId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", DisqualifiedTestEntity.Relations.EventsEntityUsingEventId, true, signalRelatedEntity, "DisqualifiedTest", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.EventId } );		
			_events = null;
		}
		...
		private void SetupSyncEvents(IEntity2 relatedEntity)
		{
			if(_events!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", DisqualifiedTestEntity.Relations.EventsEntityUsingEventId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingUpdatedBy, true, signalRelatedEntity, "DisqualifiedTest_", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.UpdatedBy } );		
			_organizationRoleUser_ = null;
		}
		...
		private void SetupSyncOrganizationRoleUser_(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser_!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser_, new PropertyChangedEventHandler( OnOrganizationRoleUser_PropertyChanged ), "OrganizationRoleUser_", DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingUpdatedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, signalRelatedEntity, "DisqualifiedTest", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.CreatedBy } );		
			_organizationRoleUser = null;
		}
		...
		private void SetupSyncOrganizationRoleUser(IEntity2 relatedEntity)
		{
			if(_organizationRoleUser!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _organizationRoleUser, new PropertyChangedEventHandler( OnOrganizationRoleUserPropertyChanged ), "OrganizationRoleUser", DisqualifiedTestEntity.Relations.OrganizationRoleUserEntityUsingCreatedBy, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _preQualificationQuestion, new PropertyChangedEventHandler( OnPreQualificationQuestionPropertyChanged ), "PreQualificationQuestion", DisqualifiedTestEntity.Relations.PreQualificationQuestionEntityUsingQuestionId, true, signalRelatedEntity, "DisqualifiedTest", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.QuestionId } );		
			_preQualificationQuestion = null;
		}
		...
		private void SetupSyncPreQualificationQuestion(IEntity2 relatedEntity)
		{
			if(_preQualificationQuestion!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _preQualificationQuestion, new PropertyChangedEventHandler( OnPreQualificationQuestionPropertyChanged ), "PreQualificationQuestion", DisqualifiedTestEntity.Relations.PreQualificationQuestionEntityUsingQuestionId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", DisqualifiedTestEntity.Relations.TestEntityUsingTestId, true, signalRelatedEntity, "DisqualifiedTest", resetFKFields, new int[] { (int)DisqualifiedTestFieldIndex.TestId } );		
			_test = null;
		}
		...
		private void SetupSyncTest(IEntity2 relatedEntity)
		{
			if(_test!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _test, new PropertyChangedEventHandler( OnTestPropertyChanged ), "Test", DisqualifiedTestEntity.Relations.TestEntityUsingTestId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this DisqualifiedTestEntity</param>
		...
		public  static DisqualifiedTestRelations Relations
		{
			get	{ return new DisqualifiedTestRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("CustomerProfile")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.CustomerProfileEntity, 0, null, null, null, null, "CustomerProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEventCustomers
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventCustomersEntityFactory))),
					(IEntityRelation)GetRelationsForField("EventCustomers")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.EventCustomersEntity, 0, null, null, null, null, "EventCustomers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEvents
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Events")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, null, null, "Events", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser_
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser_")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrganizationRoleUser
		{
			...
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrganizationRoleUserEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrganizationRoleUser")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.OrganizationRoleUserEntity, 0, null, null, null, null, "OrganizationRoleUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPreQualificationQuestion
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PreQualificationQuestionEntityFactory))),
					(IEntityRelation)GetRelationsForField("PreQualificationQuestion")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.PreQualificationQuestionEntity, 0, null, null, null, null, "PreQualificationQuestion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTest
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TestEntityFactory))),
					(IEntityRelation)GetRelationsForField("Test")[0], (int)Falcon.Data.EntityType.DisqualifiedTestEntity, (int)Falcon.Data.EntityType.TestEntity, 0, null, null, null, null, "Test", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return DisqualifiedTestEntity.CustomProperties;}
		}
		...
		{
			get { return DisqualifiedTestEntity.FieldsCustomProperties;}
		}

		/// <summary> The TestId property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."TestId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TestId
		{
			get { return (System.Int64)GetValue((int)DisqualifiedTestFieldIndex.TestId, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.TestId, value); }
		}

		/// <summary> The EventCustomerId property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."EventCustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> EventCustomerId
		{
			get { return (Nullable<System.Int64>)GetValue((int)DisqualifiedTestFieldIndex.EventCustomerId, false); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.EventCustomerId, value); }
		}

		/// <summary> The QuestionId property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."QuestionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 QuestionId
		{
			get { return (System.Int64)GetValue((int)DisqualifiedTestFieldIndex.QuestionId, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.QuestionId, value); }
		}

		/// <summary> The Answer property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."Answer"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Answer
		{
			get { return (System.String)GetValue((int)DisqualifiedTestFieldIndex.Answer, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.Answer, value); }
		}

		/// <summary> The Version property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."Version"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 Version
		{
			get { return (System.Int64)GetValue((int)DisqualifiedTestFieldIndex.Version, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.Version, value); }
		}

		/// <summary> The IsActive property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)DisqualifiedTestFieldIndex.IsActive, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.IsActive, value); }
		}

		/// <summary> The CreatedBy property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."CreatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> CreatedBy
		{
			get { return (Nullable<System.Int64>)GetValue((int)DisqualifiedTestFieldIndex.CreatedBy, false); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.CreatedBy, value); }
		}

		/// <summary> The CreatedDate property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."CreatedDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> CreatedDate
		{
			get { return (Nullable<System.DateTime>)GetValue((int)DisqualifiedTestFieldIndex.CreatedDate, false); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.CreatedDate, value); }
		}

		/// <summary> The UpdatedBy property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."UpdatedBy"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int64> UpdatedBy
		{
			get { return (Nullable<System.Int64>)GetValue((int)DisqualifiedTestFieldIndex.UpdatedBy, false); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.UpdatedBy, value); }
		}

		/// <summary> The UpdatedDate property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."UpdatedDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> UpdatedDate
		{
			get { return (Nullable<System.DateTime>)GetValue((int)DisqualifiedTestFieldIndex.UpdatedDate, false); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.UpdatedDate, value); }
		}

		/// <summary> The CustomerId property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."CustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CustomerId
		{
			get { return (System.Int64)GetValue((int)DisqualifiedTestFieldIndex.CustomerId, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.CustomerId, value); }
		}

		/// <summary> The EventId property of the Entity DisqualifiedTest<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblDisqualifiedTest"."EventId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventId
		{
			get { return (System.Int64)GetValue((int)DisqualifiedTestFieldIndex.EventId, true); }
			set	{ SetValue((int)DisqualifiedTestFieldIndex.EventId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_customerProfile != null)
						{
							_customerProfile.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "DisqualifiedTest");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_eventCustomers != null)
						{
							_eventCustomers.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_events != null)
						{
							_events.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser_ != null)
						{
							_organizationRoleUser_.UnsetRelatedEntity(this, "DisqualifiedTest_");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "DisqualifiedTest_");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_organizationRoleUser != null)
						{
							_organizationRoleUser.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_preQualificationQuestion != null)
						{
							_preQualificationQuestion.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_test != null)
						{
							_test.UnsetRelatedEntity(this, "DisqualifiedTest");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.DisqualifiedTestEntity; }
		}
		#endregion
