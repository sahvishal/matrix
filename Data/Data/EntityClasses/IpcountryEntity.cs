...
namespace HealthYes.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Ipcountry'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IpcountryEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static IpcountryEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public IpcountryEntity():base("IpcountryEntity")
		{
		...
		public IpcountryEntity(IEntityFields2 fields):base("IpcountryEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this IpcountryEntity</param>
		public IpcountryEntity(IValidator validator):base("IpcountryEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="ipcountryId">PK value for Ipcountry which data should be fetched into this Ipcountry object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IpcountryEntity(System.Int64 ipcountryId):base("IpcountryEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this IpcountryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public IpcountryEntity(System.Int64 ipcountryId, IValidator validator):base("IpcountryEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.IpcountryId = ipcountryId;
		}
		...
		protected IpcountryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((IpcountryFieldIndex)fieldIndex)
			{
				case IpcountryFieldIndex.Ipid:
					DesetupSyncIp(true, false);
					break;
				case IpcountryFieldIndex.CountryId:
		...
		{
			return IpcountryEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(IpcountryFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IpcountryFieldIndex fieldIndex)
		{
		...
		{
			return new IpcountryRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(HealthYes.Data.EntityType.IpcountryEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(IpcountryEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("IpcountryId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _country, new PropertyChangedEventHandler( OnCountryPropertyChanged ), "Country", IpcountryEntity.Relations.CountryEntityUsingCountryId, true, signalRelatedEntity, "Ipcountry", resetFKFields, new int[] { (int)IpcountryFieldIndex.CountryId } );		
			_country = null;
		}
		...
		private void SetupSyncCountry(IEntity2 relatedEntity)
		{
			if(_country!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _country, new PropertyChangedEventHandler( OnCountryPropertyChanged ), "Country", IpcountryEntity.Relations.CountryEntityUsingCountryId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this IpcountryEntity</param>
		...
		public  static IpcountryRelations Relations
		{
			get	{ return new IpcountryRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCountry
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryEntityFactory))),
					(IEntityRelation)GetRelationsForField("Country")[0], (int)HealthYes.Data.EntityType.IpcountryEntity, (int)HealthYes.Data.EntityType.CountryEntity, 0, null, null, null, null, "Country", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathIp
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IpEntityFactory))),
					(IEntityRelation)GetRelationsForField("Ip")[0], (int)HealthYes.Data.EntityType.IpcountryEntity, (int)HealthYes.Data.EntityType.IpEntity, 0, null, null, null, null, "Ip", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return IpcountryEntity.CustomProperties;}
		}
		...
		{
			get { return IpcountryEntity.FieldsCustomProperties;}
		}

		/// <summary> The IpcountryId property of the Entity Ipcountry<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIPCountry"."IPCountryID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 IpcountryId
		{
			get { return (System.Int64)GetValue((int)IpcountryFieldIndex.IpcountryId, true); }
			set	{ SetValue((int)IpcountryFieldIndex.IpcountryId, value); }
		}

		/// <summary> The Ipid property of the Entity Ipcountry<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIPCountry"."IPId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 Ipid
		{
			get { return (System.Int64)GetValue((int)IpcountryFieldIndex.Ipid, true); }
			set	{ SetValue((int)IpcountryFieldIndex.Ipid, value); }
		}

		/// <summary> The CountryId property of the Entity Ipcountry<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIPCountry"."CountryID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 CountryId
		{
			get { return (System.Int64)GetValue((int)IpcountryFieldIndex.CountryId, true); }
			set	{ SetValue((int)IpcountryFieldIndex.CountryId, value); }
		}

		/// <summary> The DateCreated property of the Entity Ipcountry<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIPCountry"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)IpcountryFieldIndex.DateCreated, true); }
			set	{ SetValue((int)IpcountryFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateModified property of the Entity Ipcountry<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblIPCountry"."DateModified"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateModified
		{
			get { return (System.DateTime)GetValue((int)IpcountryFieldIndex.DateModified, true); }
			set	{ SetValue((int)IpcountryFieldIndex.DateModified, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_country != null)
						{
							_country.UnsetRelatedEntity(this, "Ipcountry");
						}
					}
					else
					{
						if(_country!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "Ipcountry");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_ip != null)
						{
							_ip.UnsetRelatedEntity(this, "Ipcountry");
						}
					}
					else
					{
		...
		{ 
			get { return (int)HealthYes.Data.EntityType.IpcountryEntity; }
		}
		#endregion
