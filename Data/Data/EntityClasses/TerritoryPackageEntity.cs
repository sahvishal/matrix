...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TerritoryPackage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TerritoryPackageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static TerritoryPackageEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public TerritoryPackageEntity():base("TerritoryPackageEntity")
		{
		...
		public TerritoryPackageEntity(IEntityFields2 fields):base("TerritoryPackageEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this TerritoryPackageEntity</param>
		public TerritoryPackageEntity(IValidator validator):base("TerritoryPackageEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="territoryId">PK value for TerritoryPackage which data should be fetched into this TerritoryPackage object</param>
		/// <param name="packageId">PK value for TerritoryPackage which data should be fetched into this TerritoryPackage object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TerritoryPackageEntity(System.Int64 territoryId, System.Int64 packageId):base("TerritoryPackageEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this TerritoryPackageEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TerritoryPackageEntity(System.Int64 territoryId, System.Int64 packageId, IValidator validator):base("TerritoryPackageEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TerritoryId = territoryId;
			this.PackageId = packageId;
		...
		protected TerritoryPackageEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((TerritoryPackageFieldIndex)fieldIndex)
			{
				case TerritoryPackageFieldIndex.TerritoryId:
					DesetupSyncTerritory(true, false);
					break;
				case TerritoryPackageFieldIndex.PackageId:
		...
		{
			return TerritoryPackageEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(TerritoryPackageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TerritoryPackageFieldIndex fieldIndex)
		{
		...
		{
			return new TerritoryPackageRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.TerritoryPackageEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TerritoryPackageEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _package, new PropertyChangedEventHandler( OnPackagePropertyChanged ), "Package", TerritoryPackageEntity.Relations.PackageEntityUsingPackageId, true, signalRelatedEntity, "TerritoryPackage", resetFKFields, new int[] { (int)TerritoryPackageFieldIndex.PackageId } );		
			_package = null;
		}
		...
		private void SetupSyncPackage(IEntity2 relatedEntity)
		{
			if(_package!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _package, new PropertyChangedEventHandler( OnPackagePropertyChanged ), "Package", TerritoryPackageEntity.Relations.PackageEntityUsingPackageId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", TerritoryPackageEntity.Relations.TerritoryEntityUsingTerritoryId, true, signalRelatedEntity, "TerritoryPackage", resetFKFields, new int[] { (int)TerritoryPackageFieldIndex.TerritoryId } );		
			_territory = null;
		}
		...
		/// <param name="validator">The validator object for this TerritoryPackageEntity</param>
		...
		public  static TerritoryPackageRelations Relations
		{
			get	{ return new TerritoryPackageRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPackage
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PackageEntityFactory))),
					(IEntityRelation)GetRelationsForField("Package")[0], (int)Falcon.Data.EntityType.TerritoryPackageEntity, (int)Falcon.Data.EntityType.PackageEntity, 0, null, null, null, null, "Package", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTerritory
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TerritoryEntityFactory))),
					(IEntityRelation)GetRelationsForField("Territory")[0], (int)Falcon.Data.EntityType.TerritoryPackageEntity, (int)Falcon.Data.EntityType.TerritoryEntity, 0, null, null, null, null, "Territory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return TerritoryPackageEntity.CustomProperties;}
		}
		...
		{
			get { return TerritoryPackageEntity.FieldsCustomProperties;}
		}

		/// <summary> The TerritoryId property of the Entity TerritoryPackage<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblTerritoryPackage"."TerritoryID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TerritoryId
		{
			get { return (System.Int64)GetValue((int)TerritoryPackageFieldIndex.TerritoryId, true); }
			set	{ SetValue((int)TerritoryPackageFieldIndex.TerritoryId, value); }
		}

		/// <summary> The PackageId property of the Entity TerritoryPackage<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblTerritoryPackage"."PackageID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 PackageId
		{
			get { return (System.Int64)GetValue((int)TerritoryPackageFieldIndex.PackageId, true); }
			set	{ SetValue((int)TerritoryPackageFieldIndex.PackageId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_package != null)
						{
							_package.UnsetRelatedEntity(this, "TerritoryPackage");
						}
					}
					else
					{
						if(_package!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "TerritoryPackage");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_territory != null)
						{
							_territory.UnsetRelatedEntity(this, "TerritoryPackage");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.TerritoryPackageEntity; }
		}
		#endregion
