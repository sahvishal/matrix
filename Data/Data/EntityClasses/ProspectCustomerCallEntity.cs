...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ProspectCustomerCall'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ProspectCustomerCallEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ProspectCustomerCallEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ProspectCustomerCallEntity():base("ProspectCustomerCallEntity")
		{
		...
		public ProspectCustomerCallEntity(IEntityFields2 fields):base("ProspectCustomerCallEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ProspectCustomerCallEntity</param>
		public ProspectCustomerCallEntity(IValidator validator):base("ProspectCustomerCallEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="prospectCustomerId">PK value for ProspectCustomerCall which data should be fetched into this ProspectCustomerCall object</param>
		/// <param name="callId">PK value for ProspectCustomerCall which data should be fetched into this ProspectCustomerCall object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProspectCustomerCallEntity(System.Int64 prospectCustomerId, System.Int64 callId):base("ProspectCustomerCallEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this ProspectCustomerCallEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProspectCustomerCallEntity(System.Int64 prospectCustomerId, System.Int64 callId, IValidator validator):base("ProspectCustomerCallEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ProspectCustomerId = prospectCustomerId;
			this.CallId = callId;
		...
		{
			switch((ProspectCustomerCallFieldIndex)fieldIndex)
			{
				case ProspectCustomerCallFieldIndex.ProspectCustomerId:
					DesetupSyncProspectCustomer(true, false);
					break;
				case ProspectCustomerCallFieldIndex.CallId:
		...
		{
			return ProspectCustomerCallEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Calls":
					toReturn.Add(ProspectCustomerCallEntity.Relations.CallsEntityUsingCallId);
					break;
				case "ProspectCustomer":
					toReturn.Add(ProspectCustomerCallEntity.Relations.ProspectCustomerEntityUsingProspectCustomerId);
					break;
		...
		public bool TestOriginalFieldValueForNull(ProspectCustomerCallFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ProspectCustomerCallFieldIndex fieldIndex)
		{
		...
		{
			return new ProspectCustomerCallRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.ProspectCustomerCallEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProspectCustomerCallEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _calls, new PropertyChangedEventHandler( OnCallsPropertyChanged ), "Calls", ProspectCustomerCallEntity.Relations.CallsEntityUsingCallId, true, signalRelatedEntity, "ProspectCustomerCall", resetFKFields, new int[] { (int)ProspectCustomerCallFieldIndex.CallId } );		
			_calls = null;
		}
		...
		private void SetupSyncCalls(IEntity2 relatedEntity)
		{
			if(_calls!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _calls, new PropertyChangedEventHandler( OnCallsPropertyChanged ), "Calls", ProspectCustomerCallEntity.Relations.CallsEntityUsingCallId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this ProspectCustomerCallEntity</param>
		...
		public  static ProspectCustomerCallRelations Relations
		{
			get	{ return new ProspectCustomerCallRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCalls
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CallsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Calls")[0], (int)Falcon.Data.EntityType.ProspectCustomerCallEntity, (int)Falcon.Data.EntityType.CallsEntity, 0, null, null, null, null, "Calls", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProspectCustomer
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProspectCustomerEntityFactory))),
					(IEntityRelation)GetRelationsForField("ProspectCustomer")[0], (int)Falcon.Data.EntityType.ProspectCustomerCallEntity, (int)Falcon.Data.EntityType.ProspectCustomerEntity, 0, null, null, null, null, "ProspectCustomer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ProspectCustomerCallEntity.CustomProperties;}
		}
		...
		{
			get { return ProspectCustomerCallEntity.FieldsCustomProperties;}
		}

		/// <summary> The ProspectCustomerId property of the Entity ProspectCustomerCall<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblProspectCustomerCall"."ProspectCustomerId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 ProspectCustomerId
		{
			get { return (System.Int64)GetValue((int)ProspectCustomerCallFieldIndex.ProspectCustomerId, true); }
			set	{ SetValue((int)ProspectCustomerCallFieldIndex.ProspectCustomerId, value); }
		}

		/// <summary> The CallId property of the Entity ProspectCustomerCall<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblProspectCustomerCall"."CallId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 CallId
		{
			get { return (System.Int64)GetValue((int)ProspectCustomerCallFieldIndex.CallId, true); }
			set	{ SetValue((int)ProspectCustomerCallFieldIndex.CallId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_calls != null)
						{
							_calls.UnsetRelatedEntity(this, "ProspectCustomerCall");
						}
					}
					else
					{
						if(_calls!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "ProspectCustomerCall");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_prospectCustomer != null)
						{
							_prospectCustomer.UnsetRelatedEntity(this, "ProspectCustomerCall");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.ProspectCustomerCallEntity; }
		}
		#endregion
