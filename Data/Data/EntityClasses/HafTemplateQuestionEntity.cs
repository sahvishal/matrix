...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'HafTemplateQuestion'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class HafTemplateQuestionEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static HafTemplateQuestionEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public HafTemplateQuestionEntity():base("HafTemplateQuestionEntity")
		{
		...
		public HafTemplateQuestionEntity(IEntityFields2 fields):base("HafTemplateQuestionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this HafTemplateQuestionEntity</param>
		public HafTemplateQuestionEntity(IValidator validator):base("HafTemplateQuestionEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="haftemplateId">PK value for HafTemplateQuestion which data should be fetched into this HafTemplateQuestion object</param>
		/// <param name="questionId">PK value for HafTemplateQuestion which data should be fetched into this HafTemplateQuestion object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HafTemplateQuestionEntity(System.Int64 haftemplateId, System.Int64 questionId):base("HafTemplateQuestionEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this HafTemplateQuestionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public HafTemplateQuestionEntity(System.Int64 haftemplateId, System.Int64 questionId, IValidator validator):base("HafTemplateQuestionEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.HaftemplateId = haftemplateId;
			this.QuestionId = questionId;
		...
		{
			switch((HafTemplateQuestionFieldIndex)fieldIndex)
			{
				case HafTemplateQuestionFieldIndex.HaftemplateId:
					DesetupSyncHafTemplate(true, false);
					break;
				case HafTemplateQuestionFieldIndex.QuestionId:
		...
		{
			return HafTemplateQuestionEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "CustomerHealthQuestions":
					toReturn.Add(HafTemplateQuestionEntity.Relations.CustomerHealthQuestionsEntityUsingQuestionId);
					break;
				case "HafTemplate":
					toReturn.Add(HafTemplateQuestionEntity.Relations.HafTemplateEntityUsingHaftemplateId);
					break;
		...
		public bool TestOriginalFieldValueForNull(HafTemplateQuestionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(HafTemplateQuestionFieldIndex fieldIndex)
		{
		...
		{
			return new HafTemplateQuestionRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.HafTemplateQuestionEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(HafTemplateQuestionEntityFactory));
		}
#if !CF
		...
		private void SetupSyncCustomerHealthQuestions(IEntity2 relatedEntity)
		{
			if(_customerHealthQuestions!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _customerHealthQuestions, new PropertyChangedEventHandler( OnCustomerHealthQuestionsPropertyChanged ), "CustomerHealthQuestions", HafTemplateQuestionEntity.Relations.CustomerHealthQuestionsEntityUsingQuestionId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this HafTemplateQuestionEntity</param>
		...
		public  static HafTemplateQuestionRelations Relations
		{
			get	{ return new HafTemplateQuestionRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomerHealthQuestions
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerHealthQuestionsEntityFactory))),
					(IEntityRelation)GetRelationsForField("CustomerHealthQuestions")[0], (int)Falcon.Data.EntityType.HafTemplateQuestionEntity, (int)Falcon.Data.EntityType.CustomerHealthQuestionsEntity, 0, null, null, null, null, "CustomerHealthQuestions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHafTemplate
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(HafTemplateEntityFactory))),
					(IEntityRelation)GetRelationsForField("HafTemplate")[0], (int)Falcon.Data.EntityType.HafTemplateQuestionEntity, (int)Falcon.Data.EntityType.HafTemplateEntity, 0, null, null, null, null, "HafTemplate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return HafTemplateQuestionEntity.CustomProperties;}
		}
		...
		{
			get { return HafTemplateQuestionEntity.FieldsCustomProperties;}
		}

		/// <summary> The HaftemplateId property of the Entity HafTemplateQuestion<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHAFTemplateQuestion"."HAFTemplateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 HaftemplateId
		{
			get { return (System.Int64)GetValue((int)HafTemplateQuestionFieldIndex.HaftemplateId, true); }
			set	{ SetValue((int)HafTemplateQuestionFieldIndex.HaftemplateId, value); }
		}

		/// <summary> The QuestionId property of the Entity HafTemplateQuestion<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblHAFTemplateQuestion"."QuestionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 QuestionId
		{
			get { return (System.Int64)GetValue((int)HafTemplateQuestionFieldIndex.QuestionId, true); }
			set	{ SetValue((int)HafTemplateQuestionFieldIndex.QuestionId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_customerHealthQuestions != null)
						{
							_customerHealthQuestions.UnsetRelatedEntity(this, "HafTemplateQuestion");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "HafTemplateQuestion");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_hafTemplate != null)
						{
							_hafTemplate.UnsetRelatedEntity(this, "HafTemplateQuestion");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.HafTemplateQuestionEntity; }
		}
		#endregion
