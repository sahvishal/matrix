...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PreQualificationTemplateQuestion'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PreQualificationTemplateQuestionEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PreQualificationTemplateQuestionEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public PreQualificationTemplateQuestionEntity():base("PreQualificationTemplateQuestionEntity")
		{
		...
		public PreQualificationTemplateQuestionEntity(IEntityFields2 fields):base("PreQualificationTemplateQuestionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PreQualificationTemplateQuestionEntity</param>
		public PreQualificationTemplateQuestionEntity(IValidator validator):base("PreQualificationTemplateQuestionEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="questionId">PK value for PreQualificationTemplateQuestion which data should be fetched into this PreQualificationTemplateQuestion object</param>
		/// <param name="templateId">PK value for PreQualificationTemplateQuestion which data should be fetched into this PreQualificationTemplateQuestion object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PreQualificationTemplateQuestionEntity(System.Int64 questionId, System.Int64 templateId):base("PreQualificationTemplateQuestionEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this PreQualificationTemplateQuestionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PreQualificationTemplateQuestionEntity(System.Int64 questionId, System.Int64 templateId, IValidator validator):base("PreQualificationTemplateQuestionEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.QuestionId = questionId;
			this.TemplateId = templateId;
		...
		protected PreQualificationTemplateQuestionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PreQualificationTemplateQuestionFieldIndex)fieldIndex)
			{
				case PreQualificationTemplateQuestionFieldIndex.QuestionId:
					DesetupSyncPreQualificationQuestion(true, false);
					break;
				case PreQualificationTemplateQuestionFieldIndex.TemplateId:
		...
		{
			return PreQualificationTemplateQuestionEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "PreQualificationQuestion":
					toReturn.Add(PreQualificationTemplateQuestionEntity.Relations.PreQualificationQuestionEntityUsingQuestionId);
					break;
				case "PreQualificationTestTemplate":
					toReturn.Add(PreQualificationTemplateQuestionEntity.Relations.PreQualificationTestTemplateEntityUsingTemplateId);
					break;
		...
		public bool TestOriginalFieldValueForNull(PreQualificationTemplateQuestionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PreQualificationTemplateQuestionFieldIndex fieldIndex)
		{
		...
		{
			return new PreQualificationTemplateQuestionRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.PreQualificationTemplateQuestionEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PreQualificationTemplateQuestionEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _preQualificationQuestion, new PropertyChangedEventHandler( OnPreQualificationQuestionPropertyChanged ), "PreQualificationQuestion", PreQualificationTemplateQuestionEntity.Relations.PreQualificationQuestionEntityUsingQuestionId, true, signalRelatedEntity, "PreQualificationTemplateQuestion", resetFKFields, new int[] { (int)PreQualificationTemplateQuestionFieldIndex.QuestionId } );		
			_preQualificationQuestion = null;
		}
		...
		private void SetupSyncPreQualificationQuestion(IEntity2 relatedEntity)
		{
			if(_preQualificationQuestion!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _preQualificationQuestion, new PropertyChangedEventHandler( OnPreQualificationQuestionPropertyChanged ), "PreQualificationQuestion", PreQualificationTemplateQuestionEntity.Relations.PreQualificationQuestionEntityUsingQuestionId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _preQualificationTestTemplate, new PropertyChangedEventHandler( OnPreQualificationTestTemplatePropertyChanged ), "PreQualificationTestTemplate", PreQualificationTemplateQuestionEntity.Relations.PreQualificationTestTemplateEntityUsingTemplateId, true, signalRelatedEntity, "PreQualificationTemplateQuestion", resetFKFields, new int[] { (int)PreQualificationTemplateQuestionFieldIndex.TemplateId } );		
			_preQualificationTestTemplate = null;
		}
		...
		private void SetupSyncPreQualificationTestTemplate(IEntity2 relatedEntity)
		{
			if(_preQualificationTestTemplate!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _preQualificationTestTemplate, new PropertyChangedEventHandler( OnPreQualificationTestTemplatePropertyChanged ), "PreQualificationTestTemplate", PreQualificationTemplateQuestionEntity.Relations.PreQualificationTestTemplateEntityUsingTemplateId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PreQualificationTemplateQuestionEntity</param>
		...
		public  static PreQualificationTemplateQuestionRelations Relations
		{
			get	{ return new PreQualificationTemplateQuestionRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPreQualificationQuestion
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PreQualificationQuestionEntityFactory))),
					(IEntityRelation)GetRelationsForField("PreQualificationQuestion")[0], (int)Falcon.Data.EntityType.PreQualificationTemplateQuestionEntity, (int)Falcon.Data.EntityType.PreQualificationQuestionEntity, 0, null, null, null, null, "PreQualificationQuestion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return PreQualificationTemplateQuestionEntity.CustomProperties;}
		}
		...
		{
			get { return PreQualificationTemplateQuestionEntity.FieldsCustomProperties;}
		}

		/// <summary> The QuestionId property of the Entity PreQualificationTemplateQuestion<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPreQualificationTemplateQuestion"."QuestionId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 QuestionId
		{
			get { return (System.Int64)GetValue((int)PreQualificationTemplateQuestionFieldIndex.QuestionId, true); }
			set	{ SetValue((int)PreQualificationTemplateQuestionFieldIndex.QuestionId, value); }
		}

		/// <summary> The TemplateId property of the Entity PreQualificationTemplateQuestion<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblPreQualificationTemplateQuestion"."TemplateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 TemplateId
		{
			get { return (System.Int64)GetValue((int)PreQualificationTemplateQuestionFieldIndex.TemplateId, true); }
			set	{ SetValue((int)PreQualificationTemplateQuestionFieldIndex.TemplateId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_preQualificationQuestion != null)
						{
							_preQualificationQuestion.UnsetRelatedEntity(this, "PreQualificationTemplateQuestion");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "PreQualificationTemplateQuestion");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_preQualificationTestTemplate != null)
						{
							_preQualificationTestTemplate.UnsetRelatedEntity(this, "PreQualificationTemplateQuestion");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.PreQualificationTemplateQuestionEntity; }
		}
		#endregion
