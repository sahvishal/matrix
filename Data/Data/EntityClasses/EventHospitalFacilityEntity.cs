...
namespace Falcon.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EventHospitalFacility'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EventHospitalFacilityEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EventHospitalFacilityEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EventHospitalFacilityEntity():base("EventHospitalFacilityEntity")
		{
		...
		public EventHospitalFacilityEntity(IEntityFields2 fields):base("EventHospitalFacilityEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EventHospitalFacilityEntity</param>
		public EventHospitalFacilityEntity(IValidator validator):base("EventHospitalFacilityEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="eventId">PK value for EventHospitalFacility which data should be fetched into this EventHospitalFacility object</param>
		/// <param name="hospitalFacilityId">PK value for EventHospitalFacility which data should be fetched into this EventHospitalFacility object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventHospitalFacilityEntity(System.Int64 eventId, System.Int64 hospitalFacilityId):base("EventHospitalFacilityEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this EventHospitalFacilityEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EventHospitalFacilityEntity(System.Int64 eventId, System.Int64 hospitalFacilityId, IValidator validator):base("EventHospitalFacilityEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.EventId = eventId;
			this.HospitalFacilityId = hospitalFacilityId;
		...
		protected EventHospitalFacilityEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EventHospitalFacilityFieldIndex)fieldIndex)
			{
				case EventHospitalFacilityFieldIndex.EventId:
					DesetupSyncEvents(true, false);
					break;
				case EventHospitalFacilityFieldIndex.HospitalFacilityId:
		...
		{
			return EventHospitalFacilityEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(EventHospitalFacilityFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EventHospitalFacilityFieldIndex fieldIndex)
		{
		...
		{
			return new EventHospitalFacilityRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Falcon.Data.EntityType.EventHospitalFacilityEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EventHospitalFacilityEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventHospitalFacilityEntity.Relations.EventsEntityUsingEventId, true, signalRelatedEntity, "EventHospitalFacility", resetFKFields, new int[] { (int)EventHospitalFacilityFieldIndex.EventId } );		
			_events = null;
		}
		...
		private void SetupSyncEvents(IEntity2 relatedEntity)
		{
			if(_events!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _events, new PropertyChangedEventHandler( OnEventsPropertyChanged ), "Events", EventHospitalFacilityEntity.Relations.EventsEntityUsingEventId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _hospitalFacility, new PropertyChangedEventHandler( OnHospitalFacilityPropertyChanged ), "HospitalFacility", EventHospitalFacilityEntity.Relations.HospitalFacilityEntityUsingHospitalFacilityId, true, signalRelatedEntity, "EventHospitalFacility", resetFKFields, new int[] { (int)EventHospitalFacilityFieldIndex.HospitalFacilityId } );		
			_hospitalFacility = null;
		}
		...
		private void SetupSyncHospitalFacility(IEntity2 relatedEntity)
		{
			if(_hospitalFacility!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _hospitalFacility, new PropertyChangedEventHandler( OnHospitalFacilityPropertyChanged ), "HospitalFacility", EventHospitalFacilityEntity.Relations.HospitalFacilityEntityUsingHospitalFacilityId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EventHospitalFacilityEntity</param>
		...
		public  static EventHospitalFacilityRelations Relations
		{
			get	{ return new EventHospitalFacilityRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEvents
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EventsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Events")[0], (int)Falcon.Data.EntityType.EventHospitalFacilityEntity, (int)Falcon.Data.EntityType.EventsEntity, 0, null, null, null, null, "Events", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathHospitalFacility
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(HospitalFacilityEntityFactory))),
					(IEntityRelation)GetRelationsForField("HospitalFacility")[0], (int)Falcon.Data.EntityType.EventHospitalFacilityEntity, (int)Falcon.Data.EntityType.HospitalFacilityEntity, 0, null, null, null, null, "HospitalFacility", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return EventHospitalFacilityEntity.CustomProperties;}
		}
		...
		{
			get { return EventHospitalFacilityEntity.FieldsCustomProperties;}
		}

		/// <summary> The EventId property of the Entity EventHospitalFacility<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventHospitalFacility"."EventId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 EventId
		{
			get { return (System.Int64)GetValue((int)EventHospitalFacilityFieldIndex.EventId, true); }
			set	{ SetValue((int)EventHospitalFacilityFieldIndex.EventId, value); }
		}

		/// <summary> The HospitalFacilityId property of the Entity EventHospitalFacility<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "TblEventHospitalFacility"."HospitalFacilityId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int64 HospitalFacilityId
		{
			get { return (System.Int64)GetValue((int)EventHospitalFacilityFieldIndex.HospitalFacilityId, true); }
			set	{ SetValue((int)EventHospitalFacilityFieldIndex.HospitalFacilityId, value); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_events != null)
						{
							_events.UnsetRelatedEntity(this, "EventHospitalFacility");
						}
					}
					else
					{
						if(_events!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "EventHospitalFacility");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_hospitalFacility != null)
						{
							_hospitalFacility.UnsetRelatedEntity(this, "EventHospitalFacility");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Falcon.Data.EntityType.EventHospitalFacilityEntity; }
		}
		#endregion
