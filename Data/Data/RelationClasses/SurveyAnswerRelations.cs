...
{
	/// <summary>Implements the static Relations variant for the entity: SurveyAnswer. </summary>
	public partial class SurveyAnswerRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between SurveyAnswerEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// SurveyAnswer.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between SurveyAnswerEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// SurveyAnswer.ModifiedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between SurveyAnswerEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// SurveyAnswer.CreatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// SurveyAnswer.QuestionId - SurveyQuestion.Id
		/// </summary>
