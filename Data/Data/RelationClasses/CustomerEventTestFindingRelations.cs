...
{
	/// <summary>Implements the static Relations variant for the entity: CustomerEventTestFinding. </summary>
	public partial class CustomerEventTestFindingRelations
	{
		/// <summary>CTor</summary>
		public CustomerEventTestFindingRelations()
		{
		}

		/// <summary>Gets all relations of the CustomerEventTestFindingEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerEventTestFindingEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerEventTestFinding.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerEventTestFindingEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between CustomerEventTestFindingEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerEventTestFinding.EventId - Events.EventId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerEventTestFindingEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerEventTestFinding.TestId - Test.TestId
		/// </summary>
