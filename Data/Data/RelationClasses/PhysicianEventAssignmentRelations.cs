...
{
	/// <summary>Implements the static Relations variant for the entity: PhysicianEventAssignment. </summary>
	public partial class PhysicianEventAssignmentRelations
	{
		/// <summary>CTor</summary>
		public PhysicianEventAssignmentRelations()
		{
		}

		/// <summary>Gets all relations of the PhysicianEventAssignmentEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PhysicianEventAssignmentEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianEventAssignment.EventId - Events.EventId
		/// </summary>
		public virtual IEntityRelation EventsEntityUsingEventId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PhysicianEventAssignmentEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PhysicianEventAssignmentEntity and PhysicianProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianEventAssignment.PhysicianId - PhysicianProfile.PhysicianId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PhysicianEventAssignmentEntity and PhysicianProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianEventAssignment.OverReadPhysicianId - PhysicianProfile.PhysicianId
		/// </summary>
