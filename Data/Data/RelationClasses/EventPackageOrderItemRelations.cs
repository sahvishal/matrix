...
{
	/// <summary>Implements the static Relations variant for the entity: EventPackageOrderItem. </summary>
	public partial class EventPackageOrderItemRelations
	{
		/// <summary>CTor</summary>
		public EventPackageOrderItemRelations()
		{
		}

		/// <summary>Gets all relations of the EventPackageOrderItemEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventPackageOrderItemEntity and EventPackageDetailsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventPackageOrderItem.EventPackageId - EventPackageDetails.EventPackageId
		/// </summary>
		public virtual IEntityRelation EventPackageDetailsEntityUsingEventPackageId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventPackageOrderItemEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventPackageOrderItemEntity and OrderItemEntity over the m:1 relation they have, using the relation between the fields:
		/// EventPackageOrderItem.OrderItemId - OrderItem.OrderItemId
		/// </summary>
