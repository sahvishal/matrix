...
{
	/// <summary>Implements the static Relations variant for the entity: PackageTest. </summary>
	public partial class PackageTestRelations
	{
		/// <summary>CTor</summary>
		public PackageTestRelations()
		{
		}

		/// <summary>Gets all relations of the PackageTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PackageTestEntity and PackageEntity over the m:1 relation they have, using the relation between the fields:
		/// PackageTest.PackageId - Package.PackageId
		/// </summary>
		public virtual IEntityRelation PackageEntityUsingPackageId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PackageTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PackageTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// PackageTest.TestId - Test.TestId
		/// </summary>
