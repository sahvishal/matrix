...
{
	/// <summary>Implements the static Relations variant for the entity: HospitalPartnerCustomer. </summary>
	public partial class HospitalPartnerCustomerRelations
	{
		/// <summary>CTor</summary>
		public HospitalPartnerCustomerRelations()
		{
		}

		/// <summary>Gets all relations of the HospitalPartnerCustomerEntity as a list of IEntityRelation objects.</summary>
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.OrganizationRoleUserEntityUsingCareCoordinatorOrgRoleUserId);
			return toReturn;
		}
		...
		/// <summary>Returns a new IEntityRelation object, between HospitalPartnerCustomerEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// HospitalPartnerCustomer.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("HospitalPartnerCustomerEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between HospitalPartnerCustomerEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// HospitalPartnerCustomer.EventId - Events.EventId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between HospitalPartnerCustomerEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// HospitalPartnerCustomer.ModifiedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between HospitalPartnerCustomerEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// HospitalPartnerCustomer.CreatedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between HospitalPartnerCustomerEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// HospitalPartnerCustomer.CareCoordinatorOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		public virtual IEntityRelation OrganizationRoleUserEntityUsingCareCoordinatorOrgRoleUserId
		{
			get
			{
