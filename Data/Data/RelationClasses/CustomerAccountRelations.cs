...
{
	/// <summary>Implements the static Relations variant for the entity: CustomerAccount. </summary>
	public partial class CustomerAccountRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerAccountEntity and CustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerAccount.CustomerId - Customers.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomersEntityUsingCustomerId
		{
			get
			{
				...
				relation.AddEntityFieldPair(CustomersFields.CustomerId, CustomerAccountFields.CustomerId);
