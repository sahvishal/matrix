...
{
	/// <summary>Implements the static Relations variant for the entity: Widget. </summary>
	public partial class WidgetRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between WidgetEntity and AfmarketingMaterialEntity over the m:1 relation they have, using the relation between the fields:
		/// Widget.MarketingMaterialId - AfmarketingMaterial.MarketingMaterialId
		/// </summary>
