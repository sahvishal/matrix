...
{
	/// <summary>Implements the static Relations variant for the entity: RequiredTest. </summary>
	public partial class RequiredTestRelations
	{
		/// <summary>CTor</summary>
		public RequiredTestRelations()
		{
		}

		/// <summary>Gets all relations of the RequiredTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between RequiredTestEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// RequiredTest.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("RequiredTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between RequiredTestEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// RequiredTest.CreatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between RequiredTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// RequiredTest.TestId - Test.TestId
		/// </summary>
