...
{
	/// <summary>Implements the static Relations variant for the entity: EventAffiliateDetails. </summary>
	public partial class EventAffiliateDetailsRelations
	{
		/// <summary>CTor</summary>
		public EventAffiliateDetailsRelations()
		{
		}

		/// <summary>Gets all relations of the EventAffiliateDetailsEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventAffiliateDetailsEntity and AffiliateProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// EventAffiliateDetails.AffiliateId - AffiliateProfile.AffiliateId
		/// </summary>
		public virtual IEntityRelation AffiliateProfileEntityUsingAffiliateId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventAffiliateDetailsEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventAffiliateDetailsEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventAffiliateDetails.EventId - Events.EventId
		/// </summary>
