...
{
	/// <summary>Implements the static Relations variant for the entity: EventFluConsentTemplate. </summary>
	public partial class EventFluConsentTemplateRelations
	{
		/// <summary>CTor</summary>
		public EventFluConsentTemplateRelations()
		{
		}

		/// <summary>Gets all relations of the EventFluConsentTemplateEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventFluConsentTemplateEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventFluConsentTemplate.EventId - Events.EventId
		/// </summary>
		public virtual IEntityRelation EventsEntityUsingEventId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventFluConsentTemplateEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventFluConsentTemplateEntity and FluConsentTemplateEntity over the m:1 relation they have, using the relation between the fields:
		/// EventFluConsentTemplate.TemplateId - FluConsentTemplate.Id
		/// </summary>
