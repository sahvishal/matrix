...
{
	/// <summary>Implements the static Relations variant for the entity: EventCustomerOrderDetail. </summary>
	public partial class EventCustomerOrderDetailRelations
	{
		/// <summary>CTor</summary>
		public EventCustomerOrderDetailRelations()
		{
		}

		/// <summary>Gets all relations of the EventCustomerOrderDetailEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerOrderDetailEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerOrderDetail.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		public virtual IEntityRelation EventCustomersEntityUsingEventCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventCustomerOrderDetailEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventCustomerOrderDetailEntity and OrderDetailEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerOrderDetail.OrderDetailId - OrderDetail.OrderDetailId
		/// </summary>
