...
{
	/// <summary>Implements the static Relations variant for the entity: EventCoupons. </summary>
	public partial class EventCouponsRelations
	{
		/// <summary>CTor</summary>
		public EventCouponsRelations()
		{
		}

		/// <summary>Gets all relations of the EventCouponsEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCouponsEntity and CouponsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCoupons.CouponId - Coupons.CouponId
		/// </summary>
		public virtual IEntityRelation CouponsEntityUsingCouponId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventCouponsEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventCouponsEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCoupons.EventId - Events.EventId
		/// </summary>
