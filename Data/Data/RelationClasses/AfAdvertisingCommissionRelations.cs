...
{
	/// <summary>Implements the static Relations variant for the entity: AfAdvertisingCommission. </summary>
	public partial class AfAdvertisingCommissionRelations
	{
		/// <summary>CTor</summary>
		public AfAdvertisingCommissionRelations()
		{
		}

		/// <summary>Gets all relations of the AfAdvertisingCommissionEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between AfAdvertisingCommissionEntity and AfcampaignEntity over the m:1 relation they have, using the relation between the fields:
		/// AfAdvertisingCommission.CampaignId - Afcampaign.CampaignId
		/// </summary>
		public virtual IEntityRelation AfcampaignEntityUsingCampaignId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AfAdvertisingCommissionEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between AfAdvertisingCommissionEntity and AfmarketingMaterialEntity over the m:1 relation they have, using the relation between the fields:
		/// AfAdvertisingCommission.MarketingMaterialId - AfmarketingMaterial.MarketingMaterialId
		/// </summary>
