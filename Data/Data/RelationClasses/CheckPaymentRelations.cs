...
{
	/// <summary>Implements the static Relations variant for the entity: CheckPayment. </summary>
	public partial class CheckPaymentRelations
	{
		/// <summary>CTor</summary>
		public CheckPaymentRelations()
		{
		}

		/// <summary>Gets all relations of the CheckPaymentEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CheckPaymentEntity and CheckEntity over the m:1 relation they have, using the relation between the fields:
		/// CheckPayment.CheckId - Check.CheckId
		/// </summary>
		public virtual IEntityRelation CheckEntityUsingCheckId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CheckPaymentEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between CheckPaymentEntity and PaymentEntity over the m:1 relation they have, using the relation between the fields:
		/// CheckPayment.PaymentId - Payment.PaymentId
		/// </summary>
