...
{
	/// <summary>Implements the static Relations variant for the entity: PhysicianPermittedTest. </summary>
	public partial class PhysicianPermittedTestRelations
	{
		/// <summary>CTor</summary>
		public PhysicianPermittedTestRelations()
		{
		}

		/// <summary>Gets all relations of the PhysicianPermittedTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PhysicianPermittedTestEntity and PhysicianProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianPermittedTest.OrganizationRoleUserId - PhysicianProfile.PhysicianId
		/// </summary>
		public virtual IEntityRelation PhysicianProfileEntityUsingOrganizationRoleUserId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PhysicianPermittedTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PhysicianPermittedTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianPermittedTest.TestId - Test.TestId
		/// </summary>
