...
{
	/// <summary>Implements the static Relations variant for the entity: CustomerHealthInfoArchive. </summary>
	public partial class CustomerHealthInfoArchiveRelations
	{
		/// <summary>CTor</summary>
		public CustomerHealthInfoArchiveRelations()
		{
		}

		/// <summary>Gets all relations of the CustomerHealthInfoArchiveEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerHealthInfoArchiveEntity and CustomerHealthQuestionsEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerHealthInfoArchive.CustomerHealthQuestionId - CustomerHealthQuestions.CustomerHealthQuestionId
		/// </summary>
		public virtual IEntityRelation CustomerHealthQuestionsEntityUsingCustomerHealthQuestionId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerHealthInfoArchiveEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between CustomerHealthInfoArchiveEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerHealthInfoArchive.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerHealthInfoArchiveEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerHealthInfoArchive.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerHealthInfoArchiveEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerHealthInfoArchive.CreatedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
