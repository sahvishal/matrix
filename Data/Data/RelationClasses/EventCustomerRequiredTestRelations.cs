...
{
	/// <summary>Implements the static Relations variant for the entity: EventCustomerRequiredTest. </summary>
	public partial class EventCustomerRequiredTestRelations
	{
		/// <summary>CTor</summary>
		public EventCustomerRequiredTestRelations()
		{
		}

		/// <summary>Gets all relations of the EventCustomerRequiredTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerRequiredTestEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerRequiredTest.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		public virtual IEntityRelation EventCustomersEntityUsingEventCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventCustomerRequiredTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventCustomerRequiredTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerRequiredTest.TestId - Test.TestId
		/// </summary>
