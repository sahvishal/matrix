...
{
	/// <summary>Implements the static Relations variant for the entity: PhysicianLabTest. </summary>
	public partial class PhysicianLabTestRelations
	{
		/// <summary>CTor</summary>
		public PhysicianLabTestRelations()
		{
		}

		/// <summary>Gets all relations of the PhysicianLabTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PhysicianLabTestEntity and PhysicianProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianLabTest.PhysicianId - PhysicianProfile.PhysicianId
		/// </summary>
		public virtual IEntityRelation PhysicianProfileEntityUsingPhysicianId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PhysicianLabTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PhysicianLabTestEntity and StateEntity over the m:1 relation they have, using the relation between the fields:
		/// PhysicianLabTest.StateId - State.StateId
		/// </summary>
