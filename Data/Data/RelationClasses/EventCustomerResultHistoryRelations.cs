...
{
	/// <summary>Implements the static Relations variant for the entity: EventCustomerResultHistory. </summary>
	public partial class EventCustomerResultHistoryRelations
	{
		/// <summary>CTor</summary>
		public EventCustomerResultHistoryRelations()
		{
		}

		/// <summary>Gets all relations of the EventCustomerResultHistoryEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerResultHistoryEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerResultHistory.InvoiceDateUpdatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		public virtual IEntityRelation OrganizationRoleUserEntityUsingInvoiceDateUpdatedBy
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventCustomerResultHistoryEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventCustomerResultHistoryEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerResultHistory.ChatPdfReviewedByPhysicianId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerResultHistoryEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerResultHistory.ChatPdfReviewedByOverreadPhysicianId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
