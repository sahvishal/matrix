...
{
	/// <summary>Implements the static Relations variant for the entity: CallCenterAgentTeamLog. </summary>
	public partial class CallCenterAgentTeamLogRelations
	{
		/// <summary>CTor</summary>
		public CallCenterAgentTeamLogRelations()
		{
		}

		/// <summary>Gets all relations of the CallCenterAgentTeamLogEntity as a list of IEntityRelation objects.</summary>
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.OrganizationRoleUserEntityUsingRemovedByOrgRoleUserId);
		...
		/// <summary>Returns a new IEntityRelation object, between CallCenterAgentTeamLogEntity and CallCenterTeamEntity over the m:1 relation they have, using the relation between the fields:
		/// CallCenterAgentTeamLog.TeamId - CallCenterTeam.Id
		/// </summary>
		public virtual IEntityRelation CallCenterTeamEntityUsingTeamId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CallCenterAgentTeamLogEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between CallCenterAgentTeamLogEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CallCenterAgentTeamLog.RemovedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		public virtual IEntityRelation OrganizationRoleUserEntityUsingRemovedByOrgRoleUserId
		{
			get
			{
		...
		/// <summary>Returns a new IEntityRelation object, between CallCenterAgentTeamLogEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CallCenterAgentTeamLog.AssignedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CallCenterAgentTeamLogEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CallCenterAgentTeamLog.AgentId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
