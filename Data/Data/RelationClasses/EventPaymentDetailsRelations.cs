...
{
	/// <summary>Implements the static Relations variant for the entity: EventPaymentDetails. </summary>
	public partial class EventPaymentDetailsRelations
	{
		/// <summary>CTor</summary>
		public EventPaymentDetailsRelations()
		{
		}

		/// <summary>Gets all relations of the EventPaymentDetailsEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventPaymentDetailsEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// EventPaymentDetails.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventPaymentDetailsEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventPaymentDetailsEntity and EventPackageDetailsEntity over the m:1 relation they have, using the relation between the fields:
		/// EventPaymentDetails.EventPackageId - EventPackageDetails.EventPackageId
		/// </summary>
