...
{
	/// <summary>Implements the static Relations variant for the entity: AccountTest. </summary>
	public partial class AccountTestRelations
	{
		/// <summary>CTor</summary>
		public AccountTestRelations()
		{
		}

		/// <summary>Gets all relations of the AccountTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between AccountTestEntity and AccountEntity over the m:1 relation they have, using the relation between the fields:
		...
		public virtual IEntityRelation AccountEntityUsingAccountId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AccountTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between AccountTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// AccountTest.TestId - Test.TestId
		/// </summary>
