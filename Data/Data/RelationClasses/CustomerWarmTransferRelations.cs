...
{
	/// <summary>Implements the static Relations variant for the entity: CustomerWarmTransfer. </summary>
	public partial class CustomerWarmTransferRelations
	{
		/// <summary>CTor</summary>
		public CustomerWarmTransferRelations()
		{
		}

		/// <summary>Gets all relations of the CustomerWarmTransferEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerWarmTransferEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerWarmTransfer.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerWarmTransferEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between CustomerWarmTransferEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerWarmTransfer.ModifiedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerWarmTransferEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerWarmTransfer.CreatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
