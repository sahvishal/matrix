...
{
	/// <summary>Implements the static Relations variant for the entity: TestIncidentalFinding. </summary>
	public partial class TestIncidentalFindingRelations
	{
		/// <summary>CTor</summary>
		public TestIncidentalFindingRelations()
		{
		}

		/// <summary>Gets all relations of the TestIncidentalFindingEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between TestIncidentalFindingEntity and IncidentalFindingsEntity over the m:1 relation they have, using the relation between the fields:
		/// TestIncidentalFinding.IncidentalFindingId - IncidentalFindings.IncidentalFindingsId
		/// </summary>
		public virtual IEntityRelation IncidentalFindingsEntityUsingIncidentalFindingId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("TestIncidentalFindingEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between TestIncidentalFindingEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// TestIncidentalFinding.TestId - Test.TestId
		/// </summary>
