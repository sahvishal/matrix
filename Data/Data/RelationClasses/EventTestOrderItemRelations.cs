...
{
	/// <summary>Implements the static Relations variant for the entity: EventTestOrderItem. </summary>
	public partial class EventTestOrderItemRelations
	{
		/// <summary>CTor</summary>
		public EventTestOrderItemRelations()
		{
		}

		/// <summary>Gets all relations of the EventTestOrderItemEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventTestOrderItemEntity and EventTestEntity over the m:1 relation they have, using the relation between the fields:
		/// EventTestOrderItem.EventTestId - EventTest.EventTestId
		/// </summary>
		public virtual IEntityRelation EventTestEntityUsingEventTestId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventTestOrderItemEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventTestOrderItemEntity and OrderItemEntity over the m:1 relation they have, using the relation between the fields:
		/// EventTestOrderItem.OrderItemId - OrderItem.OrderItemId
		/// </summary>
