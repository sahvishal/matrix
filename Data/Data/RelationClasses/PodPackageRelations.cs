...
{
	/// <summary>Implements the static Relations variant for the entity: PodPackage. </summary>
	public partial class PodPackageRelations
	{
		/// <summary>CTor</summary>
		public PodPackageRelations()
		{
		}

		/// <summary>Gets all relations of the PodPackageEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PodPackageEntity and PackageEntity over the m:1 relation they have, using the relation between the fields:
		/// PodPackage.PackageId - Package.PackageId
		/// </summary>
		public virtual IEntityRelation PackageEntityUsingPackageId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PodPackageEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PodPackageEntity and PodDetailsEntity over the m:1 relation they have, using the relation between the fields:
		/// PodPackage.PodId - PodDetails.PodId
		/// </summary>
