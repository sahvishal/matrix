...
{
	/// <summary>Implements the static Relations variant for the entity: PriorityInQueue. </summary>
	public partial class PriorityInQueueRelations
	{
		/// <summary>CTor</summary>
		public PriorityInQueueRelations()
		{
		}

		/// <summary>Gets all relations of the PriorityInQueueEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PriorityInQueueEntity and EventCustomerResultEntity over the m:1 relation they have, using the relation between the fields:
		/// PriorityInQueue.EventCustomerResultId - EventCustomerResult.EventCustomerResultId
		/// </summary>
		public virtual IEntityRelation EventCustomerResultEntityUsingEventCustomerResultId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PriorityInQueueEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between PriorityInQueueEntity and NotesDetailsEntity over the m:1 relation they have, using the relation between the fields:
		/// PriorityInQueue.NoteId - NotesDetails.NoteId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PriorityInQueueEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// PriorityInQueue.CreatedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between PriorityInQueueEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// PriorityInQueue.ModifiedByOrgRoleUserId - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
