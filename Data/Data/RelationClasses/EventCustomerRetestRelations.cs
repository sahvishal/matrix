...
{
	/// <summary>Implements the static Relations variant for the entity: EventCustomerRetest. </summary>
	public partial class EventCustomerRetestRelations
	{
		/// <summary>CTor</summary>
		public EventCustomerRetestRelations()
		{
		}

		/// <summary>Gets all relations of the EventCustomerRetestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerRetestEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerRetest.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		public virtual IEntityRelation EventCustomersEntityUsingEventCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EventCustomerRetestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between EventCustomerRetestEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerRetest.CreatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EventCustomerRetestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// EventCustomerRetest.TestId - Test.TestId
		/// </summary>
