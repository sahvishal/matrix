...
{
	/// <summary>Implements the static Relations variant for the entity: GiftCertificatePayment. </summary>
	public partial class GiftCertificatePaymentRelations
	{
		/// <summary>CTor</summary>
		public GiftCertificatePaymentRelations()
		{
		}

		/// <summary>Gets all relations of the GiftCertificatePaymentEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between GiftCertificatePaymentEntity and GiftCertificateEntity over the m:1 relation they have, using the relation between the fields:
		/// GiftCertificatePayment.GiftCertificateId - GiftCertificate.GiftCertificateId
		/// </summary>
		public virtual IEntityRelation GiftCertificateEntityUsingGiftCertificateId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("GiftCertificatePaymentEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between GiftCertificatePaymentEntity and PaymentEntity over the m:1 relation they have, using the relation between the fields:
		/// GiftCertificatePayment.PaymentId - Payment.PaymentId
		/// </summary>
