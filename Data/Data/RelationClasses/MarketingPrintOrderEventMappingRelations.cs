...
{
	/// <summary>Implements the static Relations variant for the entity: MarketingPrintOrderEventMapping. </summary>
	public partial class MarketingPrintOrderEventMappingRelations
	{
		/// <summary>CTor</summary>
		public MarketingPrintOrderEventMappingRelations()
		{
		}

		/// <summary>Gets all relations of the MarketingPrintOrderEventMappingEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between MarketingPrintOrderEventMappingEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// MarketingPrintOrderEventMapping.EventId - Events.EventId
		/// </summary>
		public virtual IEntityRelation EventsEntityUsingEventId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MarketingPrintOrderEventMappingEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between MarketingPrintOrderEventMappingEntity and MarketingPrintOrderEntity over the m:1 relation they have, using the relation between the fields:
		/// MarketingPrintOrderEventMapping.MarketingPrintOrderId - MarketingPrintOrder.MarketingPrintOrderId
		/// </summary>
