...
{
	/// <summary>Implements the static Relations variant for the entity: ParticipationConsentSignature. </summary>
	public partial class ParticipationConsentSignatureRelations
	{
		/// <summary>CTor</summary>
		public ParticipationConsentSignatureRelations()
		{
		}

		/// <summary>Gets all relations of the ParticipationConsentSignatureEntity as a list of IEntityRelation objects.</summary>
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.FileEntityUsingInsuranceSignatureFileId);
		...
		/// <summary>Returns a new IEntityRelation object, between ParticipationConsentSignatureEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// ParticipationConsentSignature.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		public virtual IEntityRelation EventCustomersEntityUsingEventCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ParticipationConsentSignatureEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between ParticipationConsentSignatureEntity and FileEntity over the m:1 relation they have, using the relation between the fields:
		/// ParticipationConsentSignature.SignatureFileId - File.FileId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between ParticipationConsentSignatureEntity and FileEntity over the m:1 relation they have, using the relation between the fields:
		/// ParticipationConsentSignature.InsuranceSignatureFileId - File.FileId
		/// </summary>
		public virtual IEntityRelation FileEntityUsingInsuranceSignatureFileId
		{
			get
			{
		...
		/// <summary>Returns a new IEntityRelation object, between ParticipationConsentSignatureEntity and OrganizationRoleUserEntity over the m:1 relation they have, using the relation between the fields:
		/// ParticipationConsentSignature.CreatedBy - OrganizationRoleUser.OrganizationRoleUserId
		/// </summary>
