...
{
	/// <summary>Implements the static Relations variant for the entity: DependentDisqualifiedTest. </summary>
	public partial class DependentDisqualifiedTestRelations
	{
		/// <summary>CTor</summary>
		public DependentDisqualifiedTestRelations()
		{
		}

		/// <summary>Gets all relations of the DependentDisqualifiedTestEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between DependentDisqualifiedTestEntity and CustomerProfileEntity over the m:1 relation they have, using the relation between the fields:
		/// DependentDisqualifiedTest.CustomerId - CustomerProfile.CustomerId
		/// </summary>
		public virtual IEntityRelation CustomerProfileEntityUsingCustomerId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("DependentDisqualifiedTestEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between DependentDisqualifiedTestEntity and EventCustomersEntity over the m:1 relation they have, using the relation between the fields:
		/// DependentDisqualifiedTest.EventCustomerId - EventCustomers.EventCustomerId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between DependentDisqualifiedTestEntity and EventsEntity over the m:1 relation they have, using the relation between the fields:
		/// DependentDisqualifiedTest.EventId - Events.EventId
		/// </summary>
		...
		/// <summary>Returns a new IEntityRelation object, between DependentDisqualifiedTestEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
		/// DependentDisqualifiedTest.TestId - Test.TestId
		/// </summary>
