...
namespace Falcon.Data.RelationClasses
{
	...
	public partial class OrderRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.PaymentOrderEntityUsingOrderId);
			toReturn.Add(this.RefundRequestEntityUsingOrderId);
		...
		/// <summary>Returns a new IEntityRelation object, between OrderEntity and PaymentOrderEntity over the 1:n relation they have, using the relation between the fields:
		/// Order.OrderId - PaymentOrder.OrderId
		/// </summary>
		public virtual IEntityRelation PaymentOrderEntityUsingOrderId
		{
			get
			{
		...
		/// <summary>Returns a new IEntityRelation object, between OrderEntity and RefundRequestEntity over the 1:n relation they have, using the relation between the fields:
		/// Order.OrderId - RefundRequest.OrderId
		/// </summary>
		public virtual IEntityRelation RefundRequestEntityUsingOrderId
		{
			get
			{
