...
{
    public class AaaTestResultSynchronizationService : TestResultSynchronizationService
    {
        public AaaTestResultSynchronizationService(ReadingSource newReadingSource)
        {
        ...
        {
            var newAaaTestResult = (AAATestResult)newTestResult;
            ...
            var currentAaaTestResult = (AAATestResult)currentTestResult;
            ...
            if (NewReadingSource == ReadingSource.Automatic) // Syncing those which didn't come through Uploaded file
            {
                ...
                newAaaTestResult = (AAATestResult)SyncronizeTestResultForAutomaticUploadwithManual(currentAaaTestResult, newAaaTestResult);
            }
        ...
        {
            var aaaTestResult = newTestResult as AAATestResult;
