...
{
    [DefaultImplementation(Interface = typeof(IValidator<PhysicianQueueListModelFilter>))]
    public class PhysicianQueueListModelFilterValidator : AbstractValidator<PhysicianQueueListModelFilter>
    {
        public PhysicianQueueListModelFilterValidator()
        {
