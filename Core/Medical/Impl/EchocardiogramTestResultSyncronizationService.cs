...
{
    public class EchocardiogramTestResultSyncronizationService : TestResultSynchronizationService
    {
        public EchocardiogramTestResultSyncronizationService(ReadingSource readingSource)
        {
        ...
        {
            var newEchoTestResult = (EchocardiogramTestResult)newTestResult;
            ...
            {
                newEchoTestResult = (EchocardiogramTestResult)SyncronizeTestResultForAutomaticUploadwithManual(currentTestResult, newEchoTestResult);
            }
        ...
        {
            var echoTestResult = newTestResult as EchocardiogramTestResult;
