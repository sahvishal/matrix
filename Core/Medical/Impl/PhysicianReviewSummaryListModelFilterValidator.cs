...
{
    [DefaultImplementation(Interface = typeof(IValidator<PhysicianReviewSummaryListModelFilter>))]
    public class PhysicianReviewSummaryListModelFilterValidator : AbstractValidator<PhysicianReviewSummaryListModelFilter>
    {
        public PhysicianReviewSummaryListModelFilterValidator()
        {
