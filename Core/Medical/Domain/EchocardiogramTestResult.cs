...
{
    public class EchocardiogramTestResult : MediaTestResult
    {
        ...
        public List<StandardFinding<int>> DistolicDysfunctionFinding { get; set; }
        ...
        public EchocardiogramTestResult()
            : this(0)
        { }

        public EchocardiogramTestResult(long id)
            : base(id)
        {
            this.TestType = TestType.Echocardiogram;
        }
    }
