...
{
    public class PpEchocardiogramTestResult : MediaTestResult
    {
        ...
        public PpEchocardiogramTestResult()
            : this(0)
        { }

        public PpEchocardiogramTestResult(long id)
            : base(id)
        {
            this.TestType = TestType.PPEcho;
        }
    }
}
