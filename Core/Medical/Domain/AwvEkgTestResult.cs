...
{
    public class AwvEkgTestResult : TestResult
    {
        ...
        public ResultReading<bool> ShortPrInterval { get; set; }

        public ResultMedia ResultImage { get; set; }

        public StandardFinding<int?> Finding { get; set; }

        public AwvEkgTestResult()
            : this(0)
        { }

        public AwvEkgTestResult(long id)
            : base(id)
        {
            this.TestType = TestType.AwvEkg;
        }
    }
}
