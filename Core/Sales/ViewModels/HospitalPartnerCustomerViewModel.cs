...
{
    public class HospitalPartnerCustomerViewModel : ViewModelBase
    {
        ...
        public string HospitalPartnerName { get; set; }

        [DisplayName("Hospital Facility")]
        public string HospitalFacility { get; set; }

        [Format("MM/dd/yyyy")]
        public DateTime? InitialCallDate { get; set; }

        public IEnumerable<HospitalPartnerCustomerActivityViewModel> Activities { get; set; }

        public string PostScreeningFollowUpNotes { get; set; } // Beryl Output for Care Coordinator
