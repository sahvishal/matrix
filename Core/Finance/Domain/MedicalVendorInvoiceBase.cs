...
{
    public abstract class MedicalVendorInvoiceBase : DomainObjectBase
    {
        ...
        protected MedicalVendorInvoiceBase()
        {}

        protected MedicalVendorInvoiceBase(long medicalVendorInvoiceId)
