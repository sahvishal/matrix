...
CASE WHEN (Z.TimeZone='10' AND Z.DayLightSaving='N') THEN 'GMT -10:00  U.S. Hawaiian Time'  
     ...
     WHEN (Z.TimeZone='5' AND Z.DayLightSaving='N')  THEN 'GMT -05:00  U.S. Eastern Time'  
     WHEN (Z.TimeZone='5' AND Z.DayLightSaving='Y')  THEN 'GMT -05:00  U.S. Eastern Time (Indiana)'  
	 ELSE '-N\A-'
	 END 
FROM TblEvents E
