...
in (select EmailTemplateId from TblEmailTemplate where EmailTitle = 'PurchaseShippingNotification' )

--select MacroId from #MacroId

delete from TblEmailTemplateMacro where EmailTemplateId in (select EmailTemplateId from TblEmailTemplate where EmailTitle = 'PurchaseShippingNotification')
...
where EmailTitle = 'PurchaseShippingNotification' 
