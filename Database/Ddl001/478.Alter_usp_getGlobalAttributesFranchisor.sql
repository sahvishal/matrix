...
BEGIN           
 ...
 BEGIN          
  ...
  ,  EnablePhysicianPartnerCustomerResultFaxNotification=(select value from TblGlobalConfiguration where name='EnablePhysicianPartnerCustomerResultFaxNotification')  
  ,  EnableAWVCustomerResultFaxNotification=(select value from TblGlobalConfiguration where name='EnableAWVCustomerResultFaxNotification')  
  ,  AskPreQualificationQuestion=(select value from TblGlobalConfiguration where name='AskPreQualificationQuestion') 
  ,  PasswordExpirationDays=(select value from TblGlobalConfiguration where name='PasswordExpirationDays') 
  ,  PreviousPasswordNonRepetitionCount=(select value from TblGlobalConfiguration where name='PreviousPasswordNonRepetitionCount') 
  ,  OtpNotificationMediumEmail=(select value from TblGlobalConfiguration where name='OtpNotificationMediumEmail') 
  ,  OtpNotificationMediumSms=(select value from TblGlobalConfiguration where name='OtpNotificationMediumSms') 
  ,  OtpExpirationMinutes=(select value from TblGlobalConfiguration where name='OtpExpirationMinutes') 
  ,  OtpMisMatchAttemptCount=(select value from TblGlobalConfiguration where name='OtpMisMatchAttemptCount') 
  ,	 OtpByGoogleAuthenticator=(select value from TblGlobalConfiguration where name='OtpByGoogleAuthenticator') 
  ,  AllowSafeComputerRemember=(select value from TblGlobalConfiguration where name='AllowSafeComputerRemember')
  ,  SafeDeviceExpiryDays=(select value from TblGlobalConfiguration where name='SafeDeviceExpiryDays')  
  ,  AlertBeforePasswordExpirationInDays=(select value from TblGlobalConfiguration where name='AlertBeforePasswordExpirationInDays')  
  , EnableVoiceMailNotification = (select value from TblGlobalConfiguration where Name ='EnableVoiceMailNotification')
