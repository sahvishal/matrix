...
BEGIN
	...
	select @RefundPrice = RefundPrice, @HafTemplateId = HAFTemplateId from TblTest where TestId = @TestId
	-- Update Record
    ...
    ELSE
    BEGIN
		INSERT INTO TblEventTest (EventID, TestId,Price,RefundPrice, ScreeningTime, DateCreated ,DateModified, ShowInAlaCarte, HAFTemplateId)
		VALUES(@EventID,@TestId,@TestPrice,@RefundPrice, @ScreeningTime, GETDATE(),GETDATE(), @ShowInAlaCarte, @HafTemplateId)
