...
( 
	...
	(
		...
		--and EventCustomerResultId not in
		--(
		--	select EventCustomerResultId from TblCustomerEventScreeningTests where TestId not in (23, 25)
		--)
		and IsNull(DateModified,DateCreated) >= '01/27/2013'
	)
