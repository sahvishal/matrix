...
/****** Object:  View [dbo].[vw_CustomerAggregateResultSummary]    Script Date: 04/25/2012 14:47:40 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_CustomerAggregateResultSummary]'))
DROP VIEW [dbo].[vw_CustomerAggregateResultSummary]
GO
...
Create View [dbo].[vw_CustomerAggregateResultSummary]
AS
...
(
	...
	where TECOD.IsActive=1 and TSDOD.IsActive=1 and ShippingOptionId=1
