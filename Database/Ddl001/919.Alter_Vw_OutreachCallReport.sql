...
SELECT
		...
		A.Tag,
		CQC.CallQueueId,
		ISNULL(C.IsContacted,1) AS IsContacted
		...
		Where A.IsHealthPlan = 1 and (c.OutBound is not null and c.OutBound = 1) and (c.[Status] != 35 and c.[Status] <> 325)
		AND (c.Disposition != 'DeclinedMobileAndTransferredToHome' AND c.Disposition != 'DeclinedMobileAndHomeVisit') --and cq.IsActive = 1
