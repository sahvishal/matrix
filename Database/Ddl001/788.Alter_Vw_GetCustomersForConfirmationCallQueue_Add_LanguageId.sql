...
/****** Object:  View [dbo].[Vw_GetCustomersForConfirmationCallQueue]    Script Date: 3/6/2018 8:53:26 AM ******/
SET ANSI_NULLS ON
GO
  ...
  ,cqc.LanguageId
   ...
   from TblCallQueueCustomer cqc WITH(NOLOCK)
		...
		( 
			...
			--or
			--(
			--	cqc.ContactedDate >= CONVERT(date,GETDATE()) and cqc.CallStatus not in (325, 32, 33, 242, 34) 
			--)
			or 
			(	
