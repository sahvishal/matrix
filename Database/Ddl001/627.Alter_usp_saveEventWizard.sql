...
BEGIN TRAN
	...
	BEGIN
		...
		RecommendPackage, AskPreQualifierQuestion, FixedGroupScreeningTime,EventCancellationReasonId,EnableForCallCenter,EnableForTechnician,IsPackageTimeOnly)
		...
		@RecommendPackage, @AskPreQualificationQuestion, @FixedGroupScreeningTime,@EventCancellationReasonId,@EnableForCallCenter,@EnableForTechnician,@IsPackageTimeOnly)
