USE [$(dbName)]
GO
/****** Object:  StoredProcedure [dbo].[usp_saveEventWizard]    Script Date: 10/17/2014 20:26:57 ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRAN
	...
	BEGIN
		...
		RecommendPackage, AskPreQualifierQuestion, FixedGroupScreeningTime,EventCancellationReasonId,EnableForCallCenter,EnableForTechnician)
		...
		@RecommendPackage, @AskPreQualificationQuestion, @FixedGroupScreeningTime,@EventCancellationReasonId,@EnableForCallCenter,@EnableForTechnician)
