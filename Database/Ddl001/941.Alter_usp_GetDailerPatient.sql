...
/****** Object:  StoredProcedure [dbo].[usp_GetDailerPatientList]    Script Date: 8/27/2018 11:59:55 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_GetDailerPatientList] 
					...
					(
						...
						(
							...
							(
								...
								AND (CQC.Disposition = 'NotInterested' OR CQC.Disposition = 'DeclinedMobileAndHomeVisit' OR CQC.Disposition = 'RecentlySawDoc' OR CQC.Disposition = 'TransportationIssue')
							)
