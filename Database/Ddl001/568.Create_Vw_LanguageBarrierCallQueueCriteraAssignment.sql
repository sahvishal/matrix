...
IF OBJECT_ID ('Vw_LanguageBarrierCallQueueCriteraAssignment', 'view') IS NOT NULL  
	DROP VIEW Vw_LanguageBarrierCallQueueCriteraAssignment ;  
GO 

CREATE VIEW [dbo].[Vw_LanguageBarrierCallQueueCriteraAssignment]
As
