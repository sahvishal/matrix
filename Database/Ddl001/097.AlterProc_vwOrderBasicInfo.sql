...
SELECT EventCustomerDetail.EventCustomerID
		...
		--,ISNULL(vwcts.CustomerEventTestID,0)CustomerEventTestID
		,ISNULL(TblEventCustomerResult.EventCustomerResultId,0)CustomerEventTestID
		--,ISNULL(vwcts.IsResultPDFGenerated, 0) AS IsResultPDFGenerated
		,ISNULL(TblEventCustomerResult.IsResultPDFGenerated, 0) AS IsResultPDFGenerated
		--,ISNULL(vwcts.IsPDFGenerated, 0) AS IsPDFGenerated
...
(
		...
		ISNULL( [GCPayment],0) NewGCPayment, [vw_EventCustomerRevenue].[EventCustomerId],isShipping
