...
IF EXISTS (SELECT * FROM sys.views WHERE name = 'Vw_GetCustomersToGenerateConfirmationCallQueue')
DROP VIEW [Vw_GetCustomersToGenerateConfirmationCallQueue]
GO

CREATE VIEW [Vw_GetCustomersToGenerateConfirmationCallQueue]
AS
