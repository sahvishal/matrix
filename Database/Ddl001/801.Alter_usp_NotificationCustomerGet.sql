...
/****** Object:  StoredProcedure [dbo].[usp_NotificationCustomerGet]    Script Date: 3/16/2018 1:55:32 PM ******/
SET ANSI_NULLS ON
GO
...
inner join TblOrganizationRoleUser TORU with(nolock) on TORU.OrganizationRoleUserId = TN.RequestedByOrgRoleUserId
 ...
 ,0 as IsInvalidAddress
 --, '-N/A-' AS IsCallQueueCall
 , Case WHEN cqcc.CallQueueCustomerId is not null and Tblcalls.CallQueueId is not null THEN 'Yes' ELSE 'No' END AS IsCallQueueCall
