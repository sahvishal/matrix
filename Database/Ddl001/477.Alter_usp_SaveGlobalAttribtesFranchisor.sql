...
ALTER PROCEDURE [dbo].[usp_SaveGlobalAttributesFranchisor]          
 ...
 @PasswordExpirationDays varchar(10),
 @PreviousPasswordNonRepetitionCount varchar(10),
 @OtpNotificationMediumEmail varchar(10),
 @OtpNotificationMediumSms varchar(10),
 @OtpExpirationMinutes varchar(10),
 @OtpMisMatchAttemptCount varchar(10),
 @OtpByGoogleAuthenticator  varchar(10),
 @AllowSafeComputerRemember  varchar(10),
 @SafeDeviceExpiryDays  varchar(10),
 @AlertBeforePasswordExpirationInDays varchar(10) ,
 @EnableVoiceMailNotification varchar(10)
  )          
AS    
SET NOCOUNT ON;          
 SET @returnvalue=0        
 ...
 Update TblGlobalConfiguration set value=@globalcutoffdate where name='GlobalCutOffDate'         
    ...
    Update TblGlobalConfiguration set Value = @PasswordExpirationDays where Name = 'PasswordExpirationDays'
    Update TblGlobalConfiguration set Value = @PreviousPasswordNonRepetitionCount where Name = 'PreviousPasswordNonRepetitionCount'
    
    Update TblGlobalConfiguration set Value = @OtpNotificationMediumEmail where Name = 'OtpNotificationMediumEmail'
    Update TblGlobalConfiguration set Value = @OtpNotificationMediumSms where Name = 'OtpNotificationMediumSms'
    Update TblGlobalConfiguration set Value = @OtpExpirationMinutes where Name = 'OtpExpirationMinutes'
    Update TblGlobalConfiguration set Value = @OtpMisMatchAttemptCount where Name = 'OtpMisMatchAttemptCount'
    
    Update TblGlobalConfiguration set Value = @SafeDeviceExpiryDays where Name = 'SafeDeviceExpiryDays'
    Update TblGlobalConfiguration set Value = @AllowSafeComputerRemember where Name = 'AllowSafeComputerRemember'
    Update TblGlobalConfiguration set Value = @OtpByGoogleAuthenticator where Name = 'OtpByGoogleAuthenticator'
    Update TblGlobalConfiguration set Value =@AlertBeforePasswordExpirationInDays where Name ='AlertBeforePasswordExpirationInDays'
	update TblGlobalConfiguration set Value =@EnableVoiceMailNotification where Name ='EnableVoiceMailNotification'
