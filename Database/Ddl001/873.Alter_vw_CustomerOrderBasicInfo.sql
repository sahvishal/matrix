...
/****** Object:  View [dbo].[vw_CustomerOrderBasicInfo]    Script Date: 5/15/2018 6:27:06 PM ******/
SET ANSI_NULLS ON
GO
...
(
	SELECT TEC.[CustomerID],TEC.[EventID],TEC.[EventCustomerID],TEC.MarketingSource
		,TEC.DateCreated 
		--,EventRegTORU.[RoleID] 
		,case when EventRegRole.ParentId is null Then EventRegRole.RoleID Else EventRegRole.ParentId End RoleID
		,TEC.[AppointmentID],TEC.IsTestConducted,
	...
	inner join TblRole EventRegRole WITH(nolock) on EventRegTORU.RoleID = EventRegRole.RoleID
