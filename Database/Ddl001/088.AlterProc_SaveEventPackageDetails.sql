...
BEGIN
	...
	BEGIN
		...
		SET PackagePrice=@PackagePrice,  ScreeningTime = @ScreeningTime
    ...
    ELSE
    BEGIN
		INSERT INTO TblEventPackageDetails (EventID, PackageID ,PackagePrice , ScreeningTime, DateCreated ,DateModified)		
		VALUES(@EventID,@PackageID, @PackagePrice, @ScreeningTime, GETDATE(), GETDATE())
