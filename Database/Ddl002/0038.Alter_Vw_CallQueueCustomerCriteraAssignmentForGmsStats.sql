...
ALTER VIEW [dbo].[Vw_CallQueueCustomerCriteraAssignmentForGmsStats]
AS
...
SELECT cqc.CallQueueCustomerId
  ...
  ,ISNULL(cqc.ActivityId,1) as ActivityId
  ...
  ,ISNULL(cqc.TargetedYear,0) AS TargetedYear
  ,ISNULL(cqc.IsTargeted,0) AS IsTargeted
