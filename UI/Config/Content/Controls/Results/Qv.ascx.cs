...
{
    public partial class Qv : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                qv_hip.Visible = false;
                qv_chat.Visible = true;

            }
            else
            {
                qv_hip.Visible = true;
                qv_chat.Visible = false;
            }
        ...
        private void SetTestNotPerfomred()
        {
            ...
            if (listTestNotPerformedData.Count > 1)
            {
                if (IsResultEntrybyChat)
                {
                    ddlTestNotPerformedReasonQv_Chat.DataSource = listTestNotPerformedData;
                                            
                    ddlTestNotPerformedReasonQv_Chat.DataTextField = "Name";
                    ddlTestNotPerformedReasonQv_Chat.DataValueField = "Id";
                    ddlTestNotPerformedReasonQv_Chat.DataBind();
                    ddlTestNotPerformedReasonQv_Chat.Items[0].Selected = true;
                }
                else
                {
                    ddlTestNotPerformedReasonQv.DataSource = listTestNotPerformedData;
                                           
                    ddlTestNotPerformedReasonQv.DataTextField = "Name";
                    ddlTestNotPerformedReasonQv.DataValueField = "Id";
                    ddlTestNotPerformedReasonQv.DataBind();
                    ddlTestNotPerformedReasonQv.Items[0].Selected = true;
                }
            }
            else
            {
                ddlTestNotPerformedReasonQv.Visible = false;
                ddlTestNotPerformedReasonQv_Chat.Visible = false;
            }
        }
