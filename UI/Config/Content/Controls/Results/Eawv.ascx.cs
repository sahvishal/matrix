...
{
    public partial class Eawv : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                eAWV_hip.Visible = false;
                eAWV_chat.Visible = true;

            }
            else
            {
                eAWV_hip.Visible = true;
                eAWV_chat.Visible = false;
            }
        }
        ...
        public void FillAllStaticGrids()
        {
            ...
            if (!IsResultEntrybyChat)
            {
                ...
                var listUnableScreenReasonData = unableScreenRepository.GetAllUnableToScreenReasons((long)TestType.eAWV) ?? new List<UnableScreenReason> { new UnableScreenReason { DisplayName = "Unable to Screen", Reason = UnableToScreenReason.Other } };
                ...
                UnableToScreenEawvDataList.DataSource = listUnableScreenReasonData;
                UnableToScreenEawvDataList.DataBind();
                ...
                if (listTestNotPerformedData.Count > 1)
                {
                    ...
                    ddlTestNotPerformedReasonEawv.DataSource = listTestNotPerformedData;

                    ddlTestNotPerformedReasonEawv.DataTextField = "Name";
                    ddlTestNotPerformedReasonEawv.DataValueField = "Id";
                    ddlTestNotPerformedReasonEawv.DataBind();
                    ddlTestNotPerformedReasonEawv.Items[0].Selected = true;
                }
                else
                {
                    ddlTestNotPerformedReasonEawv.Visible = false;
                }
            }
