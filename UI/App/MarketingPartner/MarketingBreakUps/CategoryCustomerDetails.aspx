<%@ Page Language="C#" Title="Marketing Break-Ups" AutoEventWireup="true" MasterPageFile="~/App/MarketingPartner/MarketingPartner.master"
    CodeBehind="CategoryCustomerDetails.aspx.cs" Inherits="HealthYes.Web.App.MarketingPartner.CategoryCustomerDetails" %>
...
<%-- Grid script ends here --%>
    ...
    function ClearDateSearch()
    {
        ...
        function StartGetChart(Duration, selimage, pagenumber) {
            ...
            document.getElementById('divgridAdvocateCustomer').style.display = 'none';
            //postRequest.url = "/App/MarketingPartner/AdvocateSalesManager/AsyncChartCampaignCategory.aspx?CategoryCustomer=true&Duration=" + Duration + "&startdate=" + txtStartDate.value + "&enddate=" + txtEndDate.value;
            postRequest.url = "AsyncChartCampaignCustomer.aspx?CategoryCustomer=true&Duration=" + Duration + "&startdate=" + txtStartDate.value + "&enddate=" + txtEndDate.value + "&CategoryId=" + hfCategoryID.value + "&PageNumber=" + pagenumber + "&selimage=" + selimage;
	        ...
	        document.getElementById('divgridAdvocateCustomer').style.display = 'block';
        }
        function StartGetChartDateRange(Duration, selimage, pagenumber) {
            var hfDuration = document.getElementById('<%=hfDuration.ClientID %>');
            hfDuration.value=Duration;
            var hfCategoryID = document.getElementById('<%=hfCategoryID.ClientID %>');
            var txtStartDate = document.getElementById('<%=txtStartDate.ClientID %>');
        ...
        function SetChartImage(httpRequest) {
            ...
            var gridPagingIndex1 = responsetext.indexOf("<!-- Start Advocate Customer Paging -->");
            var gridPagingIndex2 = responsetext.indexOf("<!-- End Advocate Customer Paging -->");

            var gridIndex1 = responsetext.indexOf("<!--Start Advocate Customer Grid-->");
            var gridIndex2 = responsetext.indexOf("<!--End Advocate Customer Grid-->");
            if (gridIndex1 != -1) {
                var grid = responsetext.substring(gridIndex1 + 35, gridIndex2);
                var paging = responsetext.substring(gridPagingIndex1 + 40, gridPagingIndex2);
                document.getElementById('divgridAdvocateCustomer').innerHTML = grid + paging;
        ...
        function GetCategoryPaging(Duration, selimage, pagenumber) {
            var hfDuration = document.getElementById('<%=hfDuration.ClientID %>');
            hfDuration.value = Duration;
            var hfCategoryID = document.getElementById('<%=hfCategoryID.ClientID %>');
            ...
            document.getElementById('divgridAdvocateCustomer').style.display = 'none';
            //postRequest.url = "AsyncChartCampaignCustomer.aspx?CampaignCustomer=true&Duration=" + Duration + "&startdate=" + txtStartDate.value + "&enddate=" + txtEndDate.value + "&AdvocateId=" + hfAdvocateID.value + "&PageNumber=" + pagenumber + "&selimage=" + selimage;
            postRequest.url = "AsyncChartCampaignCustomer.aspx?CategoryCustomer=true&Duration=" + Duration + "&startdate=" + txtStartDate.value + "&enddate=" + txtEndDate.value + "&CategoryId=" + hfCategoryID.value + "&PageNumber=" + pagenumber + "&selimage=" + selimage;
        ...
        <div class="mainbody_inner">
            <div class="main_area_bdrnone">
                <div class="headingbox_top_body" style="width: 753px;">
                    ...
                    <span class="orngheadtxt_heading" runat="server" id="sptitle">Marketing Break-Up for <span id="spCategoryName" runat="server"></span></span>
                 ...
                 <p >
                     ...
                     <span class="dateinputfldnowidth_cl">Start
                            ...
                            <asp:ImageButton ID="imgCalendarEnd" runat="server" ImageUrl="~/App/Images/calendar-icon.gif"
                                            CssClass=""></asp:ImageButton>
                                         </span>    <asp:ImageButton ID="ibtnFilter" runat="server" OnClientClick="return ValidateDate();"
                                                 ImageUrl="~/App/Images/Filter-btn.gif" onclick="ibtnFilter_Click" />
                                          
                                            <asp:ImageButton ID="ibtnClear" runat="server" OnClientClick="return ClearDateSearch();"
                                                 ImageUrl="~/App/Images/clear-btn.gif" />  
            ...
            <div class="main_area_bdrnone">
                <div style="float: left; width: 710px; height: 27px">
                    <a href="javascript:StartGetChart('Today', 'imgCStoday',1);">
                        <img id="imgCStoday" src="/App/Images/MarketingPartner/today-tab-off_mp.gif" alt="" /></a>
                    <a href="javascript:StartGetChart('Week', 'imgCSWeek',1);">
                        <img id="imgCSWeek" src="/App/Images/MarketingPartner/last7-gtab-off.gif" alt="" /></a>
                    <a href="javascript:StartGetChart('Month', 'imgCSMonth',1);">
                        <img id="imgCSMonth" src="/App/Images/MarketingPartner/last30-gtab-off.gif" alt="" /></a>
                    <a href="javascript:StartGetChart('All', 'imgCSAll',1);">
                        <img id="imgCSAll" src="/App/Images/MarketingPartner/All-tab-off_mp.gif" alt="" /></a>
                </div>
                <div id="divData" style="float: left; width: 748px; height:310px; border: solid 1px #D9E9FF">
                    <div id="divgridAdvocateCustomer" style="float: left; width: 300px; height: 310px;
                        border-right: solid 1px #D9E9FF; background-color: #EFF8FD;">
                    </div>
                    <div style="float: left; width: 446px; height:310px; overflow-x:hidden; overflow-y:scroll;">
                    
                        <div id="divcschart" style="float:left; "> 
                                   
                                <img id="imgchart" src="../../Images/indicator_chartbox.gif" usemap="#chartCampaignCustomerImageMap"
                                    alt="" />
                                    <div id="divMap">
                                </div>
    ...
    <fieldset style="margin: 0px; padding: 0px;">
        <legend class="legendhead_default" style="font-size:14px;">Summary</legend>
            ...
            <span style="float:left">
                ...
                <a href="javascript:void(0);">
                                    <img id="imgAdvocate" runat="server" src='~/App/Images/MarketingPartner/Advocates-taboff.gif'
                                        onclick="View('Advocate')" /></a>
                    <img id="imgCampaign" runat="server" src='~/App/Images/MarketingPartner/campaigns-tabon.gif'
                        onclick="View('Campaign')" /></a><a href="javascript:void(0);">
                            <img id="imgSignup" runat="server" src='~/App/Images/MarketingPartner/signups-blutab-off.gif'
                                onclick="View('Signup')" /></a><a href="javascript:void(0);">
                                    <img id="imgCustomer" runat="server" src='~/App/Images/MarketingPartner/Cusotmers-taboff.gif'
                                        onclick="View('Customer')" /></a><a href="javascript:void(0);">
                                    <img id="imgPaidCustomer" runat="server" src='~/App/Images/MarketingPartner/PaidCusotmers-taboff.gif'
                                        onclick="View('PaidCustomer')" /></a><a href="javascript:void(0);">
                                    <img id="imgCall" runat="server" src='~/App/Images/MarketingPartner/Calls-taboff.gif'
                                        onclick="View('Call')" /></a><a href="javascript:void(0);">
                                            <img id="imgPayment" runat="server" src='~/App/Images/MarketingPartner/Payments-taboff.gif'
                                                onclick="View('Payment')" /></a><a href="javascript:void(0); ">
                                                    <img id="imgCustomerGraph" runat="server" src='~/App/Images/MarketingPartner/graph-taboff.gif'
                                                        onclick="View('Graph')" /></a><a href="javascript:alert('Please check this in next release'); ">
                                                    <img style="display:none" id="imgHistory" runat="server" src='~/App/Images/MarketingPartner/history-taboff.gif'
                                                        onclick="View('History')" /></a>
