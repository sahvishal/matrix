...
public partial class App_MarketingPartner_AdvocateManager_Dashboard : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        App_MarketingPartner_AdvocateManager objmaster = (App_MarketingPartner_AdvocateManager)this.Master;
        Title = "Advocate Manager Dashboard";
        objmaster.settitle("Advocate Manager Dashboard");
        objmaster.SetBreadCrumbRoot = "<a href=\"/App/MarketingPartner/AdvocateManager/DashBoard.aspx\">DashBoard</a> ";
