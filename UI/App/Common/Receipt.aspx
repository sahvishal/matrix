<%@ Page Language="C#" MasterPageFile="~/App/Franchisee/Technician/TechnicianMaster.master" AutoEventWireup="true" Inherits="App_Common_Receipt" Title="Untitled Page" Codebehind="Receipt.aspx.cs" %>
...
//prtContent.innerHTML=strOldOne;
   ...
   <span class="graytxtright_prsmall"><img src="/Public/Images/printer-icon.gif" onclick="javascript:CallPrint()" /></span>
   </p>
   <div class="maindiv_prsmall">
    <p class="contentrow_prsmall"> <img src="/Public/Images/header-smallprintrec.gif" /> </p>
