<%@ Page Language="C#" MasterPageFile="~/App/Franchisor/FranchisorMaster.master" AutoEventWireup="true" Inherits="App_Common_CustomerListSignInMode" Codebehind="CustomerListSignInMode.aspx.cs" %>
...
<div class="mainbody_outer">
 <div class="mainbody_inner">
     ...
     <div class="headingbox_feedback">
            ...
            <span class="orngheadtxt_feedback">Customer List (Sign In Mode)</span>
            </div>
    ...
    <span class="normaltxtnowdth_ea">Registered:&nbsp;<a href="#">28</a>&nbsp;|&nbsp;Actual:&nbsp;<a href="#">22</a>&nbsp;|&nbsp;Paid:&nbsp;<a href="#">22</a>&nbsp;|&nbsp;Unpaid:&nbsp;<a href="#">4</a>&nbsp;|&nbsp;Canceled:&nbsp;<a href="#">2</a>&nbsp;|&nbsp;No Show:&nbsp;<a href="#">2</a></span>
     ...
     <p class="lgtgrayboxrow_ea">
        <span class="titlefixwdth_ea">Revenue:</span>
    <span class="normaltxtnowdth_ea">Total:<b>$3200</b>&nbsp;|&nbsp;CC:<b>$1200</b> (<a href="#">10</a>)&nbsp;|&nbsp;Cash:<b>$900</b> (<a href="#">11</a>)&nbsp;|&nbsp;Check:<b>$900</b> (<a href="#">11</a>)</span>
     </p>
     <p class="lgtgrayboxrow_ea">
        <span class="titlefixwdth_ea">Deposits to EIP:</span>
    <span class="normaltxtnowdth_ea"> <b>$1800</b> (Cash and Checks) </span>
     </p>
    </div>
    ...
    <p class="maindivinnerrow_feedback">
            <span class="orngbold14_default" style="float:left">Customer List</span>
            <span class="smalltxtlnk_hd"> <asp:ImageButton ID="ibtn" runat="server" ImageUrl="~/App/Images/save-button.gif" /></span>
            <span class="smalltxtlnk_hd">
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="inputf_def" Width="110px">
    ...
    <asp:GridView ID="dgcustomerlist" runat="server" CssClass="divgrid_clnew" AutoGenerateColumns="false" GridLines="None">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Check In/Out">
                         <ItemTemplate>
                         <p>
                         <span class="gridinnertxtdiv">In:</span> <span><asp:TextBox ID="TextBox2" runat="server" CssClass="inputf_def" Width="70px"></asp:TextBox></span>
                         </p>
                         <p>
                         <span class="gridinnertxtdiv">Out:</span> <span><asp:TextBox ID="TextBox1" runat="server" CssClass="inputf_def" Width="70px"></asp:TextBox></span>
                         </p>
                         <p>
                         <span class="gridinnertxtdiv"><img src="../Images/specer.gif" width="30px" height="1px" /></span><asp:CheckBox ID="CheckBox1" runat="server" Text="No Show" /> <span>
                         </p>                         
                        </ItemTemplate>                                       
                        </asp:TemplateField>
