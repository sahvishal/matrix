<%@ Page Language="C#" MasterPageFile="~/App/Franchisor/FranchisorMaster.master" AutoEventWireup="True" Inherits="App_Franchisee_SalesRep_Dashboard" Title="Dashboard" Codebehind="Dashboard.aspx.cs" %>
...
<div class="mainbody_outer">
            ...
            <div class="main_area_bdrnone">
                <div class="headingbox_top_body">
                    ...
                    <span class="orngheadtxt_heading" id="dvTitle" runat="server">Dashboard</span>
           ...
           <%-- <div class="mainbody_inner_left">
            ...
            <div class="mainbody_titletxtleft">Sales Rep Dashboard</div>
            </div>
