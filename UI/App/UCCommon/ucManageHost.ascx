<%@ Control Language="C#" AutoEventWireup="true" Inherits="App_UCCommon_ucManageHost"
    CodeBehind="ucManageHost.ascx.cs" %>
...
<script type="text/javascript">
	...
	{
		if (confirm('Are you sure to delete host?'))
		{
			document.getElementById('divloading').style.visibility = "visible";
			document.getElementById('divloading').style.display = "block";
		
			//var postRequest1 = new HttpRequest();
			var url="/App/Common/AsyncAddTask.aspx?Delete=Host";
			// Delete Prospect
			url=url + "&hostid=" + HostId;
			postRequest.url =url;
			postRequest.successCallback = SucessDeleteHost;
			postRequest.post("");
		}
		return false;
	}
	
	function SucessDeleteHost(httpRequest)
	{
		if(httpRequest.responseText!="")
		{
			...
			if (result1 == 1)
			{
				LoadProspectTable(curviewmode);
				alert('Host Deleted Successfully!');
			}
			else if (result1 == 2)
			{
				alert('There is an event hosted on this host.\nPlease delete the event first');
			}
			else if (result1 == 0)
			{
				alert('Error occured in dtabase whiling deleting host.');
			}
	...
	function ShowActionList(userid,ancAction)
	{
		...
		divActionListID.style.left = (parseInt(dim.Left)- 56) + 'px';
	} 
	
	//on mouse out
	function HideActionList(userid,evt)
	{//debugger
		var divActionListID=document.getElementById("divActionList" + userid);
	...
	function RedirectCall(prospectid,noofcalls)
	{
		if (noofcalls > 0)
		{
			window.location="/App/Franchisor/ViewCall.aspx?Type=Host&ProspectId=" + prospectid;            
		}
		else 
		{   
	...
	function RedirectMeeting(prospectid,noofmeetings)
	{
		if (noofmeetings > 0)
		{
			window.location="/App/Franchisor/ViewMeetings.aspx?Type=Host&ProspectID=" + prospectid;            
		}
		else 
		{   
	...
	function SaveTask()
	{
		...
		//var postRequest1 = new HttpRequest();
		var url="/App/Common/AsyncAddTask.aspx?Add=Task&ishost=true";
		// task details
		var txtTask = document.getElementById("<%= this.txtTask.ClientID %>"); 
		var txtDueDate = document.getElementById("<%= this.txtDueDate.ClientID %>"); 
		var txtDueTime = document.getElementById("<%= this.txtDueTime.ClientID %>");
	...
	// -------------------------------------------------------------------------------------------------
        ...
        function GetUrl()
        {
            ...
            url="/App/Common/AsyncManageHost.aspx?ishost=true";
            // search details
            ...
            var ddlEvents = document.getElementById("<%= this.ddlEvents.ClientID %>");
            ...
            var _prospectTypeId = document.getElementById("<%= this._hostType.ClientID %>");
            ...
            else if (hidRole == 'SalesRep' && ddlSalesPerson!=null)
            {
                ...
                url=url + "&salesrepid=" + ddlSalesPerson.value;
                else url=url + "&salesrepid=" + document.getElementById("<%= this.hidUserId.ClientID %>").value;
            }
            url=url + "&role=" + hidRole;
            
            url=url + "&distance=" + ddlDistance.value;
            url=url + "&zipcode=" + txtZipcode.value;
            url=url + "&status=" + ddlStatus.value;
            url=url + "&hasevent=" + ddlEvents.value;
            ...
            url=url + "&hostType=" + _prospectTypeId.value;
            
            if(isreset==true) 
            {   url=url + "&isreset=true";
                isreset=false;
            }
            //alert(url);
        ...
        function resetsearchpanel()
        {
            ...
            document.getElementById("<%= this.ddlEvents.ClientID %>").options[0].selected=true;
             document.getElementById("<%= this._hostType.ClientID %>").options[0].selected=true;
    ...
    <div class="mainbody_inner">
        <div class="main_area_bdrnone">
            <div class="headingbox_top_body">
                ...
                <span class="orngheadtxt_heading" id="sptitle" runat="server">Manage Hosts</span>
                <span class="headingright_default"><a href="~/App/Common/AddNewHost.aspx" runat="server"
                    id="lnkNewProspect">+ Add new Host</a></span>
            </div>
            <p>
        ...
        <div class="main_area_bdrnone">
                ...
                <asp:Panel ID="Panel1" it="PnlSearch" runat="server" DefaultButton="ibtnSearch">
                    ...
                    <div class="lgtgraybox_cl" id="divStartCallSearch" runat="server">
                        <p class="lgtgrayboxrow_cl" style="padding-top: 10px;">
                            <span class="titletextsmallbld1_default">Name:</span> <span class="inputfieldright_default">
                                <asp:TextBox ID="txtProspectName" runat="server" CssClass="inputf_def" Width="100px"></asp:TextBox></span>
                            <span class="titletext1a_default">Created Between:</span> <span class="dateinputfldnowidth_cl">
                                <asp:TextBox ID="txtStartDate" runat="server" CssClass="inputf_def" Width="80px"></asp:TextBox></span>
                            ...
                            </span><span class="dateinputfldnowidth_cl">&nbsp;&nbsp;-To-&nbsp;&nbsp;<asp:TextBox
                                ID="txtEndDate" runat="server" CssClass="inputf_def" Width="80px"></asp:TextBox></span>
                            <span class="calendarcntrl_default">
                        ...
                        <p class="lgtgrayboxrow_cl" style="padding-top: 10px;">
                            <span id="spanFranchisee" runat="server"><span id="Span1" class="titletextsmallbld1_default"
                                ...
                                </span></span><span class="titletextsmallbld1_default" id="_spnDistance" runat="server">
                                    Distance:</span> <span class="inputfieldright_default" id="SpanDistanceDrpoDown"
                                        runat="server">
                                        <asp:DropDownList ID="ddlDistance" runat="server" Width="120px">
                                        </asp:DropDownList>
                                    </span><span class="ttxtnowidthnormal_default">From Zip Code</span> <span class="dateinputfldnowidth_cl">
                                        <asp:TextBox ID="txtZipcode" runat="server" CssClass="inputf_def" Width="60px" MaxLength="10"></asp:TextBox>
                                    </span>
                        </p>
                        <p class="lgtgrayboxrow_cl" style="padding-top: 10px;">
                            <span class="titletextsmallbld1_default">Status:</span> <span class="inputfieldright_default">
                                <asp:DropDownList ID="ddlStatus" runat="server" Width="110px">
                                </asp:DropDownList>
                            </span><span class="titletext1a_default">Has Events:</span> <span class="dateinputfldnowidth_cl">
                                <asp:DropDownList ID="ddlEvents" runat="server" Width="90px">
                                </asp:DropDownList>
                            </span>
                        </p>
                        <p class="lgtgrayboxrow_cl" style="padding-top: 10px;">
                            <span class="titletextsmallbld1_default">Territory:</span> <span class="inputfieldright_default">
                                <asp:DropDownList ID="ddlTerritory" runat="server" CssClass="inputf_def" Width="110px">
                                </asp:DropDownList>
                            </span><span id="_spnAssignedTo" runat="server"><span class="titletext1a_default">Assigned
                                To:</span> <span class="dateinputfldnowidth_cl">
                                    <asp:DropDownList ID="_assignedTo" runat="server" Width="150px">
                                    </asp:DropDownList>
                                </span></span><span id="spanSalesPerson" runat="server" style="display: block"><span
                                    class="titletext1a_default">HSC:</span> <span class="dateinputfldnowidth_cl" style="margin-right: 25px;">
                                        <asp:DropDownList ID="ddlSalesPerson" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </span></span>
                        </p>
                        <p class="lgtgrayboxrow_cl" style="padding-top: 10px;">
                        <span class="titletextsmallbld1_default">Type:</span>
                        <span class="inputfieldright_default">
                                <asp:DropDownList ID="_hostType" runat="server" CssClass="inputf_def" Width="300px">
                                </asp:DropDownList>
                            </span>
                        </p>
                    </div>
            ...
            <p class="divmainbody_cd">
                <span class="blkheadtxt_regcust" id="spnTotalText" runat="server" style="float: left;">
                </span><span class="blueheadtxt_regcust" id="Span3" runat="server" style="float: left;">
                    <span id="spCount" runat="server" style="float: left;"></span></span><span class="rightlnktxt_cl">
                        <asp:DropDownList ID="ddlProspectRecords" CssClass="inputf_def" Width="50px" runat="server">
                ...
                <div class="innermain_pop">
                    ...
                    <p class="innermain_pop">
                        <span class="inputfield110px_anp">Due Date:
                            <asp:TextBox ID="txtDueDate" runat="server" CssClass="inputf_def" Width="100px"></asp:TextBox>
                            <span style="font-size: 9px; color: #666;">(mm/dd/yyyy)</span> </span><span style="float: left;
                                padding-top: 17px;">
                                <asp:ImageButton ID="ibtnDueDate" runat="server" CssClass="" ImageUrl="~/App/Images/calendar-icon.gif" /></span>
                        <cc1:CalendarExtender ID="caleventfrom" runat="server" Format="MM/dd/yyyy" PopupButtonID="ibtnDueDate"
