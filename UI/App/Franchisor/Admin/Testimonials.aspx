<%@ Page Language="C#" MasterPageFile="~/App/Franchisor/FranchisorMaster.master" AutoEventWireup="true" Inherits="App_Franchisor_Admin_testimonials" Codebehind="Testimonials.aspx.cs" %>
...
<div class="mainbody_outer">
    ...
    <div class="main_area_bdrnone">
            ...
            <span class="orngheadtxt_feedback">Testimonials</span>
            </div>
            </div>
            ...
            <p><img src="../../Images/specer.gif" width="750" height="15px"/></p> 
            <p class="lightblueboxrow_feedback">
            <span class="inputfldnowidth_default"><asp:CheckBox ID="CheckBox1" runat="server"/></span>
            </p>
            <p><img src="../../Images/specer.gif" width="750" height="15px" /></p> 
            </div>
            <div class="headbg2_box_accm">
             ...
             <p class="maindivinnerrow_feedback">
              <span class="orngtxtbld_urm">My Testimonials History</span>
             </p>
             <p class="graylinefull_feedback"><img src="../../Images/specer.gif" width="1px" height="1px" /></p>
             <p class="maindivinnerrow_feedback">
