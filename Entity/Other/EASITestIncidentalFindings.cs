...
{
    public class EASITestIncidentalFindings
    {
        private int m_iASITestIncidentalFindingID = 0;
        ...
        /// <summary>
        /// EIncidentalFindings object for mapping EASITestIncidentalFindings with EIncidentalFindings
        /// </summary>        
        ...
        /// master id
        /// </summary>        
        public int ASITestIncidentalFindingID
        {
            get { return m_iASITestIncidentalFindingID; }
            set { m_iASITestIncidentalFindingID = value; }
        }
    }
}
